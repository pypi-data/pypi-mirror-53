...
setuptools.setup(name="aime_detector_sdk", version="0.1.3-1", author="TrinhQuan", author_email="quantv@aimesoft.com",
                 ...
                 download_url='https://github.com/jarklee/aime_detector_sdk/releases/download/0.1.3-1/aime_detector_sdk-0.1.3.post1.tar.gz',
