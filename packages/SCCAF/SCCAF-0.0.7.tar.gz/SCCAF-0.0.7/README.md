...
Note: if you are viewing this README on PYPI at `https://pypi.org/project/SCCAF/` you will notice that the two links
above for the Notebook are broken, this is due to an [issue](https://github.com/pypa/warehouse/issues/5246) between PYPI and GitHub.
To view the Notebook, please check this same document at the [SCCAF Git repo](https://github.com/SCCAF/sccaf).
