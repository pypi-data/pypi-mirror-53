...
class MinetorchStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SetTimer = channel.unary_unary(
        ...
        request_serializer=featurize__jupyterlab_dot_proto_dot_minetorch__pb2.Timer.SerializeToString,
        response_deserializer=featurize__jupyterlab_dot_proto_dot_minetorch__pb2.StandardResponse.FromString,
        )
...
def add_MinetorchServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'SetTimer': grpc.unary_unary_rpc_method_handler(
          servicer.SetTimer,
          request_deserializer=featurize__jupyterlab_dot_proto_dot_minetorch__pb2.Timer.FromString,
          response_serializer=featurize__jupyterlab_dot_proto_dot_minetorch__pb2.StandardResponse.SerializeToString,
      ),
