...
class xMattersShift(object):
    ...
    def addMemberToShift(self, groupId, shiftId, memberId, retry=0):
        ...
        try:
            self.log.info(defName + 'adding member ' + memberId + ' to group ' + groupId + ' shift ' + shiftId)
            url = '/api/xm/1' + '/groups/' + \
                urllib.parse.quote(groupId) + '/shifts/' + \
                urllib.parse.quote(shiftId) + '/members'
    ...
    def getShift(self, groupId, shiftId, retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Group: ' + groupId)
            url = '/api/xm/1' + '/groups/' + urllib.parse.quote(groupId) + '/shifts/' + urllib.parse.quote(shiftId)
    ...
    def getShifts(self, groupId, retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Group Shifts: ' + groupId)
            url = '/api/xm/1' + '/groups/' + urllib.parse.quote(groupId) + '/shifts'
    ...
    def createShift(self, groupId, data, retry=0):
        ...
        try:
            self.log.info(defName + 'Creating Shift, for ' + groupId)
            url = '/api/xm/1' + '/groups/' + urllib.parse.quote(groupId) + '/shifts'
