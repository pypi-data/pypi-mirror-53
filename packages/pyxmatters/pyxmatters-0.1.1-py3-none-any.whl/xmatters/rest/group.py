...
class xMattersGroup(object):
    ...
    def getGroup(self, id, filter='?embed=supervisors', retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Group: ' + id)
            url = '/api/xm/1' + '/groups/' + urllib.parse.quote(id) + filter
    ...
    def getGroups(self, filter='?offset=0&limit=1000', retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Groups')
    ...
    def createGroup(self, data, retry=0):
        ...
        try:
            ...
            self.log.info(defName + 'Creating Group: ' + name + ' with ' + str(data))
    ...
    def modifyGroup(self, data, retry=0):
        ...
        try:
            ...
            id = data['id']
            self.log.info(defName + 'Modifying Group: ' + id + ' with ' + str(data))
    ...
    def removeGroup(self, id, retry=0):
        ...
        try:
            self.log.info(defName + 'Removing Group: ' + id)
