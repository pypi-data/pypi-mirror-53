...
class xMattersSite(object):
    ...
    def getSite(self, id, retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Site: ' + id)
            url = '/api/xm/1' + '/sites/' + urllib.parse.quote(id)
    ...
    def createSite(self, data, retry=0):
        ...
        try:
            ...
            name = data['name']
            self.log.info(defName + 'Creating Site: ' + name + ' with ' + str(data))
    ...
    def getSites(self, retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Sites')
            url = '/api/xm/1' + '/sites'
    ...
    def modifySite(self, data, retry=0):
        ...
        try:
            ...
            id = data['id']
            self.log.info(defName + 'Modifying Site: ' + id + ' with ' + str(data))
