...
class xMattersRoster(object):
    ...
    def addMemberToRoster(self, groupId, memberId, retry=0):
        ...
        try:
            url = '/api/xm/1' + '/groups/' + urllib.parse.quote(groupId) + '/members'
            ...
            self.log.info(defName + 'adding member '+memberId+' to group roster ' + groupId + ' with ' + str(data))
    ...
    def removeMemberFromRoster(self, groupId, memberId, retry=0):
        ...
        try:
            self.log.info(defName + 'removing member '+memberId+' from group roster ' + groupId)
            url = '/api/xm/1' + '/groups/' + urllib.parse.quote(groupId) + '/members/'+urllib.parse.quote(memberId)
    ...
    def getRoster(self, groupId, retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Group Roster: ' + groupId)
            url = '/api/xm/1' + '/groups/' + urllib.parse.quote(groupId)
