...
class xMattersPerson(object):
    ...
    def getPerson(self, id, filter='?embed=roles,supervisors', retry=0):
        ...
        try:
            self.log.info(defName + 'Getting Person: ' + id)
            url = '/api/xm/1' + '/people/' + urllib.parse.quote(id) + filter
    ...
    def getPeople(self, filter='?embed=roles,devices&offset=0&limit=1000', retry=0):
        ...
        try:
            self.log.info(defName + 'Getting People')
    ...
    def createPerson(self, data, retry=0):
        ...
        try:
            ...
            self.log.info(defName + 'Creating Person: ' + name + ' with ' + str(data))
    ...
    def modifyPerson(self, data):
        ...
        try:
            ...
            id = data['id']
            self.log.info(defName + 'Modifying Person: ' + id + ' with ' + str(data))
    ...
    def removePerson(self, id, retry=0):
        ...
        try:
            self.log.info(defName + 'Removing Person: ' + id)
