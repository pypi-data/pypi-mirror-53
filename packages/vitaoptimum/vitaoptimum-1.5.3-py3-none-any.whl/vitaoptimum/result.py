    ...
    def plot_function(self, sol_range=None, dim_indices=None,
        ...
        if self._dim == 1:
            if not isinstance(sol_range, list):
                ...
                constr = self._best_constrains if hasattr(self, '_best_constrains') else None
                plot.fobj_1d(self._fobj, sol_range, title, logo, save_to, constr)
            ...
            if not isinstance(sol_range, list):
                ...
                plot.fobj_2d(self._fobj, self._solution, [low0, high0], [low1, high1],
                             self._dim, dim_indices, title, logo, save_to, constr)
        return True
