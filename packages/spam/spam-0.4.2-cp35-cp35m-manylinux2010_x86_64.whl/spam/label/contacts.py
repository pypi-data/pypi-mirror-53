...
def detectAndFixOversegmentation(lab, nVoxThreshold=25):
    ...
    while len(stack) > 0:
        ...
        if bigContactsMask.sum() != 0:
            ...
            for pos in numpy.where(bigContactsMask is True)[0]:
                # print pos
                # print contactLabels
...
def getContactPoints(lab, contactPairs, returnContactZones=False, boundingBoxes=None, centresOfMass=None):
    print("spam.label.getContactPoints(): This function has been renamed to contactPoints, please update your code")
    return
