...
segments = [
    ...
    {
        'title': 'Region',
        'filters': {'Sverige8grupper': ["SE06", "SE07+SE08", "SE09", "SE0A", "SE110", "SE12", "SE2"]},
...
class SCBClient(Client):
    ...
    def get(self) -> pd.DataFrame:
        ...
        dfs = [self._get_psu_table(x['slug'], x['filters']) for x in segments]
        ...
        df.psu_pop_segment = df.psu_pop_segment.apply(nice_string).str.replace('\s+', '_')
