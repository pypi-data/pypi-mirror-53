...
class HREELS_Window(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui = self.ui = uic.loadUi("viewhreels.ui", self)
        self.xmin = 50.
        self.factor = 10.
        self.offset = 0.1
        self.useOffset = False
        self.normalized = False
        self.datapath = "D:\\Data\\Python\\expHREELS\\data"
        self.remoteDir = '\\\\backup-ep3\\BackUp02\\0_experiments\\EELS-PC4\HREELS'
        self.wideScan = True
        self.marker = []
        # self.markerSet = False

        # initialize the widget "drawWidget" and attach it into the ui
        self.drawing_figure = plt.figure(frameon=False,figsize=(5, 4), dpi=300, tight_layout = True)
    ...
    def onActionHelp(self):
        ...
        msg.setText('''
        This is version 1.0 of the MLU-HREELS data browser
        designed for fast data screening and judgement.
        ''')
    ...
    def onPushButton_details3(self):
        ...
        self.dialog.ui = uic.loadUi("viewhreels_dialog.ui", self.dialog)
