...
compatibility with recently patched Windows 7 (or later) memory samples:
    ...
    https://github.com/volbffoundation/volatility/wiki/2.6-Win-Profiles
...
volbf (at) volatilityfoundation (dot) org
...
For a more detailed list of capabilities, see the following:
    ...
    https://github.com/volbffoundation/volatility/wiki
...
memory images from the following url:
    ...
    https://github.com/volbffoundation/volatility/wiki/Memory-Samples
...
Email: volbf (at) volatilityfoundation (dot) org
...
Some plugins may have other requirements which can be found at: 
    https://github.com/volbffoundation/volatility/wiki/Installation
...
4. Run some other plugins. -f is a required option for all plugins. Some
   ...
   as well as Basic Usage:
        ...
        https://github.com/volbffoundation/volatility/wiki/Volatility-Usage
...
If you think you've found a bug, please report it at:
    ...
    https://github.com/volbffoundation/volatility/issues
