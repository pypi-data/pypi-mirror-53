...
#define CASADI_VERSION_STRING "3.5.0"
#define CASADI_GIT_REVISION "6e649616d7942b8b855a968e21fafd14cf35ff07"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-226.6e649616d"  // NOLINT(whitespace/line_length)
