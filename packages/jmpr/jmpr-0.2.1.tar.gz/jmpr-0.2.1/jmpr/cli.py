...
def main():
    ...
    if args.yaml_file:
        ...
        # try: #wrapper for overall execution
        #     cloud_assets = CloudAssets.from_yaml(args.yaml_file)
        ...
        #
        #     except Exception as e:
        #         sys.exit("Exception occurred before cloud assets was defined, so no further reporting")
