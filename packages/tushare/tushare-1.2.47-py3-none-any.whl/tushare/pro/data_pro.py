    ...
    for _ in range(retry_count):
        try:
            if asset == 'E':
                ...
                if 'min' in freq:
                    data = api.stk_mins(ts_code=ts_code, start_time=start_date, end_time=end_date, freq=freq, offset=offset, limit=limit)
                ...
                if 'min' in freq:
                    data = api.ft_mins(ts_code=ts_code, start_time=start_date, end_time=end_date, freq=freq, offset=offset, limit=limit)
            elif asset == 'O':
                if freq == 'D':
