    ...
    for _ in range(retry_count):
        try:
            if asset == 'E':
                ...
                if 'min' in freq:
                    data = api.stk_mins(ts_code=ts_code, start_time=start_date, end_time=end_date, freq=freq)
                ...
                if 'min' in freq:
                    data = api.ft_mins(ts_code=ts_code, start_time=start_date, end_time=end_date, freq=freq)
            elif asset == 'O':
                if freq == 'D':
...
#     df = pro_bar(ts_code='000001.SZ', start_date='20190415', end_date='20190416', asset='E', factors=['tor', 'vr'])
    df = pro_bar(ts_code='RB2001.SHF', asset='FT', freq='1min', start_date='20190925', end_date='20191001')
