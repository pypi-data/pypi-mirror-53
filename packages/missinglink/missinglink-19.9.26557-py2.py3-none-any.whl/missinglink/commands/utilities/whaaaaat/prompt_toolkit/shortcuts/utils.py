...
from ..formatted_text import to_formatted_text, FormattedText
from ..layout import Layout
from ..output import Output, ColorDepth
from ..output.defaults import create_output, get_default_output
from ..renderer import print_formatted_text as renderer_print_formatted_text
from ..styles import default_ui_style, default_pygments_style, BaseStyle, merge_styles
import six
...
def print_container(container, file=None):
    ...
    Example usage::
        ...
        from ..widgets import Frame, TextArea
        print_container(
