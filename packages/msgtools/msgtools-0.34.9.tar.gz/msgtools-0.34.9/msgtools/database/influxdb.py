...
class InfluxDBConnection:
    ...
    def handle_query(self, msg):
        ...
        dataValueInfo = Messaging.findFieldInfo(Messaging.Messages.Network.History.Data, "Data_Value")
        dataTimestampInfo = Messaging.findFieldInfo(Messaging.Messages.Network.History.Data, "Data_Timestamp")
        arrayOffset = dataTimestampInfo.offset
        arrayElemSize = dataValueInfo.size + dataTimestampInfo.size
        ...
        for result in db_results:
            ...
            dataMsg.hdr.SetDataLength(arrayOffset + (arrayElemSize) * dataRange)
        ...
        # especially useful if two clients query at almost the same time (but only if they have unique cookies!).
        self.cookie += 1
