...
TABLES = {
    ...
    "V_BZKS_KCKXX": {
        "remark": "课程库信息",
        "table_fields": ["KCDM", "KCZWMC", "KCJC", "XF", "ZXS", "ZHXS", "JKXS", "SYXS", "SJXS", "KCSJXS", "KWXS",
                         "KCLB", "KCGS", "KHFS", "KKBMDM", "KKXDM", "SYKKBMDM", "TKBJ", "QZXS", "KCXZ", "XXKC",
                         "KCYWMC", "KCJJ", "JXDG", "ZLPJBS", "BKSXKBJ", "KCZYZYJMD", "ZYCKS", "KTHKCDM", "XLCC",
                         "GZLXS", "KCYS", "SYXMSYQ", "BZ", "SKFSMC", "AXBXRW", "BSFBJ", "XKFL", "JYS", "XKDX",
                         "ZYRKJSXM", "SJLB", "SYZY", "KCMCPY", "KCJSZTDW", "KSXS", "KKBMMC", "KKXMC"],
    },
    "V_JZG": {
        "remark": "教职工表",
