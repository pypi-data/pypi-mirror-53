...
"""
from basedata.constants import (get_student_field, get_student2_field, get_section_field, get_card_field,
                                get_student_class_table_field, get_teacher_class_table_field, get_subject_field,
                                get_teacher_field)
...
def query_student_data():
    ...
    data = query_data(table_name=table_name, fields=table_fields)
    return data


def query_student2_data():
    table_name, table_fields = get_student2_field()
    data = query_data(table_name=table_name, fields=table_fields)
    return data


def query_section_data():
