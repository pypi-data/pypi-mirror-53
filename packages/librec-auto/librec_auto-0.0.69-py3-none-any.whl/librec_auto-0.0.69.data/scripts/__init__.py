...
def execute_librec(path, command):
    #classpath1 = "../lib/auto/out/artifacts/auto_jar/auto.jar"
    classpath1 = "/lib/auto/out/artifacts/auto_jar/auto.jar"
    classpath = str(os.path.abspath(os.path.dirname(os.path.dirname(__file__)))) + classpath1
    ...
    print("confpath="+str(confpath))
    print("logpath="+str(logpath))
    print("path="+str(path))
    print("p="+str(os.path.abspath(os.path.dirname(os.path.dirname(__file__)))))
