...
class GqlExt:
    ...
    def mount_app(self):
        ...
        for schema_name, schema_description in self.schemas.items():
            ...
            middlewares = self.get_middlewares(schema_description.get('middlewares') or [])
    ...
    # SCHEMAS
    @staticmethod
    def get_middlewares(middlewares_paths):
        return [import_module(middleware_path) for middleware_path in middlewares_paths or []]
    ...
    def mount(self, schema, sdl, modules, url=None, middlewares=None):
