...
class Score:
    def __init__(self,name,group,test_info,path='R:'):
...
def generate_all(path='R:',test_info='TP01',dest_file='evalfinal_'):
...
def generate_score(path='R:',test_info='TP01',dest_file='evalfinal_'):
