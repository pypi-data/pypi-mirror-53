...
_RESPONSEBEGINBLOCK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\352\336\037\016tags,omitempty'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_RESPONSEBEGINBLOCK.fields_by_name['tags']._options = None
_RESPONSECHECKTX.fields_by_name['tags']._options = None
_RESPONSEDELIVERTX.fields_by_name['tags']._options = None
_RESPONSEENDBLOCK.fields_by_name['validator_updates']._options = None
_RESPONSEENDBLOCK.fields_by_name['tags']._options = None
