...
class Cache(object):
    ...
    def run_processes(self):
        logger.debug('Cache.run_processes() - entered')
        for key_base, primer_cls in self._primers.items():
            logger.debug('Cache.run_processes() - examining {}, {}'.format(key_base, primer_cls.__name__))
    ...
    def perform_claimed_refreshes(self, claimant):
        logger.debug('Cache.perform_claimed_refreshes({}) - entered'.format(claimant))
