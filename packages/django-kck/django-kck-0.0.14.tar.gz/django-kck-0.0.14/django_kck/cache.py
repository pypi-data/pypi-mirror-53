...
class Primer(object):
    ...
    def register_all_primers(cls, cache_instance):
        ...
        for installed_app_module_as_string in settings.INSTALLED_APPS:
            ...
            # handle AppConfig instances by referring to app module
            if isinstance(primers_module, AppConfig) or issubclass(primers_module, AppConfig):
                logger.debug('Primer.register_all_primers() - found AppConfig module')
                primers_module = primers_module.module
