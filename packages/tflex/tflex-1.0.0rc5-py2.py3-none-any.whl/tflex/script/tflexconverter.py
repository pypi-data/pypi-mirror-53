...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Fundamental, BatchNormalization, EPU Core, EPU Advanced and Additional optimizations are available, default level=4 means that the first four optimizations will be executed")
    parser.add_argument(
        '--strict_padding', '-r',
        dest='strict_padding',
        action='store_true',
...
def extract_node_names(flags):
    ...
    if flags.start_node_names and flags.end_node_names:
