...
class StructuredInterfaceInput(Model):
    ...
    def __init__(self, name=None, label=None, data_type_ids_list=None, is_optional=None, description=None, skip_processing=None, is_resource=None, data_store_mode=None, path_on_compute=None, overwrite=None, data_reference_name=None):
