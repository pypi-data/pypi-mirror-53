...
class StructuredInterfaceOutput(Model):
    ...
    def __init__(self, name=None, label=None, data_type_id=None, pass_through_data_type_input_name=None, description=None, skip_processing=None, data_store_name=None, data_store_mode=None, path_on_compute=None, overwrite=None, data_reference_name=None, training_output=None):
