...
class ClickhouseDriver(object):
    ...
    def raw_query(self, sql, with_column_types=None):
        client = self.build_client()
        result = client.execute(sql, with_column_types=with_column_types)
        if result and with_column_types and len(result) == 2:
