...
from azureml.explain.model.common.constants import ModelTask, ExplainParams
...
class BlackBoxMixin(ChainedIdentity):
    ...
    def _get_ys_dict(self, evaluation_examples, transformations=None, allow_all_transformations=False):
        ...
        :param evaluation_examples: The same ones we usually work with, must be able to be passed into the model or
            or function.
        ...
        :return: The dictionary with none, one, or both of predicted ys and predicted proba ys for eval examples.
        :rtype: dict
        """
        ...
        if self.model is not None:
            ...
            if len(predictions.shape) == 1:
                ys_dict[ExplainParams.EVAL_Y_PRED] = predictions
            else:
                ys_dict[ExplainParams.EVAL_Y_PRED_PROBA] = predictions
        return ys_dict
