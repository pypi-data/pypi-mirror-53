...
def get_argument_parser():
    ...
    # undocumented optional arguments used for Business KPI support, may be made public after GA
    parser.add_argument('--enable-bkpi', action='store_true', help=argparse.SUPPRESS)  # enable Business KPI support if specified in the model configuration. Default is false, to ensure backward compatibility.
