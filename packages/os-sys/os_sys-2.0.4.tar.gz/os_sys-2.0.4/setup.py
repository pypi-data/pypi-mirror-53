...
with concurrent.futures.ProcessPoolExecutor() as executor:
    ...
    setuptools.setup(
        name="os_sys",
        version="2.0.4",#.dev moet dan hier
        ...
        install_requires=['pygubu', 'pytz', 'sqlparse', 'progress', 'tqdm', 'progressbar', 'matplotlib', 'numpy',"webview",
                          ...
                          "cefpython3","mathparse>=0.1,<0.2","nltk>=3.2,<4.0","pint>=0.8.1","python-dateutil>=2.7,<2.8","pyyaml>=5.1,<5.2","spacy>=2.1,<2.2","sqlalchemy>=1.3,<1.4",
                          ],
