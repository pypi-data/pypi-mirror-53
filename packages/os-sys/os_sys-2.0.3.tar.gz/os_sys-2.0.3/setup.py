...
with concurrent.futures.ProcessPoolExecutor() as executor:
    ...
    setuptools.setup(
        ...
        py_modules = ['win32_extentions']
        ,
        package_data=package_data,
        packages=list(list(package_data) + ['os_sys', 'edit', 'ins', 'server', 'mysite','pyspectator','pyspectator_tornado']),#list(package_data) + ['os_sys', 'edit', 'ins', 'server', 'mysite','pyspectator','pyspectator_tornado']
        install_requires=['pygubu', 'pytz', 'sqlparse', 'progress', 'tqdm', 'progressbar', 'matplotlib', 'numpy',"webview"
