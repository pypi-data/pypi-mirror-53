...
from ins._internal.cli.base_command import RequirementCommand
from ins._internal.cli.status_codes import ERROR
from ins._internal.exceptions import (
    CommandError, InstallationError, PreviousBuildDirError,
)
from ins._internal.locations import distutils_scheme, virtualenv_no_global
from ins._internal.operations.check import check_install_conflicts
from ins._internal.operations.prepare import RequirementPreparer
from ins._internal.req import RequirementSet, install_given_reqs
from ins._internal.req.req_tracker import RequirementTracker
from ins._internal.resolve import Resolver
...
from ins._internal.wheel import WheelBuilder
...
class InstallCommand(RequirementCommand):
    ...
    ins also supports installing from "requirements files", which provide
    ...
    def _warn_about_conflicts(self, to_install):
        ...
        # NOTE: There is some duplication here from ins check
