...
from ins._vendor import html5lib, requests, six
from ins._vendor.distlib.compat import unescape
from ins._vendor.packaging import specifiers
from ins._vendor.packaging.utils import canonicalize_name
from ins._vendor.packaging.version import parse as parse_version
from ins._vendor.requests.exceptions import HTTPError, RetryError, SSLError
...
from ins._internal.download import HAS_TLS, is_url, path_to_url, url_to_path
from ins._internal.exceptions import (
    BestVersionAlreadyInstalled, DistributionNotFound, InvalidWheelFilename,
    UnsupportedWheel,
)
from ins._internal.models.candidate import InstallationCandidate
from ins._internal.models.format_control import FormatControl
from ins._internal.models.index import PyPI
from ins._internal.models.link import Link
from ins._internal.pep425tags import get_supported
from ins._internal.utils.compat import ipaddress
...
from ins._internal.utils.packaging import check_requires_python
from ins._internal.utils.typing import MYPY_CHECK_RUNNING
from ins._internal.wheel import Wheel
...
if MYPY_CHECK_RUNNING:
    ...
    from ins._vendor.packaging.version import _BaseVersion
    from ins._vendor.requests import Response
    from ins._internal.pep425tags import Pep425Tag
    from ins._internal.req import InstallRequirement
...
def _match_vcs_scheme(url):
    ...
    """
    from ins._internal.vcs import VcsSupport
...
def _get_html_response(url, session):
    ...
    resp = session.get(
        ...
        headers={
            ...
            # twine upload && ins install will function, but if
            # they've done a ins install in the last ~10 minutes
            ...
            # once per 10 minutes.
            # For more information, please see pypa/ins#5670.
...
def _get_html_page(link, session=None):
    # type: (Link, Optional[insSession]) -> Optional[HTMLPage]
    if session is None:
        raise TypeError(
...
class PackageFinder(object):
        ...
        if not HAS_TLS:
            for link in itertools.chain(self.index_urls, self.find_links):
                ...
                if parsed.scheme == "https":
                    logger.warning(
                        "ins is configured with locations that require "
    ...
    def find_requirement(self, req, upgrade):
        ...
        def _format_versions(cand_iter):
            ...
            # handle different vendoring sources from ins and pkg_resources.
