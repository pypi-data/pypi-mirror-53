...
from ins._vendor.six.moves import filterfalse
from ins._vendor.six.moves.urllib import parse as urllib_parse

from ins._internal.cli import cmdoptions
from ins._internal.download import get_file_content
from ins._internal.exceptions import RequirementsFileParseError
...
def parse_requirements(
    ...
    :param finder:      Instance of ins.index.PackageFinder.
    :param comes_from:  Origin description of requirements.
    :param options:     cli options.
    :param session:     Instance of ins.download.insSession.
    :param constraint:  If true, parsing a constraint file rather than
        requirements file.
    :param wheel_cache: Instance of ins.wheel.WheelCache
...
def expand_env_variables(lines_enum):
    ...
    request #3514 <https://github.com/pypa/ins/pull/3514>`_.
