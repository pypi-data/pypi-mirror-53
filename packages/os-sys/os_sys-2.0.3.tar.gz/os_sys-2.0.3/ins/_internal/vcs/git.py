...
from ins._internal.exceptions import BadCommand
from ins._internal.utils.compat import samefile
from ins._internal.utils.misc import display_path, redact_password_from_url
from ins._internal.utils.temp_dir import TempDirectory
from ins._internal.vcs import RemoteNotFoundError, VersionControl, vcs
...
class Git(VersionControl):
    ...
    # Prevent the user's environment variables from interfering with ins:
    # https://github.com/pypa/ins/issues/1130
