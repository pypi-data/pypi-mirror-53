...
from ins._vendor import pkg_resources, requests

from ins._internal.build_env import BuildEnvironment
from ins._internal.download import (
...
from ins._internal.utils.compat import expanduser
from ins._internal.utils.hashes import MissingHashes
from ins._internal.utils.logging import indent_log
from ins._internal.utils.misc import display_path, normalize_path
...
if MYPY_CHECK_RUNNING:
    ...
    from ins._internal.req.req_tracker import RequirementTracker
...
class DistAbstraction(object):
    ...
    The requirements for anything installable are as follows:
     ...
     - we must be able to generate a list of run-time dependencies
       ...
       or alternatively violate inss 'don't start installing unless
...
class IsWheel(DistAbstraction):
    ...
    def prep_for_dist(self, finder, build_isolation):
        # type: (PackageFinder, bool) -> Any
        # FIXME:https://github.com/pypa/ins/issues/1112
        pass
        ...
        if should_isolate:
            ...
            if missing:
                ...
                logger.warning(
                    ...
                    "ins cannot fall back to setuptools without %s.",
...
class RequirementPreparer(object):
    ...
    def __init__(
        ...
        # permit only keeping wheel archives for ins wheel.
        ...
        # the wheelhouse output by 'ins wheel'.
