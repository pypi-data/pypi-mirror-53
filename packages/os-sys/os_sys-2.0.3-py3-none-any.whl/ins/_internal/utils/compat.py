...
from ins._vendor.six import text_type
...
try:
    ...
    try:
        from ins._vendor import ipaddress  # type: ignore
    except ImportError:
...
def console_to_str(data):
    ...
    # should occur in normal ins use, but there's no harm in checking
    # in case people use ins in (unsupported) unusual situations.
...
def get_path_uid(path):
    ...
    Does not follow symlinks:
        https://github.com/pypa/ins/pull/935#discussion_r5307003
