...
from ins._vendor import pkg_resources, six
from ins._vendor.packaging.requirements import Requirement
from ins._vendor.packaging.utils import canonicalize_name
from ins._vendor.packaging.version import Version
from ins._vendor.packaging.version import parse as parse_version
from ins._vendor.pep517.wrappers import Pep517HookCaller

from ins._internal import wheel
from ins._internal.build_env import NoOpBuildEnvironment
from ins._internal.exceptions import InstallationError
from ins._internal.locations import (
    ins_DELETE_MARKER_FILENAME, running_under_virtualenv,
)
from ins._internal.models.link import Link
from ins._internal.pyproject import load_pyproject_toml, make_pyproject_path
from ins._internal.req.req_uninstall import UninstallPathSet
from ins._internal.utils.compat import native_str
...
from ins._internal.utils.packaging import get_metadata
...
from ins._internal.wheel import move_wheel_files

if MYPY_CHECK_RUNNING:
    from typing import (
        Any, Dict, Iterable, List, Mapping, Optional, Sequence, Union,
    )
    from ins._internal.build_env import BuildEnvironment
    ...
    from ins._vendor.packaging.specifiers import SpecifierSet
    from ins._vendor.packaging.markers import Marker
...
class InstallRequirement(object):
    ...
    def remove_temporary_source(self):
        ...
        if self.source_dir and os.path.exists(
                os.path.join(self.source_dir, ins_DELETE_MARKER_FILENAME)):
    ...
    def ensure_has_source_dir(self, parent_dir):
        ...
        :param parent_dir: The ideal ins parent_dir for the source_dir.
