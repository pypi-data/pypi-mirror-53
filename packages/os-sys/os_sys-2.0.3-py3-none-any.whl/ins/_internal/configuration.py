...
from ins._vendor.six.moves import configparser
...
from ins._internal.utils.misc import ensure_dir, enum
...
class Configuration(object):
    ...
    def _load_config_files(self):
        ...
        if config_files[kinds.ENV][0:1] == [os.devnull]:
            logger.debug(
                ...
                "environment's ins_CONFIG_FILE being os.devnull"
            )
            return
    ...
    def _construct_parser(self, fname):
        ...
        if os.path.exists(fname):
            try:
                ...
                # See https://github.com/pypa/ins/issues/4963
                ...
                # See https://github.com/pypa/ins/issues/4893
    ...
    def _get_environ_vars(self):
        ...
        """Returns a generator with all environmental vars with prefix ins_"""
        for key, val in os.environ.items():
            should_be_yielded = (
                key.startswith("ins_") and
    ...
    def _iter_config_files(self):
        ...
        config_file = os.environ.get('ins_CONFIG_FILE', None)
