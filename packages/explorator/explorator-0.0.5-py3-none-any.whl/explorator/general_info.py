...
def get_total(df, info=['general', 'value', 'counts', 'examples', 'description'], spark=None):
    """
    ...
    tools_spark = {'general': get_spark_df_general_info,
                   'values': get_spark_df_top_column_values,
                   'examples': get_spark_df_examples,
                   'description': get_spark_df_description}
