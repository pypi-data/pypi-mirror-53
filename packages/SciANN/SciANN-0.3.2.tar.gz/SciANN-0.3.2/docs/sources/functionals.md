...
```python
sciann.functionals.functional.Functional(fields=None, variables=None, hidden_layers=None, activation='linear', enrichment='linear', kernel_initializer=<keras.initializers.VarianceScaling object at 0x1301c2e10>, bias_initializer=<keras.initializers.RandomUniform object at 0x1301c2eb8>, dtype=None, trainable=True)
```
...
```python
sciann.functionals.field.Field(name=None, units=1, activation=<function linear at 0x12e459c80>, kernel_initializer=<keras.initializers.VarianceScaling object at 0x1300f4be0>, bias_initializer=<keras.initializers.RandomUniform object at 0x1300f4c88>, trainable=True, dtype=None)
```
