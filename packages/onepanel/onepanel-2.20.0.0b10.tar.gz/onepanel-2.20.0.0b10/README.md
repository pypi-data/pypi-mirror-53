...
```bash
TAG=2.20.0.0b10 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.20.0.0b7 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
