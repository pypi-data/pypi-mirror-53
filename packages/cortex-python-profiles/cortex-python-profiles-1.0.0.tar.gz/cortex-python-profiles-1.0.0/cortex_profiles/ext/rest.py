...
class ProfilesRestClient(_Client):
    ...
    def _build_get_profile_uri(
            cls, profileId:str, schemaId:Optional[str], historic:bool=False, version:Optional[int]=None) -> str:
        """
    ...
    def _get_profile(self, profileId:str, schemaId:Optional[str]=None, historic:bool=False, version:Optional[int]=None) -> Optional[List[dict]]:
        """
    ...
    def describeProfile(
            self, profileId:str, schemaId:str, version:Optional[int]=None) -> Optional[Profile]:
        """
