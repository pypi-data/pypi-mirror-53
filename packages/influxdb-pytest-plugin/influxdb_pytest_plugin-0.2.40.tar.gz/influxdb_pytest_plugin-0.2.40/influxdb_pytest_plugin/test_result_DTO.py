...
class TestResultDTO:
    ...
    def set_tag_values(self, item_nodeid, tags_dict):
        ...
        main_dict.update(tags_dict)
        TestResultDTO.get_test_result_tag_dict(self).update({item_nodeid: main_dict})
    ...
    def set_field_values(self, item_nodeid, fields_dict):
        ...
        TestResultDTO.get_test_result_field_dict(self).update({item_nodeid: main_dict})
