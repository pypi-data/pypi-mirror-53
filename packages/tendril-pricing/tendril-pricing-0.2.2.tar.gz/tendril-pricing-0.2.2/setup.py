...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-pricing',
    project_urls={
        'Documentation': 'https://tendril-pricing.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-pricing/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-pricing',
    },
