...
``tendril-pricing`` can be installed normally from the Python Package Index.
...
`github releases <https://github.com/tendril-framework/tendril-pricing/releases>`_.
...
``tendril-pricing``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-pricing.git
    $ cd tendril-pricing
    $ pip install -e .
