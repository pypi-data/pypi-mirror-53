...
class RestApiClient(object):
    ...
    def log_experiment_output(self, experiment_key, lines, context=None, stderr=False):
        """
        Log an output line.
        """
        stdout_lines = [
            {
                "stderr": stderr,
                "stdout": line + "\n",
                "local_timestamp": get_time_monotonic(),
                "offset": offset,
            }
    ...
    def log_experiment_other(self, experiment_key, key, value):
        """
    ...
    def log_experiment_parameter(self, experiment_key, parameter, value, step=None):
        """
    ...
    def log_experiment_metric(self, experiment_key, metric, value, step=None):
        """
    ...
    def log_experiment_html(self, experiment_key, html, overwrite=False):
        """
