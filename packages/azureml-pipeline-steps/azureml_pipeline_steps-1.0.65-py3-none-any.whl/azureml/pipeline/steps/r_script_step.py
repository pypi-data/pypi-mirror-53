...
class RScriptStep(_PythonScriptStepBase):
    ...
    For an example of using RScriptStep, see the notebook https://aka.ms/pl-get-started.

    .. remarks::

        A RScriptStep is a basic, built-in step to run a R Script on a compute target. It takes
        ...
        The following code example shows using a RScriptStep in a machine learning training scenario. For more
        details on this example, see the article `Create ML pipelines in R
        <https://docs.microsoft.com/en-us/azure/machine-learning/service/how-to-create-your-first-pipeline>`_
