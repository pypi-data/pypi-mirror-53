...
"""Contains fucntionality to add an Azure ML Pipeline step using an existing version of a Module."""
...
class ModuleStep(ModuleStepBase):
    ...
    .. remarks::
        ...
        unit of an Azure Machine Learning pipeline. A ModuleStep is a step in a pipeline that uses
        an existing version of a Module. To define which module version is used in a submitted pipeline,
        define one of the following when creating a ModuleStep:
