...
def configure(configuration, log_level=None, log_prefix=None):
    """
    ...
    :param str log_prefix: prefix every line of log with log_prefix:
    :return: None
    :rtype: NoneType
    ...
    if log_prefix:
        for handler in root_logger.handlers:
            handler.setFormatter(logging.Formatter('{}: %(message)s'.format(log_prefix)))
