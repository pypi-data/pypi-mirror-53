...
class PluginBase:
    ...
    .. py:attribute:: PLUGIN_NAME
        ...
        The :py:attr:`cls.PLUGIN_NAME <PLUGIN_NAME>` class attribute will be used to prefix any logs that the
        plugin emits. It should be set by the plugin developer to identify the plugin in the system logs.
    ...
    def __init__(self, configuration, defaults=None, logger=None):
        ...
        logging.configure(self.plugin_configuration, log_prefix=self.PLUGIN_NAME)
    ...
    def _is_proxy_set_in_config(self):
        return self.plugin_configuration.get('https_proxy', 'server') is not None
