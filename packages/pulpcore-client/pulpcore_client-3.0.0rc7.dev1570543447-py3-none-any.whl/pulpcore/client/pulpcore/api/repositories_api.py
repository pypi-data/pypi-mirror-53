...
class RepositoriesApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'name__in', 'plugin_managed', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'plugin_managed' in local_var_params:
            query_params.append(('plugin_managed', local_var_params['plugin_managed']))  # noqa: E501
