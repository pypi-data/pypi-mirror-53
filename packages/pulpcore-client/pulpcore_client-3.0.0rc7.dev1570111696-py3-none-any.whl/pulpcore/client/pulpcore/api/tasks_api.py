...
class TasksApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['ordering', 'state', 'state__in', 'worker', 'worker__in', 'name__contains', 'started_at__lt', 'started_at__lte', 'started_at__gt', 'started_at__gte', 'started_at__range', 'finished_at__lt', 'finished_at__lte', 'finished_at__gt', 'finished_at__gte', 'finished_at__range', 'parent', 'reserved_resources_record', 'created_resources', 'name', 'started_at', 'finished_at', 'limit', 'offset', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def read_with_http_info(self, task_href, **kwargs):  # noqa: E501
        ...
        all_params = ['task_href', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
