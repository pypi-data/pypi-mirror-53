...
class Task(object):
    ...
    def __init__(self, href=None, created=None, state=None, name=None, started_at=None, finished_at=None, error=None, worker=None, parent=None, spawned_tasks=None, progress_reports=None, created_resources=None, reserved_resources_record=None):  # noqa: E501
