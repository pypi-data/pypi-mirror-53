...
class ResidualsChart(APIObject):
    ...
    ``ResidualsChartRow`` is a list of floats containing the following:
        * Element 0 is the actual target value for the source data row.
        * Element 1 is the predicted target value for that row.
        * Element 2 is the error rate of predicted - actual and is optional.
