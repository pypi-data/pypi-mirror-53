...
class Project(APIObject):
    ...
    def get_associations(self, assoc_type, metric):
        ...
        metric : string
            the specfied association metric, belongs under either association
    ...
    def blend(self, model_ids, blender_method):
        ...
        """
        if blender_method == BLENDER_METHOD.FORECAST_DISTANCE:
            deprecation_warning('BLENDER_METHOD.FORECAST_DISTANCE', '2.18', '2.19',
                                'Use BLENDER_METHOD.FORECAST_DISTANCE_ENET instead.')
