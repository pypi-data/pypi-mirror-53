...
def test_blend_forecast_distance_emits_deprecation_warning():
    job_id = 1
    location = 'https://host_name.com/projects/p-id/modelJobs/{}/'.format(job_id)
    model1 = '57e27abc8e43553e572f8df7'
    model2 = '57e27abc8e43553e572f8df8'
    ...
    responses.add(responses.GET, model_job_url,
                  ...
                  body=json.dumps(model_job_data),
                  content_type='application/json')
    Project('p-id').blend([model1, model2], BLENDER_METHOD.FORECAST_DISTANCE)


@responses.activate
@pytest.mark.usefixtures('known_warning')
def test_check_blend_forecast_distance_emits_deprecation_warning(project, project_url):
    model1 = '1234deadbeefdeadbeef4321'
    model2 = 'feeddeadcafebeef43211234'
    url = '{}blenderModels/blendCheck/'.format(project_url)
    response_body = {
    ...
    responses.add(responses.POST, url, json=response_body, content_type='application/json')
    project.check_blendable([model1, model2], BLENDER_METHOD.FORECAST_DISTANCE)
