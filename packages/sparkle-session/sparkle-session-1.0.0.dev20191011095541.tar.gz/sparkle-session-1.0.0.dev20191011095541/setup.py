...
if __name__ == '__main__':
    setup(
        ...
        version = '1.0.0.dev20191011095541',
        description = 'Spark Session and DataFrame extensions',
        long_description = 'Spark session and dataframe extions, common patterns and repeated code from dozens of pyspark projects available at your fingertips',
