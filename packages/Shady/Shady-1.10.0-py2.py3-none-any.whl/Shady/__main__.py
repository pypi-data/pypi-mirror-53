...
subcommands = dict(
	...
	world = lambda: Shady.Utilities.RunShadyScript( '--skipShadyInteractionUntilTheEnd', 'world', *sys.argv[ 1: ] ), # this is an appallingly hacky workaround for *one* common way in which issue #25 rears its ugly head: https://bitbucket.org/snapproject/shady-hg/issues/25/
