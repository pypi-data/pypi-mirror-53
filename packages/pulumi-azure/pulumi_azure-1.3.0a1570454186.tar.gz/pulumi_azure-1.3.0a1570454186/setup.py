...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.3.0-alpha.1570454186+gc9f030c6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.3.0-alpha.1570454186+gc9f030c6`
                """)
            else:
                raise
