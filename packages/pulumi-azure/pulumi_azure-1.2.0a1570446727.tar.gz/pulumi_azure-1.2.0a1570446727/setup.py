...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.2.0-alpha.1570446727+ge6628ed3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.2.0-alpha.1570446727+ge6628ed3`
                """)
            else:
                raise
