...
class PoolKeiosZMQ(ZMQServer):
    ...
    def _callback_worker(self):
        ...
        while True:
            ...
            try:
                self._outbound_queue.put(ZMQMessage(work_item.identifier, self._message_handler.handle(work_item.payload)))
    ...
    def _outbound_worker(self):
        ...
        while True:
            ...
            try:
                self._socket.send_multipart([to_send.identifier, to_send.payload])
