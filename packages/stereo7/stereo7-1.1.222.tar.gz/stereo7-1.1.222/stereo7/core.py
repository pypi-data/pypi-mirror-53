...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        sys.argv.extend('robo-test -r /Volumes/Elements/work/td_core/projects/syndicate-4 -binary_path /Volumes/Elements/work/Build/syndicate4/outputs/apk/release/syndicate4-release.apk'.split(' '))
    main()
