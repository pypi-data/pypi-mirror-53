...
class InceptionV4(object):
    ...
    def inception_a(self, input_tensor, batch_normalization=True):
        ...
        with tf.compat.v1.variable_scope(self.scope, 'BlockInceptionA', [input_tensor]):
            ...
            with tf.compat.v1.variable_scope('Branch_3'):
                conv_6 = convolution_2d(input_tensor=input_tensor, number_filters=64, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0d_1x1')
                conv_7 = convolution_2d(input_tensor=conv_6, number_filters=96, kernel_sizes=(3,3) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1d_3x3')
                conv_8 = convolution_2d(input_tensor=conv_7, number_filters=96, kernel_sizes=(3,3) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='2d_3x3')
    ...
    def reduction_a(self, input_tensor, batch_normalization=True):
        ...
        with tf.compat.v1.variable_scope(self.scope, 'BlockReductionA', [input_tensor]):
            ...
            with tf.compat.v1.variable_scope('Branch_1'):
                conv_1 = convolution_2d(input_tensor=input_tensor, number_filters=384, kernel_sizes=(3,3) , stride_sizes=(2,2), paddings='VALID', activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0b_3x3')
            with tf.compat.v1.variable_scope('Branch_2'):
                conv_2 = convolution_2d(input_tensor=input_tensor, number_filters=192, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0c_1x1')
                conv_3 = convolution_2d(input_tensor=conv_2, number_filters=224, kernel_sizes=(3,3) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1c_3x3')
                conv_4 = convolution_2d(input_tensor=conv_3, number_filters=256, kernel_sizes=(3,3) , paddings='VALID', stride_sizes=(2,2), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0d_1x1')
            with tf.compat.v1.variable_scope('Concatenate_1'):
    ...
    def inception_b(self, input_tensor, batch_normalization=True):
        ...
        with tf.compat.v1.variable_scope(self.scope, 'BlockInceptionB', [input_tensor]):
            with tf.compat.v1.variable_scope('Branch_0'):
                avg_pool_1 = avarage_pool_2d(input_tensor=input_tensor, kernel_sizes=(3,3), paddings='SAME', stride_sizes=(1,1), names='0a_3x3')
                conv_1 = convolution_2d(input_tensor=avg_pool_1, number_filters=128, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1a_1x1')
            with tf.compat.v1.variable_scope('Branch_1'):
                conv_2 = convolution_2d(input_tensor=input_tensor, number_filters=384, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0b_1x1')
            with tf.compat.v1.variable_scope('Branch_2'):
                conv_3 = convolution_2d(input_tensor=input_tensor, number_filters=192, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0c_1x1')
                conv_4 = convolution_2d(input_tensor=conv_3, number_filters=224, kernel_sizes=(7,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1c_7x1')
                conv_5 = convolution_2d(input_tensor=conv_4, number_filters=256, kernel_sizes=(1,7) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='2c_1x7')
            with tf.compat.v1.variable_scope('Branch_3'):
                conv_6 = convolution_2d(input_tensor=input_tensor, number_filters=192, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0d_1x1')
                conv_7 = convolution_2d(input_tensor=conv_6, number_filters=192, kernel_sizes=(1,7) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1d_1x7')
                conv_8 = convolution_2d(input_tensor=conv_7, number_filters=224, kernel_sizes=(7,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='2d_7x1')
                conv_9 = convolution_2d(input_tensor=conv_8, number_filters=224, kernel_sizes=(1,7) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='3d_1x7')
                conv_10 = convolution_2d(input_tensor=conv_9, number_filters=256, kernel_sizes=(7,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='4d_7x1')
            with tf.compat.v1.variable_scope('Concatenate_1'):
    ...
    def reduction_b(self, input_tensor, batch_normalization=True):
        ...
        with tf.compat.v1.variable_scope(self.scope, 'BlockReductionB', [input_tensor]):
            with tf.compat.v1.variable_scope('Branch_0'):
                max_pool_1 = max_pool_2d(input_tensor=input_tensor, pool_sizes=(3,3), stride_sizes=(2,2), paddings='VALID', names='0a_3x3')
            with tf.compat.v1.variable_scope('Branch_1'):
                conv_1 = convolution_2d(input_tensor=input_tensor, number_filters=256, kernel_sizes=(1,1) , stride_sizes=(1,1), paddings='SAME', activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0b_1x1')
                conv_2 = convolution_2d(input_tensor=conv_1, number_filters=192, kernel_sizes=(3,3) , stride_sizes=(2,2), paddings='VALID', activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0b_1x1')
            with tf.compat.v1.variable_scope('Branch_2'):
                conv_3 = convolution_2d(input_tensor=input_tensor, number_filters=256, kernel_sizes=(1,1) , stride_sizes=(1,1), paddings='SAME', activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0c_1x1')
                conv_4 = convolution_2d(input_tensor=conv_3, number_filters=256, kernel_sizes=(1,7) , stride_sizes=(1,1), paddings='SAME', activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1c_1x7')
                conv_5 = convolution_2d(input_tensor=conv_4, number_filters=320, kernel_sizes=(7,1) , stride_sizes=(1,1), paddings='SAME', activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='2c_7x1')
                conv_6 = convolution_2d(input_tensor=conv_5, number_filters=320, kernel_sizes=(3,3) , stride_sizes=(2,2), paddings='VALID', activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='3c_3x3')
    ...
    def inception_c(self, input_tensor, batch_normalization=True):
        ...
        with tf.compat.v1.variable_scope(self.scope, 'BlockInceptionC', [input_tensor]):
            with tf.compat.v1.variable_scope('Branch_0'):
                avg_pool_1 = avarage_pool_2d(input_tensor=input_tensor, kernel_sizes=(3,3), paddings='SAME', stride_sizes=(1,1), names='0a_3x3')
                conv_1 = convolution_2d(input_tensor=avg_pool_1, number_filters=256, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1a_1x1')
            with tf.compat.v1.variable_scope('Branch_1'):
                conv_2 = convolution_2d(input_tensor=input_tensor, number_filters=256, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0b_1x1')
            with tf.compat.v1.variable_scope('Branch_2'):
                conv_3 = convolution_2d(input_tensor=input_tensor, number_filters=384, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0c_1x1')
                with tf.compat.v1.variable_scope('Branch_21'):
                    conv_4 = convolution_2d(input_tensor=conv_3, number_filters=256, kernel_sizes=(1,3) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1c1_1x3')
                with tf.compat.v1.variable_scope('Branch_22'):
                    conv_5 = convolution_2d(input_tensor=conv_3, number_filters=256, kernel_sizes=(3,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1c2_3x1')
            with tf.compat.v1.variable_scope('Branch_3'):
                conv_6 = convolution_2d(input_tensor=input_tensor, number_filters=384, kernel_sizes=(1,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='0d_1x1')
                conv_7 = convolution_2d(input_tensor=conv_6, number_filters=448, kernel_sizes=(1,3) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='1d_1x3')
                conv_8 = convolution_2d(input_tensor=conv_7, number_filters=512, kernel_sizes=(3,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='2d_3x1')
                with tf.compat.v1.variable_scope('Branch_31'):
                    conv_9 = convolution_2d(input_tensor=conv_8, number_filters=256, kernel_sizes=(3,1) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='3d1_3x1')
                with tf.compat.v1.variable_scope('Branch_32'):
                    conv_10 = convolution_2d(input_tensor=conv_8, number_filters=256, kernel_sizes=(1,3) , paddings='SAME', stride_sizes=(1,1), activations='relu', batch_normalizations=batch_normalization, dropout_rates=self.dropout_rate, name='3d2_1x3')
            with tf.compat.v1.variable_scope('Concatenate_1'):
