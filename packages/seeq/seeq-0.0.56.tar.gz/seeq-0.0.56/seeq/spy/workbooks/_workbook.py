...
class Workbook(ItemWithOwnerAndAcl):
    ...
    @staticmethod
    def _scrape_auth_datasource(d, key, referenced_datasources):
    ...
    def _scrape_datasource_inventory(self):
        ...
        Workbook._scrape_auth_datasource(self, 'Owner', referenced_datasources)
        if 'Access Control' in self:
            for acl in self['Access Control']:
                Workbook._scrape_auth_datasource(acl, 'Identity', referenced_datasources)
...
class StoredOrCalculatedItem(Item):
    ...
    def push_ancillaries(self, pushed_item):
