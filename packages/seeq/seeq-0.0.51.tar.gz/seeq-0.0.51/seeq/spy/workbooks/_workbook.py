...
class Item:
    def __init__(self, definition=None, *, original_item_map=None):
    ...
    @staticmethod
    def pull(item_id, *, original_item_map=None, allowed_types=None):
        ...
        item = derived_class(definition, original_item_map=original_item_map)
...
class Workbook(Item):
    ...
    def push(self, owner_id=None, folder_id=None, item_map=None, label=None):
