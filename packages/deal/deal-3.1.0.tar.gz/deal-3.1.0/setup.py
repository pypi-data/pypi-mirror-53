...
setup(
    ...
    packages=['deal'],
    package_data={},
    install_requires=['hypothesis', 'typeguard'],
    extras_require={
        'dev': [
            'coverage', 'm2r', 'marshmallow', 'pytest', 'recommonmark',
            'sphinx', 'sphinx-rtd-theme', 'urllib3', 'vaa>=0.1.4'
        ],
        'tests': ['coverage', 'marshmallow', 'pytest', 'urllib3', 'vaa>=0.1.4'],
        'docs':
