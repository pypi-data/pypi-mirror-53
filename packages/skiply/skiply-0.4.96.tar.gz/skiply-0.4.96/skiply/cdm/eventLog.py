...
class EventLog(Base):
    ...
    log_flag = Column(String(64), nullable=False)
    log_message = Column(JSON)
    log_timestamp = Column(DateTime, default=datetime.datetime.utcnow, nullable=False)
    log_type = Column(String(64), nullable=False)

    device_skiply_id = Column(String(255), nullable=False)
