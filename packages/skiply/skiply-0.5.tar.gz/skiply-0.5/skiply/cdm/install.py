...
class Installation(Base):
    ...
    install_standalone_inst = Column('standalone_inst', oolean, default=False, nullable=False)
    
    endpoint = Column('endpoint', String(500))

    install_inst_id = Column('install_inst_id', Integer, db.ForeignKey("i_install_instructions.id"), nullable=False)
