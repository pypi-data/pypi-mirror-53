...
class Location(Node):
    ...
    def _get_spec(self):
        ...
        Returns:
            The Message Spec of the Location Beacon.
        """
        if self.msg_spec_version.minor == 1:
            return LocationDownlinkMessageSpecV1()
        elif self.msg_spec_version.minor == 2:
            return LocationDownlinkMessageSpecV2()
        elif self.msg_spec_version.minor == 3:
            return LocationDownlinkMessageSpecV3()
        else:
            raise NotImplementedError

    def configure(self, ttl_s, **kwargs):
