...
class AccessPoint(Module, AirfinderSubject):
    ...
    def send_unicast_message(self, endnode, payload, ble_ttl_s, uuid=None,
        ...
        pld = self._get_spec().build_message('Unicast',
                                             endnode_addr=bytearray(endnode),
    ...
    def assert_count(self):
        ...
        otherwise. """
        val = self.metadata_json.get('assertCount')
    ...
    def last_assert_info(self):
        ...
        assert_occured = self.metadata_json.get('assertOccured')
        line_num = self.metadata_json.get('assertLineNumber')
        file_name = self.metadata_json.get('assertFileName')
    ...
    def downlink_counts(self):
        ...
        uni = self.metadata_json.get('downlinkUnicastCount')
        multi = self.metadata_json.get('downlinkMulticastCount')
    ...
    def reset_count(self):
        ...
        otherwise. """
        val = self.metadata_json.get('resetCount')
        return int(val) if val else None
    ...
    def rp_count(self):
        ...
        available, None otherwise. """
        val = self.metadata_json.get('rpCount')
        return int(val) if val else None
    ...
    def rssi_collect_time(self):
        ...
        available, None otherwise. """
        val = self.metadata_json.get('rssiCollectTime')
        return parse_time(val) if val else None

    @property
    def last_payload_len(self):
        """ Returns the last payload length when available, None otherwise. """
        val = self.metadata_json.get('symMsgPayloadLength')
        return int(val) if val else None
    ...
    def version(self):
        ...
        None otherwise."""
        major = self.metadata_json.get('symbleAPFirmwareVersionMajor')
        minor = self.metadata_json.get('symbleAPFirmwareVersionMinor')
        tag = self.metadata_json.get('symbleAPFirmwareVersionTag')
        return Version(major, minor, tag)

    @property
    def symble_version(self):
        """ Returns the SymBLE Version when available, None otherwise. """
        val = self.metadata_json.get('symbleVersion')
    ...
    def sys_time(self):
        ...
        available, None otherwise. """
        val = self.metadata_json.get('systemTimestamp_epochSeconds')
    ...
    def task_stats(self):
        ...
        try:
            return TaskStats(
                int(self.metadata_json.get("taskBHConnectionErrorCount")),
                int(self.metadata_json.get("taskBHTaskErrorCount")),
                int(self.metadata_json.get("taskBHTimeoutErrorCount")),
                int(self.metadata_json.get("taskBHTxErrorCount")),
                int(self.metadata_json.get("taskBLEConnectionCount")),
                int(self.metadata_json.get("taskBLEDisconnectionCount")),
                int(self.metadata_json.get("taskBLEErrorCount")),
                int(self.metadata_json.get("taskCacheErrorCount")),
                int(self.metadata_json.get("taskErrorCount")))
        except ValueError:
            return None
    ...
    def uplink_queue_stats(self):
        ...
        try:
            return UplinkQueueStats(
                    int(self.metadata_json.get("uplinkQueueFillLevel")),
                    int(self.metadata_json.get("uplinkQueueMsgCount")))
        except ValueError:
            return None
