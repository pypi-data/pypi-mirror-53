...
class ConductorSubject(object):
    ...
    def _validate_http_rsp(self, resp):
        ...
        try:
            ...
            LOG.critical("Call to {} FAILED!".format(resp.url))
            msg = None
            try:
                json = resp.json()
...
class UplinkSubjectBase(ConductorSubject):
    ...
    def get_messages_time_range(self, start, stop=None):
        ...
        while more_results:
            ...
            messages.extend([self.msg_obj(self.session, m.get('uuid'),
                                         self.instance, m)
    ...
    def get_last_messages(self, count=1):
        ...
        messages = [self.msg_obj(self.session, m.get('uuid'), self.instance, m)
    ...
    def subscribe(self, callback):
        ...
        class Subscription():
            ...
            def _received_message(self, message):
                callback(self.msg_obj(self.session, self.instance,
