...
def add_quyu_app(quyu,loc="aliyun"):
    ...
    tbs=['qy_zhongbiao','xmjl_zhongbiao','bd_dt','t_gg_ent_bridge','app_qy_zz','app_qy_zcry','app_qy_query']
    for tb in tbs:
    ...
    db_command(sql1,dbtype="postgresql",conp=conp_pg)
    pg2pg(sql,'gg_html_algo_cdc',conp_gp,conp_pg,chunksize=10000,datadict=datadict,if_exists='replace')
