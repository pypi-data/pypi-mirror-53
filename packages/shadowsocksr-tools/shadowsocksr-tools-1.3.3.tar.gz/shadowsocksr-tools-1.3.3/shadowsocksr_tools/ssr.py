...
class SSR:
    ...
    @property
    def hash_md5(self):
        return hashlib.md5('{}:{}'.format(self._server_ip, self.port).encode('utf-8')).hexdigest()

    @property
    def hash_sha256(self):
        return hashlib.sha256('{}:{}'.format(self._server_ip, self.port).encode('utf-8')).hexdigest()
