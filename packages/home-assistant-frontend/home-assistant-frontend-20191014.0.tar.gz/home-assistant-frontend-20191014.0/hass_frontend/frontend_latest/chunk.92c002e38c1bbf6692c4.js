...
`},229:function(t,e,i){"use strict";var n=i(3),a=i(0),s=(i(108),i(18));i(189);let o=class extends a.a{render(){return this.entities?a.f`
      <h3>
    ...
    `}};Object(n.c)([Object(a.g)()],o.prototype,"hass",void 0),Object(n.c)([Object(a.g)()],o.prototype,"entities",void 0),Object(n.c)([Object(a.g)()],o.prototype,"label",void 0),o=Object(n.c)([Object(a.d)("hui-entity-editor")],o)},268:function(t,e,i){"use strict";function n(t){return t.map(t=>"string"==typeof t?{entity:t}:t)}i.d(e,"a",function(){return n})},697:function(t,e,i){"use strict";i.r(e),i.d(e,"HuiHistoryGraphCardEditor",function(){return h});var n=i(3),a=i(0),s=(i(93),i(229),i(192)),o=i(18),c=i(268),l=i(200);const r=s.a.union([{entity:"entity-id",name:"string?"},"entity-id"]),d=Object(s.a)({type:"string",entities:[r],title:"string?",hours_to_show:"number?",refresh_interval:"number?"});let h=class extends a.a{setConfig(t){t=d(t),this._config=t,this._configEntities=Object(c.a)(t.entities)}get _entity(){return this._config.entity||""}get _title(){return this._config.title||""}get _hours_to_show(){return this._config.number||24}get _refresh_interval(){return this._config.number||0}render(){return this.hass?a.f`
      ${l.a}
...
//# sourceMappingURL=chunk.92c002e38c1bbf6692c4.js.map