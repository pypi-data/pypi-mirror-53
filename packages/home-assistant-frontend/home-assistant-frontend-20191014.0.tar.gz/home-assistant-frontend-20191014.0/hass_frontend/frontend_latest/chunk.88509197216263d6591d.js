...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget(),this.classList.add("no-padding")},attached:function(){this._ensureTarget(),requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",this.scrollTarget.scrollTop>0),this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight),this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement,this.dialogElement&&this.dialogElement.behaviors&&this.dialogElement.behaviors.indexOf(n.b)>=0?(this.dialogElement.sizingTarget=this.scrollTarget,this.scrollTarget.classList.remove("fit")):this.dialogElement&&this.scrollTarget.classList.add("fit")}})},502:function(t,i,e){"use strict";e.r(i);var n=e(3),a=e(0),o=(e(209),e(93),e(197),e(201),e(56)),s=e(121),l=e(176),r=e(258);class c extends a.a{async showDialog(t){this._params=t,this._error=void 0,this._name=this._params.entry.name||"",this._platform=this._params.entry.platform,this._origEntityId=this._params.entry.entity_id,this._entityId=this._params.entry.entity_id,this._disabledBy=this._params.entry.disabled_by,await this.updateComplete}render(){if(!this._params)return a.f``;const t=this._params.entry,i=this.hass.states[t.entity_id],e=Object(s.a)(this._entityId.trim())!==Object(s.a)(this._params.entry.entity_id);return a.f`
    ...
    `}_nameChanged(t){this._error=void 0,this._name=t.detail.value}_entityIdChanged(t){this._error=void 0,this._entityId=t.detail.value}async _updateEntry(){this._submitting=!0;try{await Object(r.d)(this.hass,this._origEntityId,{name:this._name.trim()||null,disabled_by:this._disabledBy,new_entity_id:this._entityId.trim()}),this._params=void 0}catch(t){this._error=t.message||"Unknown error"}finally{this._submitting=!1}}async _deleteEntry(){if(confirm(`${this.hass.localize("ui.panel.config.entity_registry.editor.confirm_delete")}\n\n${this.hass.localize("ui.panel.config.entity_registry.editor.confirm_delete2","platform",this._platform)}`)){this._submitting=!0;try{await Object(r.b)(this.hass,this._entityId),this._params=void 0}finally{this._submitting=!1}}}_openedChanged(t){t.detail.value||(this._params=void 0)}_disabledByChanged(t){this._disabledBy=t.target.checked?null:"user"}static get styles(){return[o.b,a.c`
      ...
      `]}}Object(n.c)([Object(a.g)()],c.prototype,"hass",void 0),Object(n.c)([Object(a.g)()],c.prototype,"_name",void 0),Object(n.c)([Object(a.g)()],c.prototype,"_platform",void 0),Object(n.c)([Object(a.g)()],c.prototype,"_entityId",void 0),Object(n.c)([Object(a.g)()],c.prototype,"_disabledBy",void 0),Object(n.c)([Object(a.g)()],c.prototype,"_error",void 0),Object(n.c)([Object(a.g)()],c.prototype,"_params",void 0),Object(n.c)([Object(a.g)()],c.prototype,"_submitting",void 0),customElements.define("dialog-entity-registry-detail",c)}}]);
//# sourceMappingURL=chunk.88509197216263d6591d.js.map