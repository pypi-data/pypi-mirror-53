...
`},693:function(t,e,i){"use strict";i.r(e),i.d(e,"HuiAlarmPanelCardEditor",function(){return r});var a=i(3),s=i(0),n=(i(146),i(143),i(145),i(192)),o=i(18),c=i(200);i(189),i(179);const l=Object(n.a)({type:"string",entity:"string?",name:"string?",states:"array?"});let r=class extends s.a{setConfig(t){t=l(t),this._config=t}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}get _states(){return this._config.states||[]}render(){if(!this.hass)return s.f``;return s.f`
      ${c.a}
...
//# sourceMappingURL=chunk.7dc9068601946f740f03.js.map