...
`},246:function(e,t,i){"use strict";var a=i(3),n=i(0),s=(i(85),i(18));let o=class extends n.a{render(){const e=["Backend-selected","default"].concat(Object.keys(this.hass.themes.themes).sort());return n.f`
      <paper-dropdown-menu
    ...
    `}_changed(e){this.hass&&""!==e.target.value&&(this.value=e.target.value,Object(s.a)(this,"theme-changed"))}};Object(a.c)([Object(n.g)()],o.prototype,"value",void 0),Object(a.c)([Object(n.g)()],o.prototype,"label",void 0),Object(a.c)([Object(n.g)()],o.prototype,"hass",void 0),o=Object(a.c)([Object(n.d)("hui-theme-select-editor")],o)},707:function(e,t,i){"use strict";i.r(t),i.d(t,"HuiSensorCardEditor",function(){return r});var a=i(3),n=i(0),s=(i(93),i(146),i(143),i(145),i(246),i(189),i(192)),o=i(18),l=i(200);const c=Object(s.a)({type:"string",entity:"string?",name:"string?",icon:"string?",graph:"string?",unit:"string?",detail:"number?",theme:"string?",hours_to_show:"number?"});let r=class extends n.a{setConfig(e){e=c(e),this._config=e}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}get _icon(){return this._config.icon||""}get _graph(){return this._config.graph||"none"}get _unit(){return this._config.unit||""}get _detail(){return this._config.number||"1"}get _theme(){return this._config.theme||"default"}get _hours_to_show(){return this._config.hours_to_show||"24"}render(){if(!this.hass)return n.f``;const e=["line","none"];return n.f`
      ${l.a}
...
//# sourceMappingURL=chunk.96d3ca9ebf9b0a4dc63b.js.map