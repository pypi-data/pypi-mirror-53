...
class COM():
    ...
    def set_date(self, time, date):
        ...
        """
        sets the slave time / v00004
        """
        self.modbusclient.write_multiple_registers(0, str2duohex("v00004="+time) )

        """
        sets the slave date / v00005
        """
        self.modbusclient.write_multiple_registers(0, str2duohex("v00005="+date) )
    ...
    def read_management_opt(self):
        ...
        """
        read optimum carbon-dioxide concentration in percent (variable v00038)
        """
        self.modbusclient.write_multiple_registers(0, str2duohex("v00038") )
        carbon_val = duohex2str(self.modbusclient.read_holdingregisters(0,5))[7:]

        """
        read optimum voc concentration in percent (variable v00041)
        """
        self.modbusclient.write_multiple_registers(0, str2duohex("v00041") )
        voc_val = duohex2str(self.modbusclient.read_holdingregisters(0,5))[7:]
    ...
    def state_preheater(self, *preheater):
        ...
        """
        if preheater & isinstance(preheater[0], int):
    ...
    def get_state(self):
        ...
        try:
            ...
            return errortable(string), "error"
            ...
            try:
                ...
                return warningtable(string), "warning"
