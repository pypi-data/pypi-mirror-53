...
from src.pycaptureautomation.color import Colors
from src.pycaptureautomation.capturearea import CaptureArea


class Rectangle:
    def __init__(self, cp_area: CaptureArea, x, y, width, height, color: Colors = Colors.BLACK, line_width=2):
