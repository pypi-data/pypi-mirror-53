...
class DataTransformer(AutoMLTransformer, FeaturizationInfoProvider):
    ...
    def __init__(self,
        ...
        :param jasmine_client: Client for communication with JOS.
        ...
        self._jasmine_client = jasmine_client  # type: Optional[AbstractJasmineClient]
        self.parent_run_id = parent_run_id  # type: Optional[str]
            ...
            if self._enable_feature_sweeping:
                ...
                if feature_sweeper is None:
                    feature_sweeper = MetaSweeper(task=self._task_type,
                                                  ...
                                                  logger=self.logger,
                                                  jasmine_client=self._jasmine_client,
