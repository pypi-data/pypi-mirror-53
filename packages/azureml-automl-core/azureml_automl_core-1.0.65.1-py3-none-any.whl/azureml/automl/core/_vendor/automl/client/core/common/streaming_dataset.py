...
class DatasetMetadataKeys(Enum):
    ...
    transformed_vector_column_names = 'TransformedVectorColumnNames'
    ...
    def _required_keys() -> List['DatasetMetadataKeys']:
        return [DatasetMetadataKeys.training_columns,
...
class StreamingDataset(DatasetBase):
    ...
    def __init__(self,
        ...
        self.training_columns = set(self._dataset_metadata[DatasetMetadataKeys.training_columns])  # type: Set[str]
        ...
        dropped_columns = self._dataset_metadata.get(DatasetMetadataKeys.dropped_columns)
        self.dropped_columns = set() if not dropped_columns else set(dropped_columns)   # type: Set[str]
    ...
    def get_problem_info(self):
        ...
        :return: _ProblemInfo
        """
        feature_column_names = list(self.training_columns - self.dropped_columns)
