...
if nimbusml_present:
    ...
    class LinearSvmBinaryClassifier(NimbusMlClassifierMixin, nml_linear.LinearSvmBinaryClassifier):
        ...
        def get_params(self, deep=True):
            ...
            :return: Parameters for the NimbusML Averaged Perceptron classifier model.
            """
            return super(LinearSvmBinaryClassifier, self).get_params(deep)
    ...
    class LinearSvmMulticlassClassifier(NimbusMlClassifierMixin, nml_multiclass.OneVsRestClassifier):
        ...
        def get_params(self, deep=True):
            """
            Return parameters for NimbusML Linear SVM Classifier model.

            :param deep: If True, will return the parameters for this estimator and contained subobjects that are
                estimators.
            :type deep: boolean
            :return: Parameters for the NimbusML Linear SVM classifier model.
            """
            # TODO: Fix this as it is not applicable anymore
            return super(LinearSvmMulticlassClassifier, self).get_params(deep)
