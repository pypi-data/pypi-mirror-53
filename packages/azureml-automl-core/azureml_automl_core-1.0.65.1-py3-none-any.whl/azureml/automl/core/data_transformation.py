...
def transform_data(raw_data_context: RawDataContext,
    ...
    :param jasmine_client: Used for communication with JOS.
...
def transform_data_streaming(raw_data_context: RawDataContext,
    ...
    if preprocess:
        ...
        result.training_columns = streaming_featurizer._training_columns
        result.dropped_columns = streaming_featurizer._dropped_columns
        result.set_transformed_vector_column_names(streaming_featurizer.get_transformed_vector_column_names())
...
def _get_transformer_x(x: DataInputType,
                       ...
                       jasmine_client: Optional[AbstractJasmineClient] = None,
                       parent_run_id: Optional[str] = None) -> Tuple[DataTransformer, Any, str]:
    """
    ...
    :param jasmine_client: Jasmine client instance to talk to JOS.
    :param parent_run_id: Parent run id.
