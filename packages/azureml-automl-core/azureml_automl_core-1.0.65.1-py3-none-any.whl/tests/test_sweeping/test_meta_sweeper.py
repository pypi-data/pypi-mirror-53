...
from ..utilities import MockJasmineClient
...
class MetaSweeperStub(MetaSweeper):
    def __init__(self, task: str,
        ...
        super(MetaSweeperStub, self).__init__(task=task,
                                              ...
                                              jasmine_client=MockJasmineClient(self._config_overrides),
                                              parent_run_id="AutoMLRun")
...
def _test_sweep(task, config_overrides, result_expected=True, row_counts=300,
    ...
    meta_sweeper = MetaSweeperStub(task, config_overrides=config_overrides,
                                   featurization_config=featurization_config)
    meta_sweeper._is_cross_validation = is_cross_validation
...
def _test_engineering_feature_names(task, config_overrides, dataset_name='newsgroup20'):
    ...
    transformer = pp.DataTransformer("classification",
                                     ...
                                     jasmine_client=MockJasmineClient(),
                                     parent_run_id="AutoMLRun")
...
class MetaSweeperTest(unittest.TestCase):
    ...
    def test_blockled_transformers(self):
        config = {
            "classification": {
                "sweeping_enabled": True,
                "page_sampled_data_to_disk": True,
    ...
    def test_build_sampler(self):
        ...
        s = MetaSweeper("classification", jasmine_client=MockJasmineClient(), parent_run_id="AutoMLRun").\
    ...
    @unittest.skip("Seed required to stabilize test")
    ...
    def test_classification_sweep_bilstm(self):
        ...
        _test_sweep(constants.Tasks.CLASSIFICATION, config, row_counts=1000,
    ...
    def test_sweeper_enabled(self):
        config = {
            "classification": {
                ...
                "page_sampled_data_to_disk": True,
                "run_sweeping_in_isolation": True,
                "enabled_sweepers": [MetaSweeperTest.word_embeddings_sweeper, MetaSweeperTest.lstm_sweeper]
            }
        }
