...
from automl.client.core.common.nimbus_wrappers import AveragedPerceptronBinaryClassifier, \
...
class NimbusMLObject(ObjectSpec):
    ...
    def prepare_kwargs(self, cls, problem_info,
        ...
        from automl.client.core.common.streaming_dataset import DatasetMetadataKeys
        if problem_info.enable_streaming and (
            ...
            if dataset_metadata and\
                    dataset_metadata.get(DatasetMetadataKeys.transformed_vector_column_names) is not None:
                self.prepared_kwargs['feature'] = \
                    dataset_metadata[DatasetMetadataKeys.transformed_vector_column_names]
            else:
