...
class SupportedTransformers:
    ...
    NimbusMLImputer = 'NimbusMLImputer'
    ...
    NimbusMLOneHotEncoder = 'NimbusMLOneHotEncoder'
    NimbusMLOneHotHashEncoder = 'NimbusMLOneHotHashEncoder'
    ...
    NimbusMLNGramFeaturizer = 'NimbusMLNGramFeaturizer'
