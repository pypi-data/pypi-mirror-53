"""
 * $Id: 0.8+14 utils.py 7495965f5725 2019-09-24 od $
 *
...
class Client(object):
    ...
    def pubsub(self, url: str, callback=None) -> None:
        ...
        if has(self, "bearertoken"):
            h["Authorization"] = 'Bearer ' + self.bearertoken

        for file in glob.iglob(self.files):
    ...
    def set_bearertoken(self, token: str) -> None:
        self.bearertoken = token

    def get_bearertoken(self) -> str:
        return self.bearertoken

    def set_webhook(self, hook: str) -> None:
        self.webhook = hook

    def set_batch(self, files: str) -> None:
        """For pubsub"""
        self.files = files
