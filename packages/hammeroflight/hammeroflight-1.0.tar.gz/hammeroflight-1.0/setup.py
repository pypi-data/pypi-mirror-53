...
setup(
  ...
  description = 'The Library is practical for Data Analysis which facilitates viewing dataset integrity reports'
                'comparing accuracy scores of ML algorithms, cleaning and encoding dataset etc. ',
  ...
  keywords = ['data cleaning', 'accuracy scores', 'comparisons of ml algo', 'dataset reports'],   # Keywords that define your package best
