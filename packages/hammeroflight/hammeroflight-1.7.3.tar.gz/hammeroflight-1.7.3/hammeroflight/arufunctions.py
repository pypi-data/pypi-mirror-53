...
def integrity_report1(val):
    ...
    ax1.pie(piedata, labels=labels1, explode=None, radius=2.65, autopct='%1.1f%%',
            colors=['limegreen', 'mediumseagreen', 'forestgreen'], startangle=70)
    ax2.pie(missdata, labels=labels2, explode=None, radius=2.65, autopct='%1.1f%%', colors=['pink', 'lightcoral'],
            startangle=310)
    ax3.pie(catnum, labels=labels3, explode=None, radius=2.65, autopct='%1.1f%%',
