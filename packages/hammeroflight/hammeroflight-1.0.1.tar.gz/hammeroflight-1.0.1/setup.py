...
setup(
  ...
  description = 'The Library is practical for Data Analysis which facilitates viewing Dataset Integrity Reports, '
                'Viewing Accuracy Scores of Regressive and Classification algorithms, Cleaning and Encoding '
                'Dataset and estimating goodness of fit. Train Test Split method is required for functioning. ',
  ...
  keywords = ['data cleaning', 'accuracy scores', 'goodness of fit', 'dataset quality report'],   # Keywords that define your package best
