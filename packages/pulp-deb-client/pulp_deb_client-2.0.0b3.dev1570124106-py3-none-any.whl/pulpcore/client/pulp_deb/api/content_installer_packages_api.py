...
class ContentInstallerPackagesApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['package', 'source', 'version', 'architecture', 'section', 'priority', 'origin', 'tag', 'essential', 'build_essential', 'installed_size', 'maintainer', 'original_maintainer', 'built_using', 'auto_built_package', 'multi_arch', 'sha256', 'repository_version', 'repository_version_added', 'repository_version_removed', 'limit', 'offset', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
