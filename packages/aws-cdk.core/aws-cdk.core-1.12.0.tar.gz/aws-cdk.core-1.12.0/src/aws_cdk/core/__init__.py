...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/core", "1.12.0", __name__, "core@1.12.0.jsii.tgz")
...
class ConstructNode(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.ConstructNode"):
    ...
    def default_child(self) -> typing.Optional["IConstruct"]:
        """Returns the child construct that has the id ``Default`` or ``Resource"``. This is usually the construct that provides the bulk of the underlying functionality. Useful for modifications of the underlying construct that are not avialable at the higher levels. Override the defaultChild property.
