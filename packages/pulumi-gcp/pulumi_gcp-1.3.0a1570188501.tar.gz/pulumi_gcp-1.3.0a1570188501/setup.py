...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.3.0-alpha.1570188501+g82e8da0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.3.0-alpha.1570188501+g82e8da0`
                """)
            else:
                raise
