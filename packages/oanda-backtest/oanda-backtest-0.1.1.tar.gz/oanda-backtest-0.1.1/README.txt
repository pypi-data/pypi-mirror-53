...
.. |PyPI - Python Version| image:: https://img.shields.io/pypi/pyversions/oanda-backtest
   :target: https://pypi.org/project/oanda-backtest/
.. |backtest.png| image:: https://github.com/10mohi6/oanda-backtest-python/blob/master/tests/backtest.png
   :target: https://github.com/10mohi6/oanda-backtest-python/blob/master/tests/backtest.png
