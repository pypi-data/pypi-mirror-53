...
class CS4x4:
    ...
    def __init__(self, axis0: Union[np.ndarray, List[float]] = None, axis1: Union[np.ndarray, List[float]] = None,
                 axis2: Union[np.ndarray, List[float]] = None, origin: Union[np.ndarray, List[float]] = None):
        """
        局部坐标系
    ...
    def ary4x4(self, ary: Union[np.ndarray, List[float]] = None) -> np.ndarray:
        ...
        """
        if ary is not None:
            self._axis3x3 = np.array([ary[0][:3], ary[1][:3], ary[2][:3]])
