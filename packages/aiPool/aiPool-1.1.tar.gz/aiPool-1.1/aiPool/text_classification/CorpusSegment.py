...
from aiPool.text_classification.Tools import savefile, readfile

logger = logging.getLogger('corpus_segment')
...
class Segment:
    def corpus_segment(self, corpus_path, seg_path):
        '''
