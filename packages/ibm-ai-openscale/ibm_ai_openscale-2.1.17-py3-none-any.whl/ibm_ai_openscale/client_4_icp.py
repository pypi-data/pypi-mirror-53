...
class APIClient4ICP(APIClientBase):
    ...
    def __init__(self, aios_credentials):
        ...
        old_merge_environment_settings = requests_session.merge_environment_settings # ignore REQUESTS_CA_BUNDLE env variable for ICP
        def modified_merge_environment_settings(url, proxies, stream, verify, cert):
            ...
            result['verify'] = None
            return result
        requests_session.merge_environment_settings = modified_merge_environment_settings
