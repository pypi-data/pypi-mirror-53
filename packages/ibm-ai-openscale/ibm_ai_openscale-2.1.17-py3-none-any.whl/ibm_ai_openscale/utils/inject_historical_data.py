...
def load_historical_kpi_measurement(ai_client, file_path, aios_credentials, monitor_instance_id, business_application_id, day_template="history_payloads_{}.json", days=7, batch_id_start=0, ignore_metrics=None, batch_id_template="batch-id-{}"):
...
def load_historical_payload(ai_client, file_path, aios_credentials, data_set_id, day_template="history_payloads_{}.json", days=7, batch_id_start=0):
    hrefs_v2 = AIHrefDefinitionsV2(aios_credentials)
...
def load_historical_drift_measurement(ai_client, file_path, aios_credentials, monitor_instance_id, business_application_id, day_template="history_payloads_{}.json", days=7, batch_id_start=0, batch_id_template="batch-id-{}", bkpis_file_path=None):
    hrefs_v2 = AIHrefDefinitionsV2(aios_credentials)
