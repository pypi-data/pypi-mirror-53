...
def save_dataset(filepath, exp, stack=None, composite=None, points=None, override=True):
...
def read_experiment(h5file):
    ...
    exp = MappingExperiment(pattern, label)
    return exp
