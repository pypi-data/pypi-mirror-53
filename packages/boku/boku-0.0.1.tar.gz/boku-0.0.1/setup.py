...
setup(
    ...
    url="http://github.com/mardix/bokku/",
    download_url='http://github.com/mardix/bokku/tarball/master',
    py_modules=['bokku'],
    ...
    keywords=['deploy', 'bokku', 'flask', 'gunicorn', 'django', 'workers', 'deploy sites', 'deployapp'],
    platforms='any',
    classifiers=[
