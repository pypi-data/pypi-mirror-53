...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipMemset3DAsync = 39,
  HIP_API_ID_hipMemcpy3D = 40,
  HIP_API_ID_hipInit = 41,
  HIP_API_ID_hipMemcpyAtoH = 42,
  HIP_API_ID_hipStreamGetPriority = 43,
  HIP_API_ID_hipMemset2D = 44,
  HIP_API_ID_hipMemset2DAsync = 45,
  HIP_API_ID_hipDeviceCanAccessPeer = 46,
  HIP_API_ID_hipDeviceEnablePeerAccess = 47,
  HIP_API_ID_hipLaunchKernel = 48,
  HIP_API_ID_hipModuleUnload = 49,
  HIP_API_ID_hipHostUnregister = 50,
  HIP_API_ID_hipProfilerStop = 51,
  HIP_API_ID_hipLaunchByPtr = 52,
  HIP_API_ID_hipStreamSynchronize = 53,
  HIP_API_ID_hipDeviceSetCacheConfig = 54,
  HIP_API_ID_hipGetErrorName = 55,
  HIP_API_ID_hipMemcpyHtoD = 56,
  HIP_API_ID_hipModuleGetGlobal = 57,
  HIP_API_ID_hipMemcpyHtoA = 58,
  HIP_API_ID_hipCtxCreate = 59,
  HIP_API_ID_hipMemcpy2D = 60,
  HIP_API_ID_hipIpcCloseMemHandle = 61,
  HIP_API_ID_hipChooseDevice = 62,
  HIP_API_ID_hipDeviceSetSharedMemConfig = 63,
  HIP_API_ID_hipDeviceComputeCapability = 64,
  HIP_API_ID_hipDeviceGet = 65,
  HIP_API_ID_hipProfilerStart = 66,
  HIP_API_ID_hipCtxSetCacheConfig = 67,
  HIP_API_ID_hipFuncSetCacheConfig = 68,
  HIP_API_ID_hipMemcpyPeerAsync = 69,
  HIP_API_ID_hipEventElapsedTime = 70,
  HIP_API_ID_hipDevicePrimaryCtxReset = 71,
  HIP_API_ID_hipMemcpy3DAsync = 72,
  HIP_API_ID_hipEventDestroy = 73,
  HIP_API_ID_hipCtxPopCurrent = 74,
  HIP_API_ID_hipGetSymbolAddress = 75,
  HIP_API_ID_hipHostGetFlags = 76,
  HIP_API_ID_hipHostMalloc = 77,
  HIP_API_ID_hipDriverGetVersion = 78,
  HIP_API_ID_hipMemGetInfo = 79,
  HIP_API_ID_hipDeviceReset = 80,
  HIP_API_ID_hipMemset = 81,
  HIP_API_ID_hipMemsetD8 = 82,
  HIP_API_ID_hipMemcpyParam2DAsync = 83,
  HIP_API_ID_hipHostRegister = 84,
  HIP_API_ID_hipCtxSetSharedMemConfig = 85,
  HIP_API_ID_hipArray3DCreate = 86,
  HIP_API_ID_hipIpcOpenMemHandle = 87,
  HIP_API_ID_hipGetLastError = 88,
  HIP_API_ID_hipCtxDestroy = 89,
  HIP_API_ID_hipDeviceGetSharedMemConfig = 90,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = 91,
  HIP_API_ID_hipSetDeviceFlags = 92,
  HIP_API_ID_hipHccModuleLaunchKernel = 93,
  HIP_API_ID_hipFree = 94,
  HIP_API_ID_hipOccupancyMaxPotentialBlockSize = 95,
  HIP_API_ID_hipDeviceGetAttribute = 96,
  HIP_API_ID_hipMemcpyDtoH = 97,
  HIP_API_ID_hipCtxDisablePeerAccess = 98,
  HIP_API_ID_hipMallocManaged = 99,
  HIP_API_ID_hipDeviceGetByPCIBusId = 100,
  HIP_API_ID_hipIpcGetMemHandle = 101,
  HIP_API_ID_hipMemcpyHtoDAsync = 102,
  HIP_API_ID_hipCtxGetDevice = 103,
  HIP_API_ID_hipMemset3D = 104,
  HIP_API_ID_hipModuleLoadData = 105,
  HIP_API_ID_hipDeviceTotalMem = 106,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessor = 107,
  HIP_API_ID_hipCtxSetCurrent = 108,
  HIP_API_ID_hipGetErrorString = 109,
  HIP_API_ID_hipDevicePrimaryCtxRetain = 110,
  HIP_API_ID_hipDeviceDisablePeerAccess = 111,
  HIP_API_ID_hipStreamCreateWithFlags = 112,
  HIP_API_ID_hipMemcpyFromArray = 113,
  HIP_API_ID_hipMemcpy2DAsync = 114,
  HIP_API_ID_hipFuncGetAttributes = 115,
  HIP_API_ID_hipGetSymbolSize = 116,
  HIP_API_ID_hipEventCreateWithFlags = 117,
  HIP_API_ID_hipStreamQuery = 118,
  HIP_API_ID_hipDeviceGetPCIBusId = 119,
  HIP_API_ID_hipMemcpy = 120,
  HIP_API_ID_hipPeekAtLastError = 121,
  HIP_API_ID_hipExtLaunchMultiKernelMultiDevice = 122,
  HIP_API_ID_hipStreamAddCallback = 123,
  HIP_API_ID_hipMemcpyToArray = 124,
  HIP_API_ID_hipMemsetD32 = 125,
  HIP_API_ID_hipDeviceSynchronize = 126,
  HIP_API_ID_hipDeviceGetCacheConfig = 127,
  HIP_API_ID_hipMalloc3D = 128,
  HIP_API_ID_hipPointerGetAttributes = 129,
  HIP_API_ID_hipMemsetAsync = 130,
  HIP_API_ID_hipMemcpyToSymbol = 131,
  HIP_API_ID_hipCtxPushCurrent = 132,
  HIP_API_ID_hipMemcpyPeer = 133,
  HIP_API_ID_hipEventSynchronize = 134,
  HIP_API_ID_hipMemcpyDtoDAsync = 135,
  HIP_API_ID_hipExtMallocWithFlags = 136,
  HIP_API_ID_hipCtxEnablePeerAccess = 137,
  HIP_API_ID_hipMemcpyDtoHAsync = 138,
  HIP_API_ID_hipModuleLaunchKernel = 139,
  HIP_API_ID_hipModuleGetTexRef = 140,
  HIP_API_ID_hipDeviceGetLimit = 141,
  HIP_API_ID_hipModuleLoadDataEx = 142,
  HIP_API_ID_hipRuntimeGetVersion = 143,
  HIP_API_ID_hipGetDeviceProperties = 144,
  HIP_API_ID_hipFreeArray = 145,
  HIP_API_ID_hipDevicePrimaryCtxRelease = 146,
  HIP_API_ID_hipHostGetDevicePointer = 147,
  HIP_API_ID_hipMemcpyParam2D = 148,
  HIP_API_ID_hipModuleGetFunction = 149,
  HIP_API_ID_hipMemsetD32Async = 150,
  HIP_API_ID_hipGetDevice = 151,
  HIP_API_ID_hipGetDeviceCount = 152,
  HIP_API_ID_NUMBER = 153,
  HIP_API_ID_ANY = 154,
