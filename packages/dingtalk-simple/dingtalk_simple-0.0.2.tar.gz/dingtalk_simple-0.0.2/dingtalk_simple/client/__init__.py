...
class DingTalkClient(BaseClient):
    ...
    def __init__(self, corp_id, prefix='client', storage=None, timeout=None, auto_retry=True, *args, **kwargs):
        super(DingTalkClient, self).__init__(storage, timeout, auto_retry, *args, **kwargs)
...
class CorpClient(DingTalkClient):
    ...
    def __init__(self, corp_id, app_key, app_secret, storage=None, token=None, aes_key=None, timeout=None,
                 auto_retry=True, *args, **kwargs):
        prefix = 'secret:%s:%s' % (corp_id, app_key)
        super(CorpClient, self).__init__(corp_id, prefix, storage, timeout, auto_retry, *args, **kwargs)
