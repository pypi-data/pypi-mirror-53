...
class ContentModulemdApi(object):
    ...
    def create_with_http_info(self, relative_path, name, stream, version, context, arch, artifacts, dependencies, **kwargs):  # noqa: E501
        ...
        if ('stream' not in local_var_params or
                local_var_params['stream'] is None):
        ...
        if ('arch' not in local_var_params or
                local_var_params['arch'] is None):
        ...
        if ('artifacts' not in local_var_params or
                local_var_params['artifacts'] is None):
        ...
        if ('dependencies' not in local_var_params or
                local_var_params['dependencies'] is None):
        ...
        if ('stream' in local_var_params and
                len(local_var_params['stream']) < 1):
        ...
        if ('version' in local_var_params and
                len(local_var_params['version']) < 1):
        ...
        if ('context' in local_var_params and
                len(local_var_params['context']) < 1):
        ...
        if ('arch' in local_var_params and
                len(local_var_params['arch']) < 1):
        ...
        if ('artifacts' in local_var_params and
                len(local_var_params['artifacts']) < 1):
            raise ApiValueError("Invalid value for parameter `artifacts` when calling `create`, length must be greater than or equal to `1`")  # noqa: E501
        if ('dependencies' in local_var_params and
                len(local_var_params['dependencies']) < 1):
            raise ApiValueError("Invalid value for parameter `dependencies` when calling `create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def read_with_http_info(self, modulemd_href, **kwargs):  # noqa: E501
        ...
        all_params = ['modulemd_href', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('modulemd_href' not in local_var_params or
                local_var_params['modulemd_href'] is None):
