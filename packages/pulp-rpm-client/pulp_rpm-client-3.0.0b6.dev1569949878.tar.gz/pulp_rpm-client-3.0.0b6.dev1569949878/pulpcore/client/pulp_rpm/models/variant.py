...
class Variant(object):
    ...
    def __init__(self, variant_id=None, uid=None, name=None, type=None, packages=None, repository=None, source_packages=None, source_repository=None, debug_packages=None, debug_repository=None, identity=None):  # noqa: E501
    ...
    def variant_id(self, variant_id):
        ...
        if variant_id is not None and len(variant_id) < 1:
    ...
    @property
    def repository(self):
        """Gets the repository of this Variant.  # noqa: E501

        A URI of the repository containing the content for this Variant.  # noqa: E501

        :return: The repository of this Variant.  # noqa: E501
        :rtype: str
        """
    ...
    def repository(self, repository):
        """Sets the repository of this Variant.

        A URI of the repository containing the content for this Variant.  # noqa: E501

        :param repository: The repository of this Variant.  # noqa: E501
        :type: str
        """
    ...
    def source_packages(self, source_packages):
        ...
        if source_packages is not None and len(source_packages) < 1:
    ...
    def source_repository(self, source_repository):
        ...
        if source_repository is not None and len(source_repository) < 1:
    ...
    def debug_packages(self, debug_packages):
        ...
        :type: str
        """
        if debug_packages is None:
            raise ValueError("Invalid value for `debug_packages`, must not be `None`")  # noqa: E501
        if debug_packages is not None and len(debug_packages) < 1:
    ...
    def debug_repository(self, debug_repository):
        ...
        :type: str
        """
        if debug_repository is None:
            raise ValueError("Invalid value for `debug_repository`, must not be `None`")  # noqa: E501
        if debug_repository is not None and len(debug_repository) < 1:
