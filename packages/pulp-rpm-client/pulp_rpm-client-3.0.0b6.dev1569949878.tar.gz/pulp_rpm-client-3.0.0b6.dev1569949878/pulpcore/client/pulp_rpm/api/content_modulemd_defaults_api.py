...
class ContentModulemdDefaultsApi(object):
    ...
    def create_with_http_info(self, relative_path, module, stream, profiles, **kwargs):  # noqa: E501
        ...
        if ('module' not in local_var_params or
        ...
        if ('profiles' not in local_var_params or
                local_var_params['profiles'] is None):
        ...
        if ('module' in local_var_params and
                len(local_var_params['module']) < 1):
        ...
        if ('profiles' in local_var_params and
                len(local_var_params['profiles']) < 1):
            raise ApiValueError("Invalid value for parameter `profiles` when calling `create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def read_with_http_info(self, modulemd_defaults_href, **kwargs):  # noqa: E501
        ...
        all_params = ['modulemd_defaults_href', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('modulemd_defaults_href' not in local_var_params or
                local_var_params['modulemd_defaults_href'] is None):
