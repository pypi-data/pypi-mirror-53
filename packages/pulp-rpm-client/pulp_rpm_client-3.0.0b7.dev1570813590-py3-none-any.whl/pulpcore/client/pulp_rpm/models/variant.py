...
class Variant(object):
    ...
    def __init__(self, variant_id=None, uid=None, name=None, type=None, packages=None, source_packages=None, source_repository=None, debug_packages=None, debug_repository=None, identity=None):  # noqa: E501
