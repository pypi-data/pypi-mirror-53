...
class ModulemdDefaults(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, artifact=None, relative_path=None, file=None, repository=None, module=None, stream=None, profiles=None):  # noqa: E501
