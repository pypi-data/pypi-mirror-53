...
class RepoMetadataFile(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, artifact=None, relative_path=None, file=None, repository=None, data_type=None, checksum_type=None, checksum=None):  # noqa: E501
