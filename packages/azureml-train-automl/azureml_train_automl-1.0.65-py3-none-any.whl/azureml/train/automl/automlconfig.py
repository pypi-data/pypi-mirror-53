...
class AutoMLConfig:
    ...
    :param featurization:
        ...
        Customized featurization currently supports list of blocked transformers, column purpose,
        transformer parameters, and drop columns.
    ...
    def __init__(self,
        ...
        if enable_tf:
            ...
            elif (isinstance(featurization, str) and featurization == FeaturizationConfigMode.Auto) or \
                    isinstance(featurization, FeaturizationConfig):
                enable_tf = False
        ...
        if not AzureAutoMLClient._is_fbprophet_module_present():
            if blacklist_models is None:
                blacklist_models = [constants.SupportedModels.Forecasting.Prophet]
            elif constants.SupportedModels.Forecasting.Prophet not in blacklist_models:
                blacklist_models.append(constants.SupportedModels.Forecasting.Prophet)
            ...
            if isinstance(featurization, str):
                if featurization == FeaturizationConfigMode.Off:
                    ...
                    raise ConfigException("Invalid Featurization Configuration"
                                          "Please check if the input is '{0}', '{1}', or FeaturizationConfig."
