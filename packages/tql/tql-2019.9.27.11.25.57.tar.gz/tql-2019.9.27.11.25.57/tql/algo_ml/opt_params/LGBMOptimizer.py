...
class LGBMOptimizer(Optimizer):
    ...
    def best_iteration(self):
        return self.best_iterations[self.optimizer._space.target.argmax()]

    @property
    def res(self):
        for res, iteration in zip(self.optimizer.res, self.best_iterations):
            res['params'].update({'n_estimators': iteration})
