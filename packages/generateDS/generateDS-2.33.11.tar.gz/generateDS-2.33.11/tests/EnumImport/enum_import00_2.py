    ...
    def validate_IntType01_1(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                return False
            if value < 0:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on IntType01_1' % {"value" : value} )
                result = False
            if value > 127:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on IntType01_1' % {"value" : value} )
                result = False
    def hasContent_(self):
        if (
