    ...
    def validate_USState(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on USState' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def hasContent_(self):
        if (
    ...
    def validate_UKPostcode(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 24:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on UKPostcode' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def hasContent_(self):
        if (
