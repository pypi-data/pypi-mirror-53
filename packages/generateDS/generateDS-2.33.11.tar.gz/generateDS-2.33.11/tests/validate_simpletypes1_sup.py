...
class simpleOneType(GeneratedsSuper):
    ...
    def validate_integer_range_1_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                return False
            if value <= 4:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minExclusive restriction on integer_range_1_st' % {"value" : value} )
                result = False
            if value >= 8:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on integer_range_1_st' % {"value" : value} )
                result = False
        return result
    def validate_pattern_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) < 10:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on pattern_st' % {"value" : value} )
                result = False
    ...
    def validate_token_enum_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on token_enum_st' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_integer_range_incl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                return False
            if value < -5:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_incl_st' % {"value" : value} )
                result = False
            if value > 10:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_incl_st' % {"value" : value} )
                result = False
        return result
    def validate_integer_range_excl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                return False
            if value <= -5:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minExclusive restriction on integer_range_excl_st' % {"value" : value} )
                result = False
            if value >= 10:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on integer_range_excl_st' % {"value" : value} )
                result = False
        return result
    def validate_min_max_length_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on min_max_length_st' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) < 10:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on min_max_length_st' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_length_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) != 10:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd length restriction on length_st' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_totalDigits_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, decimal_.Decimal):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (decimal_.Decimal)' % {"value": value, })
                return False
            if len(str(value)) >= 15:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd totalDigits restriction on totalDigits_st' % {"value" : value} )
                result = False
        return result
    def validate_date_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.date):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (datetime_.date)' % {"value": value, })
                return False
            if value < self.gds_parse_date('2015-06-01'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on date_minincl_st' % {"value" : value} )
                result = False
        return result
    def validate_date_maxincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > self.gds_parse_date('2015-10-31'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on date_maxincl_st' % {"value" : value} )
                result = False
        return result
    def validate_date_minexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.date):
                ...
                return False
            if value <= self.gds_parse_date('2015-06-01'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minExclusive restriction on date_minexcl_st' % {"value" : value} )
                result = False
        return result
    def validate_date_maxexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.date):
                ...
                return False
            if value >= self.gds_parse_date('2015-10-31'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on date_maxexcl_st' % {"value" : value} )
                result = False
        return result
    def validate_time_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.time):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (datetime_.time)' % {"value": value, })
                return False
            if value < self.gds_parse_time('14:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on time_minincl_st' % {"value" : value} )
                result = False
        return result
    def validate_time_maxincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > self.gds_parse_time('16:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on time_maxincl_st' % {"value" : value} )
                result = False
        return result
    def validate_time_minexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.time):
                ...
                return False
            if value <= self.gds_parse_time('14:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minExclusive restriction on time_minexcl_st' % {"value" : value} )
                result = False
        return result
    def validate_time_maxexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.time):
                ...
                return False
            if value >= self.gds_parse_time('16:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on time_maxexcl_st' % {"value" : value} )
                result = False
        return result
    def validate_datetime_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.datetime):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (datetime_.datetime)' % {"value": value, })
                return False
            if value < self.gds_parse_datetime('2015-06-01T14:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on datetime_minincl_st' % {"value" : value} )
                result = False
        return result
    def validate_datetime_maxincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > self.gds_parse_datetime('2015-10-31T16:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on datetime_maxincl_st' % {"value" : value} )
                result = False
        return result
    def validate_datetime_minexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.datetime):
                ...
                return False
            if value <= self.gds_parse_datetime('2015-06-01T14:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minExclusive restriction on datetime_minexcl_st' % {"value" : value} )
                result = False
        return result
    def validate_datetime_maxexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.datetime):
                ...
                return False
            if value >= self.gds_parse_datetime('2015-10-31T16:20:10'):
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on datetime_maxexcl_st' % {"value" : value} )
                result = False
        return result
    ...
    def validate_gyear_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if value < '2015':
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on gyear_minincl_st' % {"value" : value} )
                result = False
        return result
    def validate_gyearmonth_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if value < '2015-06':
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on gyearmonth_minincl_st' % {"value" : value} )
                result = False
        return result
    def validate_integer_range_A_0_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                return False
            if value < 4:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_0_st' % {"value" : value} )
                result = False
            if value > 6:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_0_st' % {"value" : value} )
                result = False
            if value < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_0_st' % {"value" : value} )
                result = False
    ...
    def validate_integer_range_A_1_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                return False
            if value < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_1_st' % {"value" : value} )
                result = False
            if value > 8:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_1_st' % {"value" : value} )
                result = False
            if value < 0:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_1_st' % {"value" : value} )
                result = False
    ...
    def validate_integer_range_A_2_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                return False
            if value < 0:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_2_st' % {"value" : value} )
                result = False
            if value > 10:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_2_st' % {"value" : value} )
                result = False
        return result
    def validate_anonymous_float_valueType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, float):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (float)' % {"value": value, })
                return False
            if value < 1.1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minInclusive restriction on anonymous_float_valueType' % {"value" : value} )
                result = False
            if value > 4.4:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxInclusive restriction on anonymous_float_valueType' % {"value" : value} )
                result = False
        return result
    def hasContent_(self):
        if (
    ...
    def validate_simpleTwoElementTwoType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 24:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on simpleTwoElementTwoType' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) < 12:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on simpleTwoElementTwoType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def hasContent_(self):
        if (
