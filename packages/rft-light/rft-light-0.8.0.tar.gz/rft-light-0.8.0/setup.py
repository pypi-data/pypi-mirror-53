...
required_packages['robotframework-swift-ride']={"pip_working": True, "nexus_pkg_available": True, "version": "==1.7.4rc1", "description": "Robot Framework is a generic test automation framework for acceptance level testing. RIDE is a lightweight and intuitive editor for Robot Framework test data."}
