...
class ExecutionEngineServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.run_genesis_with_chainspec = channel.unary_unary(
        '/io.casperlabs.ipc.ExecutionEngineService/run_genesis_with_chainspec',
...
class ExecutionEngineServiceServicer(object):
  ...
  def run_genesis_with_chainspec(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_ExecutionEngineServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'run_genesis_with_chainspec': grpc.unary_unary_rpc_method_handler(
          servicer.run_genesis_with_chainspec,
