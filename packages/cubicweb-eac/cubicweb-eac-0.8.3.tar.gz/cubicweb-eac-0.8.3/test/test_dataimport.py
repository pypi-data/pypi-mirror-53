        ...
        expected = [
            ...
            ('ChronologicalRelation', _gen_extid(),
             {'chronological_predecessor': set(['FRAD033_EAC_00001']),
              ...
              'xml_wrap': set([b'<gloups xmlns="urn:isbn:1-931666-33-4" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink">hips</gloups>']),  # noqa
              'entry': set([u'Trash']),
             },
            ),
            ...
            ('EACResourceRelation', _gen_extid(),
             {'agent_role': set([u'creatorOf']),
              ...
              'xml_wrap': set([b'<he xmlns="urn:isbn:1-931666-33-4" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">joe</he>']),  # noqa
             },
            ),
