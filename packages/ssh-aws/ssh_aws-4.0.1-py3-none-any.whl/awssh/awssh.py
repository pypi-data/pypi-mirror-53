...
def get_instances(args):
    ...
    if args.token_code and args.serial_number:
        ...
        sts_expiration = sts_response['Credentials']['Expiration']
        ...
        # MFA profile section
        config['mfa'] = {'aws_access_key_id': sts_secret_access_key,
                         'aws_secret_access_key': sts_session_token,
                         'aws_session_token': sts_access_key_id,
                         }
