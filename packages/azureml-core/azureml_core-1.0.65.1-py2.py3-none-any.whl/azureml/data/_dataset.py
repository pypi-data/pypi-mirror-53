...
from azureml.data._dataset_rest_helper import _dto_to_dataset, _dataset_to_dto, _dataset_to_saved_dataset_dto, \
    _saved_dataset_dto_to_dataset, _restclient, _resolve_dataset_type, _custom_headers
...
class _Dataset(object):
    ...
    def as_named_input(self, name):
        """Provides a name for this dataset which will be used to retrieve the materialized dataset in the run.
    ...
    def register(self, workspace, name, description=None, tags=None, create_new_version=False):
        ...
        try:
            ...
            return _dto_to_dataset(workspace, registered_dto)
        except HttpOperationError as e:
