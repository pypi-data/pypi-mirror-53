...
class AmlCompute(ComputeTarget):
    ...
    def _initialize(self, workspace, obj_dict):
        ...
        remotelogin_port_public_access = obj_dict['properties']['properties']['remoteLoginPortPublicAccess'] \
            if obj_dict['properties']['properties'] else None
        ...
        self.remotelogin_port_public_access = remotelogin_port_public_access
        self.status = status
    ...
    def provisioning_configuration(vm_size='', vm_priority="dedicated", min_nodes=0,
                                   ...
                                   tags=None, description=None, remotelogin_port_public_access="NotSpecified"):
        ...
        :param remotelogin_port_public_access: State of the public SSH port. Possible values are:
        ...
        :type remotelogin_port_public_access: str
        ...
        config = AmlComputeProvisioningConfiguration(vm_size, vm_priority, min_nodes,
                                                     ...
                                                     tags, description, remotelogin_port_public_access)
        return config
    ...
    def _build_create_payload(config, location, subscription_id):
        ...
        if not config.vm_size and not config.vm_priority and not config.admin_username and not \
                ...
                and not config.remotelogin_port_public_access:
            ...
            if not config.remotelogin_port_public_access:
                ...
                json_payload['properties']['properties']['remoteLoginPortPublicAccess'] = \
                    config.remotelogin_port_public_access
    ...
    def refresh_state(self):
        ...
        self.remotelogin_port_public_access = cluster.remotelogin_port_public_access
    ...
    def serialize(self):
        ...
        amlcompute_properties = {'vmSize': self.vm_size, 'vmPriority': self.vm_priority,
                                 ...
                                 'subnet': {'id': subnet_id},
                                 'remoteLoginPortPublicAccess': self.remotelogin_port_public_access}
