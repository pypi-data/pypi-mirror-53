...
class ActionRequestDto(Model):
    ...
    def __init__(self, action_type=None, arguments=None, definition_version=None, dataset_snapshot_name=None, dataflow_json=None, saved_dataset_id=None, compute_target=None, aml_compute_vm_size=None, pip_arguments=None):
