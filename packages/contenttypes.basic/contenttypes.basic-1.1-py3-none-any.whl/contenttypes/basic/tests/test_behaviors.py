...
class BehaviorFunctionalTest(TestUtils):
    ...
    def test_behavior_hide_text(self):
        self._create_dummy_fti(behavior='contenttyes.basic.hide_text')
        self._create_obj()
        self._set_browser()
    ...
    def test_behavior_button_text(self):
        self._create_dummy_fti(behavior='contenttyes.basic.button_text')
        self._create_obj()
        self._set_browser()
    ...
    def test_behavior_text_position(self):
        self._create_dummy_fti(behavior='contenttyes.basic.text_position')
        self._create_obj()
        self._set_browser()
    ...
    def test_behavior_icon(self):
        self._create_dummy_fti(behavior='contenttyes.basic.icon')
        self._create_obj()
        self._set_browser()
    ...
    def test_behavior_colour(self):
        self._create_dummy_fti(behavior='contenttyes.basic.colour')
        self._create_obj()
        self._set_browser()
    ...
    def test_behavior_link(self):
        self._create_dummy_fti(behavior='contenttyes.basic.link')
        self._create_obj()
        self._set_browser()
    ...
    def test_behavior_osmap(self):
        self._create_dummy_fti(behavior='contenttyes.basic.osmap')
        self._create_obj()
        self._set_browser()
