...
class CarouselItem(MyDict):
    ...
    def build(self, title: str = None, description: str=None, image:Image=None, info: SelectItemInfo=None):
    ...
    def add_image(self, url: str, accessibility_text:str=None) -> Image:
        self.image = Image().build(url=url, accessibility_text=accessibility_text)
        return self.image
