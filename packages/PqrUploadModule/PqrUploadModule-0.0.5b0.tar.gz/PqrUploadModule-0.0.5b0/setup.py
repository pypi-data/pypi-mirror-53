...
setup(
  ...
  version = '0.0.5b',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/petronije2002/PqrUpload/archive/0.0.5b.tar.gz',    # I explain this later on
