...
def JLH_HACK(connection, swagger_api):
    def check(f):
        return inspect.ismethod(f) and f.__name__.endswith('_with_http_info')
...
# Connect to appropriate LUSID environment (standard or TR-Refinitiv)
def connect(*args, **kwargs):
    ...
    connect = importlib.import_module(".connect_{}".format(settings.get('env', 'lusid')), "lusidtools.lpt")
