...
as per https://docs.aws.amazon.com/IAM/latest/UserGuide/list_identityandaccessmanagement.html#identityandaccessmanagement-resources-for-iam-policies.
Got '{}'
'''.strip().format(value)
...
def validateSG(issues, boto3_session):
    global G_AWSEnvironment
...
def main():
    ...
    if do_all_validations or args.vpc:
        validateNetwork(issues, boto3_session)

    if do_all_validations or args.sg:
        validateSG(issues, boto3_session)
