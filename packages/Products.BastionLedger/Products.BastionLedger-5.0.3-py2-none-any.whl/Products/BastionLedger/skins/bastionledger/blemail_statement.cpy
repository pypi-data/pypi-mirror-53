...
recipients = context.manage_emailStatement(email, sender, template, effective or DateTime())

context.plone_utils.addPortalMessage('Emailed report to %s' % ', '.join(recipients))
