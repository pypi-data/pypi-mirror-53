...
setup(
    ...
    packages=['commons', 'commons.data', 'commons.decorators', 'commons.encryption', 'commons.model',
              'commons.operations_utils', 'commons.utils', 'commons.model.exceptions', 'commons.web3', 'commons.web3.resources'],  # Chose the same as "name"
    data_files=[('commons/web3/resources/json', ['commons/web3/resources/abi.json'])],
    version='0.10.13',  # Start with a small number and increase it with every change you make
