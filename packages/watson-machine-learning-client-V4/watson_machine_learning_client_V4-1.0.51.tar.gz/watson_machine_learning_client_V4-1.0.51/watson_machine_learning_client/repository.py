...
class Repository(WMLResource):
    ...
    def _check_artifact_type(self, artifact_uid):
        ...
        future = {artifact: pool.apply_async(get_url, (endpoints[artifact], headers, self._client._params(), isIcp)) for artifact in endpoints if (artifact!="library" or artifact!="runtime" or artifact!="space")}
