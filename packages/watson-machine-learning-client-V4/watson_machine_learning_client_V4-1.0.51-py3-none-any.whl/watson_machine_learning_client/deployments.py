...
class Deployments(WMLResource):
    ...
    def create(self, artifact_uid=None, meta_props=None, **kwargs):
            ...
            if self._client.CAMS:
                if self._client.default_space_id is not None:
                    ...
                    raise WMLClientError("It is mandatory is set the space. Use client.set.default_space(<SPACE_GUID>) to set the space.")
    ...
    def get_job_details(self,job_uid=None,limit=None):
        ...
        return self._get_no_space_artifact_details(url, job_uid, limit, 'async deployment jobs')
