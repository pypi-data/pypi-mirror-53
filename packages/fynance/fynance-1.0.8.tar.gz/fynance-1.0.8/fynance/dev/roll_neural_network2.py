...
class RollNeuralNet:
    ...
    def __init__(self, train_period=252, estim_period=63, value_init=100,
        ...
        target_filter : function, str or bool, optional
    ...
    def plot(self, start=0, end=-1, train=True):
        """ """
        ...
        f, ax_loss = plot_loss(loss_estim, loss_train, f, ax_loss)
        f, ax_perf = plot_perf(perf_estim, perf_train, f, ax_perf)
...
def plot_loss(loss_estim, loss_train=None, f=None, ax=None):
    ...
    # Set figure
    pl = fy.PlotLoss(
        fig=f, ax=ax, title='Model loss', xlabel='Epoch', yscale='log',
...
def plot_perf(perf_estim, perf_train=None, f=None, ax=None):
    ...
    # Set figure
    pp = PlotPerf(
        fig=f, ax=ax, title='Model perf', xlabel='Date', yscale='log',
