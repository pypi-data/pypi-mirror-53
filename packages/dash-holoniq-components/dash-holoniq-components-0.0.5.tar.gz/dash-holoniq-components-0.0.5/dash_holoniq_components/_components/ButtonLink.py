...
- disabled (boolean; optional): Set true to disable the component
...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, href=Component.UNDEFINED, disabled=Component.UNDEFINED, refresh=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'href', 'disabled', 'refresh', 'className', 'style', 'n_clicks', 'n_clicks_timestamp', 'loading_state']
        self._type = 'ButtonLink'
        self._namespace = 'dash_holoniq_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'href', 'disabled', 'refresh', 'className', 'style', 'n_clicks', 'n_clicks_timestamp', 'loading_state']
