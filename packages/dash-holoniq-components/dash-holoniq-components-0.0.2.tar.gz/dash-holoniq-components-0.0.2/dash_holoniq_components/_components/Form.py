...
- preventDefault (boolean; optional): Use preventDefault=True to block the forms default action
- form_data (dict; optional): The forms data as it would be reported by the default form action
...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, inline=Component.UNDEFINED, preventDefault=Component.UNDEFINED, form_data=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'key', 'inline', 'preventDefault', 'form_data', 'loading_state']
        self._type = 'Form'
        self._namespace = 'dash_holoniq_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'key', 'inline', 'preventDefault', 'form_data', 'loading_state']
