...
def test_invalid_configuration(fixture_database, fixture_computer_localhost, generate_calc_job_node, generate_parser):
    ...
    node = generate_calc_job_node(entry_point_calc_job, fixture_computer_localhost, 'invalid_configuration', attributes)
