    ...
    def try_run(self):
        ...
        try:
            while self.running:
                ...
                result_json = os.path.join(tempfile.gettempdir(), f"{task.sid}_{task.sha256}_result.json")
                error_json = os.path.join(tempfile.gettempdir(), f"{task.sid}_{task.sha256}_error.json")
