...
def boostTypesGetter(query, mapping):
    root_op = [k for k in query['query']][0]
    return row_key_type_getters[root_op](query['query'][root_op], mapping)
