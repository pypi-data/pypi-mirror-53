...
class TransformKernel(object):
    ...
    def __init__(self, attributes=None):
        ...
        globs = [[self.hide_time_steps,  u'Long', u'Time Steps [int]', self.time_steps, u'time_steps'],
                 [self.hide_duration,  u'Double', u'Duration [msec]',  self.duration,   u'duration'],
                 [self.hide_tip_angle, u'Double', u'Tip Angle [deg]',  self.tip_angle,  u'tip_angle'],
                 [self.hide_bandwidth, u'Double', u'Bandwidth [kHz]',  self.bandwidth,  u'bandwidth']]
    ...
    def __unicode__(self):
        ...
        lines.append("Hide File1     : %s" % unicode(self.hide_file1))
        lines.append("Hide File2     : %s" % unicode(self.hide_file2))
        lines.append("Hide Time Step : %s" % unicode(self.hide_time_steps))
        lines.append("Hide Duration  : %s" % unicode(self.hide_Duration))
        lines.append("Hide Tip Angle : %s" % unicode(self.hide_tip_angle))
        lines.append("Hide Bandwidth : %s" % unicode(self.hide_bandwidth))

        lines.append("File1 Label    : %s" % unicode(self.file1_label))
        lines.append("File1 Label    : %s" % unicode(self.file2_label))
        lines.append("Time Step      : %s" % unicode(self.time_steps))
        lines.append("Duration       : %s" % unicode(self.duration))
        lines.append("Tip Angle      : %s" % unicode(self.tip_angle))
        lines.append("Bandwidth      : %s" % unicode(self.bandwidth))
        lines.append("Deprecated     : %s" % unicode(self.deprecated))
