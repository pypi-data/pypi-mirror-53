...
# This is rev 63994 of the floatspin control:
# http://trac.wxwidgets.org/browser/wxPython/3rdParty/AGW/agw/floatspin.py?rev=r63994
# As of this writing (31 May 2010), this is the latest version and is not 
# any official release of wx. We need the bug fixes it contains, hence this 
# custom version. Once it finds its way into an official release, we can use 
# the standard version in the wx library.
 
# As long as I have a custom version, I'm going to add this 
