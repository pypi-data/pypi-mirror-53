...
config = {
    ...
    'style_defs': {
        ...
        'wxTE_NOHIDESEL': {
            'desc': _('By default, the Windows text control does not show '
                      'the selection when it does not have focus - use this '
                      'style to force it to always show it. It does not do '
                      'anything under other platforms.'),
        },
        'wxHSCROLL': {
            'desc': _('A horizontal scrollbar will be created and used, so '
                      'that text will not be wrapped. No effect under wxGTK1.'),
        },
        'wxTE_NO_VSCROLL': {
        ...
        'wxTE_DONTWRAP': {
            'desc': _('Same as wxHSCROLL style: do not wrap at all, show '
