...
if vespa.common.wx_gravy.util.is_wx_floatspin_ok():
    from wx.lib.agw.floatspin import EVT_FLOATSPIN, FS_LEFT, FS_RIGHT, FS_CENTRE, FS_READONLY

else:
    from vespa.common.wx_gravy.widgets.floatspin.floatspin import EVT_FLOATSPIN, FS_LEFT, FS_RIGHT, FS_CENTRE, FS_READONLY
"""
        return [s]
...
def initialize():
    ...
    common.class_names['EditFloatSpinMultiplier'] = 'FloatSpinMultiplier'

    # python code generation functions
    pygen = common.code_writers.get("python")
    if pygen:
        pygen.add_widget_handler('FloatSpinMultiplier', PythonCodeGenerator())
