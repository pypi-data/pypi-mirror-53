...
def builder(parent, sizer, pos, number=[1]):
    ...
    floatSpinWin = EditFloatSpinMultiplier(label, parent, wx.ID_ANY, misc._encode(label), sizer, pos, common.property_panel)
...
def xml_builder(attrs, parent, sizer, sizeritem, pos=None):
    ...
    floatSpinWin = EditFloatSpinMultiplier(label, parent, wx.ID_ANY, misc._encode(label), sizer, pos, common.property_panel, show=False)
