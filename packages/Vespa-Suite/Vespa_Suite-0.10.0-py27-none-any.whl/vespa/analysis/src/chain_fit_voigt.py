...
import vespa.analysis.src.functors.funct_fit_voigt      as funct_fit_voigt
...
class ChainFitVoigt(chain_fit_identity.ChainFitIdentity):
    ...
    def lorgauss_internal_lmfit(self, params, report_stats=False):
        """
        This is in the format that LMFIT expects to call in the Minimizer
        class. 
        ...
        if report_stats:
            nfree = np.size(yfit)-len(params.keys())
