...
import vespa.analysis.src.plot_panel_voigt as plot_panel_voigt  
...
import vespa.analysis.src.dialog_experiment_indices as dialog_experiment_indices
import vespa.analysis.src.dynamic_list_voigt_metabolite as dynamic_list_voigt_metabolite
...
#        self.dynamic_macromolecule_list.reset_to_default()
    ...
    def on_mmol_single_dataset_initval(self, event):
        ...
        method = constants.FitMacromoleculeMethodInitVal.choices.keys()[index]
    ...
    def on_optimize_limits_range_ppm_alt(self, event): 
        """ alternative ppm bounds for 'small' metabs to enforce db values more closely """
        val = event.GetEventObject().GetValue()
        self.block.set.optimize_limits_range_ppm_alt = val

    def on_optimize_apply_range_ppm_alt(self, event): 
        """ can turn this 'alt' option on/off """
        val = event.GetEventObject().GetValue()
        self.block.set.optimize_apply_range_ppm_alt = val
