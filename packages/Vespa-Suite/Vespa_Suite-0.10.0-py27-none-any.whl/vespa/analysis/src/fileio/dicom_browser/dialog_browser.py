...
import vespa.analysis.src.fileio.dicom_browser.util_browser as util_browser
...
class BrowserDialog(browser.TheDialog):
    ...
    def __init__(self, parent=None, preview_size=(64, 64), multi_select=False, manufacturer=['SIEMENS',]):
    ...
    def _populate_tree(self):
        ...
        files = [ ]
        self._nfiles = 0
        for f in util_browser.get_files(path, manufacturer=self.manufacturer):
...
class SiemensSpectroscopyBrowserDialog(BrowserDialog):
    def __init__(self, parent=None, multi_select=False):
        ...
        BrowserDialog.__init__(self, parent, None, multi_select, manufacturer=['SIEMENS','PHILIPS'])
...
class PhilipsSpectroscopyBrowserDialog(BrowserDialog):
    def __init__(self, parent=None, multi_select=False):
        ...
        BrowserDialog.__init__(self, parent, None, multi_select, manufacturer=['PHILIPS',])
