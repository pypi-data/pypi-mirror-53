...
import vespa.analysis.src.chain_fit_voigt as chain_fit_voigt
...
class _Settings(object):
    ...
    def __init__(self,  attributes=None):
        ...
        self.optimize_bounds_area_max           = 50.0                 
        self.optimize_bounds_area_min           = 50.0                 
        self.optimize_bounds_area_max_small     = 50.0                 
...
#     def get_combo_results(self, voxel, prior_list_unique):
# 
#         combos = []
...
# 
#         if self.set.prior_calculate_combinations:
#             combo = self.get_combo_results()
...
#             val.append(str(0.0))
# 
#         if fit.prior_calculate_combinations:
#             combo = self.get_combo_results()
#             if combo is not None:
#                 for item in combo:
