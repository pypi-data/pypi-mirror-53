...
class ViewIdsSpectral(common_menu.IdContainer):
    ...
    VIFF_DATA_PLOTA           = "replace me"
    VIFF_SVD_FIDS_CHECKED_SUM = "replace me"
...
#            ("Add Fitting Tab - Giso",  main.on_add_giso_tab, wx.ITEM_NORMAL),
    ...
    view_spectral = (
            ...
            ("Output", (
                ...
                common_menu.SEPARATOR,
                ("Export to VIFF", (
                    ("Data Plot A",              main.on_menu_view_output, wx.ITEM_NORMAL, ViewIdsSpectral.VIFF_DATA_PLOTA),
                    ("SVD FIDs Checked Summed",  main.on_menu_view_output, wx.ITEM_NORMAL, ViewIdsSpectral.VIFF_SVD_FIDS_CHECKED_SUM))),
                
#                common_menu.SEPARATOR,
#                ("Data -> VIFF",    main.on_menu_view_output, wx.ITEM_NORMAL, ViewIdsSpectral.VIFF_DATA_PLOTA),
#                ("SVD FID Sum -> VIFF", main.on_menu_view_output, wx.ITEM_NORMAL, ViewIdsSpectral.VIFF_SVD_FID_SUMMED_ALL),
                )),
           )
