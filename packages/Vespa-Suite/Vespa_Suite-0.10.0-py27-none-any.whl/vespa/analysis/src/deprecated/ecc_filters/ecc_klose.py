...
def _create_panel(parent, tab, attributes):
    ...
    return panel_klose.PanelKlose(parent, tab, attributes)
    


class EccKlose(ecc_filter.EccFilter):
    
    XML_VERSION = "1.0.0"

    ID = "8dfdfb60-9247-41a7-ae05-aee7a4a1c05d"
...
class _FunctEccKlose(functor.Functor):
    """ 
    ...
    def algorithm(self, chain):
        if self.ecc_dataset: 
            ...
            chain.data  = abs(chain.data) * np.exp(1j*(phtime-phecc))
