        ...
        def init_cal(self,voltage, mySwitchbox):
            ...
            while (result < lower_limit or result > upper_limit):
                ...
                if enclosure.__contains__("1995"):
                    enclosure = enclosure+"-"+self.powerModule.dut.sendCommand("*POSITION?")
                showDialog(title="Check load connection",message="\aPlease connect the Keithley to " + enclosure +" " + voltage + " channel")
                ...
                while(currentTotalTemp < minTotalTemp):
                    ...
                    if tempTimeout > timeoutTime:
                        ...
                        printText("\n Internal: " + str(unitTemp) + "/" + str(minUnitTemp) + "C   5vFet: " + str(
                            ...
                            minv12Temp) + "C")
                        break
                        #raise Exception('Timeout waiting for module to reach working temperature') # sb db
