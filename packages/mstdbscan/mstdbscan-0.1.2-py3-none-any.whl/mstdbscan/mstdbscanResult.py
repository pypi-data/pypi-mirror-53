...
class MSTdbscanResult():
    ...
    def __setResult(self):
        clusterDict = {"clusterID":[], "mstTime":[], "type":[], "centerX":[], "centerY":[], "geometry":[]}
        ...
        for clusterID in self.__allClusters:
            ...
            for t in self.__timeBar:
                ...
                clusterDict["geometry"].append(shape)
                ###############################################################
        ...
        self.__clusterGDF = gpd.GeoDataFrame(clusterDF, geometry="geometry")
