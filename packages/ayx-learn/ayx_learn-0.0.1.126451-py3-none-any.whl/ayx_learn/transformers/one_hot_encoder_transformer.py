...
class OneHotEncoderTransformer(OneHotEncoder):
    ...
    def __init__(self, *args, categorical_columns="auto", **kwargs):
        ...
        super().__init__(*args, sparse=False, **kwargs)
    ...
    def fit(self, x, *args, **kwargs):
        ...
        try:
            super().fit(x[self._columns_to_encode], *args, **kwargs)
    ...
    def transform(self, x, *args, **kwargs):
        ...
        try:
            x_encoded = super().transform(x[self._columns_to_encode], *args, **kwargs)
        except ValueError as e:
            logger.exception(e)
            validate_no_nulls(x)
        ...
        x_encoded = pd.DataFrame(
            x_encoded, columns=self.get_categorical_feature_names()
        )
        ...
        for col in list(unencoded_df):
            x_encoded[col] = unencoded_df[col]
