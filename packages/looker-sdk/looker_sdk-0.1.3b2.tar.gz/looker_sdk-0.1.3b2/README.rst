...
Mac users should use brew:

.. code-block:: bash

    brew install pyenv

And then follow the **remaining steps 3 - 5** of https://github.com/pyenv/pyenv#basic-github-checkout
...
is an awesome enhancement to pip to manage project dependencies.
