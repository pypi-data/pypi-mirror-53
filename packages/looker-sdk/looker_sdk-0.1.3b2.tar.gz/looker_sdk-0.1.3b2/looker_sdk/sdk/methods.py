...
class LookerSDK(api_methods.APIMethods):
    ...
    def add_group_user(
        ...
        """Add a User to Group"""
        response = self.post(f"/groups/{group_id}/users", models.User, body=body)
    ...
    def all_datagroups(self) -> Sequence[models.Datagroup]:
        """Get All Datagroups"""
        response = self.get(f"/datagroups", Sequence[models.Datagroup])
        assert isinstance(response, list)
        return response
    ...
    def all_folders(
        ...
        """Get All Folders"""
        response = self.get(
            f"/folders", Sequence[models.Folder], query_params={"fields": fields}
        )
        assert isinstance(response, list)
        return response
    ...
    def all_git_branches(
        ...
        response = self.get(
            f"/projects/{project_id}/git_branches", Sequence[models.GitBranch]
        )
        assert isinstance(response, list)
        return response
    ...
    def all_homepages(
        ...
        """Get All Homepages"""
        response = self.get(
            f"/homepages", Sequence[models.Homepage], query_params={"fields": fields}
        )
        assert isinstance(response, list)
        return response
    ...
    def all_legacy_features(self) -> Sequence[models.LegacyFeature]:
        """Get All Legacy Features"""
        response = self.get(f"/legacy_features", Sequence[models.LegacyFeature])
        assert isinstance(response, list)
        return response

    # GET /locales -> Sequence[models.Locale]
    def all_locales(self) -> Sequence[models.Locale]:
        """Get All Locales"""
        response = self.get(f"/locales", Sequence[models.Locale])
        assert isinstance(response, list)
        return response
    ...
    def all_looks(
        ...
        """Get All Looks"""
        response = self.get(
            f"/looks", Sequence[models.Look], query_params={"fields": fields}
        )
        assert isinstance(response, list)
        return response
    ...
    def all_model_sets(
        ...
        """Get All Model Sets"""
        response = self.get(
            f"/model_sets", Sequence[models.ModelSet], query_params={"fields": fields}
        )
        assert isinstance(response, list)
        return response
    ...
    def all_permissions(self) -> Sequence[models.Permission]:
        """Get All Permissions"""
        response = self.get(f"/permissions", Sequence[models.Permission])
        assert isinstance(response, list)
        return response
    ...
    def all_projects(
        ...
        """Get All Projects"""
        response = self.get(
            f"/projects", Sequence[models.Project], query_params={"fields": fields}
        )
        assert isinstance(response, list)
        return response
    ...
    def all_running_queries(self) -> Sequence[models.RunningQueries]:
        """Get All Running Queries"""
        response = self.get(f"/running_queries", Sequence[models.RunningQueries])
        assert isinstance(response, list)
        return response
    ...
    def all_spaces(
        ...
        """Get All Spaces"""
        response = self.get(
            f"/spaces", Sequence[models.SpaceBase], query_params={"fields": fields}
        )
        assert isinstance(response, list)
        return response
    ...
    def all_themes(
        ...
        """Get All Themes"""
        response = self.get(
            f"/themes", Sequence[models.Theme], query_params={"fields": fields}
        )
        assert isinstance(response, list)
        return response

    # GET /timezones -> Sequence[models.Timezone]
    def all_timezones(self) -> Sequence[models.Timezone]:
        """Get All Timezones"""
        response = self.get(f"/timezones", Sequence[models.Timezone])
        assert isinstance(response, list)
        return response
    ...
    def all_workspaces(self) -> Sequence[models.Workspace]:
        """Get All Workspaces"""
        response = self.get(f"/workspaces", Sequence[models.Workspace])
        assert isinstance(response, list)
        return response

    # GET /backup_configuration -> models.BackupConfiguration
    def backup_configuration(self) -> models.BackupConfiguration:
        """Get Backup Configuration"""
        response = self.get(f"/backup_configuration", models.BackupConfiguration)
    ...
    def create_color_collection(
        self, body: Optional[models.WriteColorCollection] = None
    ) -> models.ColorCollection:
        """Create ColorCollection"""
        response = self.post(f"/color_collections", models.ColorCollection, body=body)
        assert isinstance(response, models.ColorCollection)
        return response

    # POST /connections -> models.DBConnection
    def create_connection(
        self, body: Optional[models.WriteDBConnection] = None
    ) -> models.DBConnection:
        """Create Connection"""
        response = self.post(f"/connections", models.DBConnection, body=body)
        assert isinstance(response, models.DBConnection)
        return response

    # POST /content_favorite -> models.ContentFavorite
    def create_content_favorite(
        self, body: Optional[models.WriteContentFavorite] = None
    ) -> models.ContentFavorite:
        """Create Favorite Content"""
        response = self.post(f"/content_favorite", models.ContentFavorite, body=body)
        assert isinstance(response, models.ContentFavorite)
        return response

    # POST /content_metadata_access -> models.ContentMetaGroupUser
    def create_content_metadata_access(
        self, body: Optional[models.ContentMetaGroupUser] = None
    ) -> models.ContentMetaGroupUser:
        """Create Content Metadata Access"""
        response = self.post(
            f"/content_metadata_access", models.ContentMetaGroupUser, body=body
        )
    ...
    def create_dashboard(
        self, body: Optional[models.WriteDashboard] = None
    ) -> models.Dashboard:
        """Create Dashboard"""
        response = self.post(f"/dashboards", models.Dashboard, body=body)
    ...
    def create_folder(self, body: Optional[models.WriteFolder] = None) -> models.Folder:
        """Create Folder"""
        response = self.post(f"/folders", models.Folder, body=body)
    ...
    def create_git_branch(
        ...
        response = self.post(
            f"/projects/{project_id}/git_branch", models.GitBranch, body=body
        )
    ...
    def create_git_deploy_key(
        ...
        """Create Deploy Key"""
        response = self.post(f"/projects/{project_id}/git/deploy_key", str)
    ...
    def create_group(
        ...
        """Create Group"""
        response = self.post(
            f"/groups", models.Group, query_params={"fields": fields}, body=body
        )
        assert isinstance(response, models.Group)
        return response
    ...
    def create_homepage(
        ...
        """Create Homepage"""
        response = self.post(
            f"/homepages", models.Homepage, query_params={"fields": fields}, body=body
        )
    ...
    def create_look(
        ...
        """Create Look"""
        response = self.post(
            f"/looks", models.LookWithQuery, query_params={"fields": fields}, body=body
        )
    ...
    def create_lookml_model(
        self, body: Optional[models.WriteLookmlModel] = None
    ) -> models.LookmlModel:
        """Create LookML Model"""
        response = self.post(f"/lookml_models", models.LookmlModel, body=body)
    ...
    def create_model_set(
        self, body: Optional[models.WriteModelSet] = None
    ) -> models.ModelSet:
        """Create Model Set"""
        response = self.post(f"/model_sets", models.ModelSet, body=body)
        assert isinstance(response, models.ModelSet)
        return response

    # POST /oidc_test_configs -> models.OIDCConfig
    def create_oidc_test_config(
        self, body: models.WriteOIDCConfig
    ) -> models.OIDCConfig:
        """Create OIDC Test Configuration"""
        response = self.post(f"/oidc_test_configs", models.OIDCConfig, body=body)
        assert isinstance(response, models.OIDCConfig)
        return response

    # POST /permission_sets -> models.PermissionSet
    def create_permission_set(
        self, body: Optional[models.WritePermissionSet] = None
    ) -> models.PermissionSet:
        """Create Permission Set"""
        response = self.post(f"/permission_sets", models.PermissionSet, body=body)
        assert isinstance(response, models.PermissionSet)
        return response

    # POST /projects -> models.Project
    def create_project(
        self, body: Optional[models.WriteProject] = None
    ) -> models.Project:
        """Create Project"""
        response = self.post(f"/projects", models.Project, body=body)
    ...
    def create_query(
        ...
        """Create Query"""
        response = self.post(
            f"/queries", models.Query, query_params={"fields": fields}, body=body
        )
    ...
    def create_role(self, body: Optional[models.WriteRole] = None) -> models.Role:
        """Create Role"""
        response = self.post(f"/roles", models.Role, body=body)
        assert isinstance(response, models.Role)
        return response

    # POST /saml_test_configs -> models.SamlConfig
    def create_saml_test_config(
        self, body: models.WriteSamlConfig
    ) -> models.SamlConfig:
        """Create SAML Test Configuration"""
        response = self.post(f"/saml_test_configs", models.SamlConfig, body=body)
        assert isinstance(response, models.SamlConfig)
        return response

    # POST /scheduled_plans -> models.ScheduledPlan
    def create_scheduled_plan(
        self, body: Optional[models.WriteScheduledPlan] = None
    ) -> models.ScheduledPlan:
        """Create Scheduled Plan"""
        response = self.post(f"/scheduled_plans", models.ScheduledPlan, body=body)
        assert isinstance(response, models.ScheduledPlan)
        return response

    # POST /spaces -> models.Space
    def create_space(self, body: models.WriteSpace) -> models.Space:
        """Create Space"""
        response = self.post(f"/spaces", models.Space, body=body)
        assert isinstance(response, models.Space)
        return response

    # POST /sql_queries -> models.SqlQuery
    def create_sql_query(self, body: models.WriteSqlQueryCreate) -> models.SqlQuery:
        """Create SQL Runner Query"""
        response = self.post(f"/sql_queries", models.SqlQuery, body=body)
        assert isinstance(response, models.SqlQuery)
        return response

    # POST /themes -> models.Theme
    def create_theme(self, body: Optional[models.WriteTheme] = None) -> models.Theme:
        """Create Theme"""
        response = self.post(f"/themes", models.Theme, body=body)
    ...
    def create_user(
        ...
        """Create User"""
        response = self.post(
            f"/users", models.User, query_params={"fields": fields}, body=body
        )
        assert isinstance(response, models.User)
        return response
    ...
    def datagroup(
        ...
        """Get Datagroup"""
        response = self.get(f"/datagroups/{datagroup_id}", models.Datagroup)
        assert isinstance(response, models.Datagroup)
        return response

    # GET /color_collections/default -> models.ColorCollection
    def default_color_collection(self) -> models.ColorCollection:
        """Get Default Color Collection"""
        response = self.get(f"/color_collections/default", models.ColorCollection)
        assert isinstance(response, models.ColorCollection)
        return response
    ...
    def default_theme(
        ...
        """Get Default Theme"""
        response = self.get(f"/themes/default", models.Theme, query_params={"ts": ts})
        assert isinstance(response, models.Theme)
        return response
    ...
    def delete_color_collection(
        ...
        response = self.delete(f"/color_collections/{collection_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_connection(
        ...
        """Delete Connection"""
        response = self.delete(f"/connections/{connection_name}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_content_favorite(
        ...
        response = self.delete(f"/content_favorite/{content_favorite_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_content_metadata_access(
        ...
        response = self.delete(
            f"/content_metadata_access/{content_metadata_access_id}", str
        )
        assert isinstance(response, str)
        return response
    ...
    def delete_dashboard(
        ...
        """Delete Dashboard"""
        response = self.delete(f"/dashboards/{dashboard_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_dashboard_element(
        ...
        response = self.delete(f"/dashboard_elements/{dashboard_element_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_dashboard_filter(
        ...
        response = self.delete(f"/dashboard_filters/{dashboard_filter_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_dashboard_layout(
        ...
        response = self.delete(f"/dashboard_layouts/{dashboard_layout_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_folder(
        ...
        """Delete Folder"""
        response = self.delete(f"/folders/{folder_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_git_branch(
        ...
        """Delete a Git Branch"""
        response = self.delete(f"/projects/{project_id}/git_branch/{branch_name}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_group(
        ...
        """Delete Group"""
        response = self.delete(f"/groups/{group_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_group_user(
        ...
        response = self.delete(f"/groups/{group_id}/users/{user_id}")
        assert response is None
        return response
    ...
    def delete_homepage(
        ...
        """Delete Homepage"""
        response = self.delete(f"/homepages/{homepage_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_homepage_item(
        ...
        response = self.delete(f"/homepage_items/{homepage_item_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_homepage_section(
        ...
        response = self.delete(f"/homepage_sections/{homepage_section_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_integration_hub(
        ...
        response = self.delete(f"/integration_hubs/{integration_hub_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_look(
        ...
        """Delete Look"""
        response = self.delete(f"/looks/{look_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_lookml_model(
        ...
        """Delete LookML Model"""
        response = self.delete(f"/lookml_models/{lookml_model_name}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_model_set(
        ...
        """Delete Model Set"""
        response = self.delete(f"/model_sets/{model_set_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_oidc_test_config(
        ...
        response = self.delete(f"/oidc_test_configs/{test_slug}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_permission_set(
        ...
        response = self.delete(f"/permission_sets/{permission_set_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_repository_credential(
        ...
        response = self.delete(
            f"/projects/{root_project_id}/credential/{credential_id}", str
        )
        assert isinstance(response, str)
        return response
    ...
    def delete_role(
        ...
        """Delete Role"""
        response = self.delete(f"/roles/{role_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_saml_test_config(
        ...
        response = self.delete(f"/saml_test_configs/{test_slug}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_scheduled_plan(
        ...
        response = self.delete(f"/scheduled_plans/{scheduled_plan_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_space(
        ...
        """Delete Space"""
        response = self.delete(f"/spaces/{space_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_theme(
        ...
        """Delete Theme"""
        response = self.delete(f"/themes/{theme_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user(
        ...
        """Delete User"""
        response = self.delete(f"/users/{user_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_attribute(
        ...
        response = self.delete(f"/user_attributes/{user_attribute_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_attribute_user_value(
        ...
        response = self.delete(f"/users/{user_id}/attribute_values/{user_attribute_id}")
        assert response is None
        return response
    ...
    def delete_user_credentials_api3(
        ...
        response = self.delete(
            f"/users/{user_id}/credentials_api3/{credentials_api3_id}", str
        )
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_email(
        ...
        response = self.delete(f"/users/{user_id}/credentials_email", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_embed(
        ...
        response = self.delete(
            f"/users/{user_id}/credentials_embed/{credentials_embed_id}", str
        )
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_google(
        ...
        response = self.delete(f"/users/{user_id}/credentials_google", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_ldap(
        ...
        response = self.delete(f"/users/{user_id}/credentials_ldap", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_looker_openid(
        ...
        response = self.delete(f"/users/{user_id}/credentials_looker_openid", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_oidc(
        ...
        response = self.delete(f"/users/{user_id}/credentials_oidc", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_saml(
        ...
        response = self.delete(f"/users/{user_id}/credentials_saml", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_credentials_totp(
        ...
        response = self.delete(f"/users/{user_id}/credentials_totp", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_login_lockout(
        ...
        response = self.delete(f"/user_login_lockout/{key}", str)
        assert isinstance(response, str)
        return response
    ...
    def delete_user_session(
        ...
        response = self.delete(f"/users/{user_id}/sessions/{session_id}", str)
        assert isinstance(response, str)
        return response
    ...
    def deploy_to_production(
        ...
        response = self.post(f"/projects/{project_id}/deploy_to_production", str)
        assert isinstance(response, str)
        return response
    ...
    def fetch_integration_form(
        ...
        response = self.post(
            f"/integrations/{integration_id}/form", models.DataActionForm
        )
    ...
    def fetch_remote_data_action_form(
        self, body: MutableMapping[str, str]
    ) -> models.DataActionForm:
        """Fetch Remote Data Action Form"""
        response = self.post(f"/data_actions/form", models.DataActionForm, body=body)
        assert isinstance(response, models.DataActionForm)
        return response
    ...
    def find_git_branch(
        ...
        """Find a Git Branch"""
        response = self.get(
            f"/projects/{project_id}/git_branch/{branch_name}", models.GitBranch
        )
        assert isinstance(response, models.GitBranch)
        return response
    ...
    def folder(
        ...
        """Get Folder"""
        response = self.get(
            f"/folders/{folder_id}", models.Folder, query_params={"fields": fields}
        )
        assert isinstance(response, models.Folder)
        return response
    ...
    def force_password_reset_at_next_login_for_all_users(self) -> str:
        """Force password reset"""
        response = self.put(
            f"/password_config/force_password_reset_at_next_login_for_all_users", str
        )
        assert isinstance(response, str)
        return response
    ...
    def git_branch(
        ...
        response = self.get(f"/projects/{project_id}/git_branch", models.GitBranch)
        assert isinstance(response, models.GitBranch)
        return response
    ...
    def git_deploy_key(
        ...
        """Git Deploy Key"""
        response = self.get(f"/projects/{project_id}/git/deploy_key", str)
        assert isinstance(response, str)
        return response
    ...
    def group(
        ...
        """Get Group"""
        response = self.get(
            f"/groups/{group_id}", models.Group, query_params={"fields": fields}
        )
        assert isinstance(response, models.Group)
        return response
    ...
    def internal_help_resources(self) -> models.InternalHelpResources:
        """Get Internal Help Resources"""
        response = self.get(
            f"/internal_help_resources_enabled", models.InternalHelpResources
        )
    ...
    def internal_help_resources_content(self) -> models.InternalHelpResourcesContent:
        """Get Internal Help Resources Content"""
        response = self.get(
            f"/internal_help_resources_content", models.InternalHelpResourcesContent
        )
    ...
    def kill_query(
        ...
        """Kill Running Query"""
        response = self.delete(f"/running_queries/{query_task_id}", str)
        assert isinstance(response, str)
        return response

    # GET /ldap_config -> models.LDAPConfig
    def ldap_config(self) -> models.LDAPConfig:
        """Get LDAP Configuration"""
        response = self.get(f"/ldap_config", models.LDAPConfig)
    ...
    def legacy_feature(
        ...
        """Get Legacy Feature"""
        response = self.get(
            f"/legacy_features/{legacy_feature_id}", models.LegacyFeature
        )
    ...
    def look(
        ...
        """Get Look"""
        response = self.get(
            f"/looks/{look_id}", models.LookWithQuery, query_params={"fields": fields}
        )
        assert isinstance(response, models.LookWithQuery)
        return response
    ...
    def manifest(
        ...
        """Get Manifest"""
        response = self.get(f"/projects/{project_id}/manifest", models.Manifest)
    ...
    def me(
        ...
        """Get Current User"""
        response = self.get(f"/user", models.User, query_params={"fields": fields})
        assert isinstance(response, models.User)
        return response
    ...
    def oidc_config(self) -> models.OIDCConfig:
        """Get OIDC Configuration"""
        response = self.get(f"/oidc_config", models.OIDCConfig)
        assert isinstance(response, models.OIDCConfig)
        return response
    ...
    def oidc_test_config(
        ...
        response = self.get(f"/oidc_test_configs/{test_slug}", models.OIDCConfig)
        assert isinstance(response, models.OIDCConfig)
        return response

    # POST /parse_saml_idp_metadata -> models.SamlMetadataParseResult
    def parse_saml_idp_metadata(self, body: str) -> models.SamlMetadataParseResult:
        """Parse SAML IdP XML"""
        response = self.post(
            f"/parse_saml_idp_metadata", models.SamlMetadataParseResult, body=body
        )
        assert isinstance(response, models.SamlMetadataParseResult)
        return response

    # GET /password_config -> models.PasswordConfig
    def password_config(self) -> models.PasswordConfig:
        """Get Password Config"""
        response = self.get(f"/password_config", models.PasswordConfig)
        assert isinstance(response, models.PasswordConfig)
        return response

    # POST /data_actions -> models.DataActionResponse
    def perform_data_action(
        self, body: models.WriteDataActionRequest
    ) -> models.DataActionResponse:
        """Send a Data Action"""
        response = self.post(f"/data_actions", models.DataActionResponse, body=body)
    ...
    def project(
        ...
        """Get Project"""
        response = self.get(
            f"/projects/{project_id}", models.Project, query_params={"fields": fields}
        )
        assert isinstance(response, models.Project)
        return response
    ...
    def query(
        ...
        """Get Query"""
        response = self.get(
            f"/queries/{query_id}", models.Query, query_params={"fields": fields}
        )
        assert isinstance(response, models.Query)
        return response
    ...
    def query_for_slug(
        ...
        """Get Query for Slug"""
        response = self.get(
            f"/queries/slug/{slug}", models.Query, query_params={"fields": fields}
        )
        assert isinstance(response, models.Query)
        return response
    ...
    def query_task_results(
        ...
        response = self.get(
            f"/query_tasks/{query_task_id}/results", MutableMapping[str, str]
        )
        assert isinstance(response, dict)
        return response
    ...
    # GET /render_tasks/{render_task_id}/results -> str
    def render_task_results(
        ...
        """Render Task Results"""
        response = self.get(f"/render_tasks/{render_task_id}/results", str)
        assert isinstance(response, str)
        return response
    ...
    def reset_project_to_production(
        ...
        """Reset To Production"""
        response = self.post(f"/projects/{project_id}/reset_to_production", str)
        assert isinstance(response, str)
        return response
    ...
    def reset_project_to_remote(
        ...
        """Reset To Remote"""
        response = self.post(f"/projects/{project_id}/reset_to_remote", str)
        assert isinstance(response, str)
        return response
    ...
    def role(
        ...
        """Get Role"""
        response = self.get(f"/roles/{role_id}", models.Role)
        assert isinstance(response, models.Role)
        return response
    ...
    # POST /queries/run/{result_format} -> str
    ...
    # GET /looks/{look_id}/run/{result_format} -> str
    def run_look(
        self,
        # Id of look
        look_id: int,
    ...
    # GET /queries/{query_id}/run/{result_format} -> str
    def run_query(
        self,
        # Id of query
        query_id: int,
    ...
    # GET /queries/models/{model_name}/views/{view_name}/run/{result_format} -> str
    def run_url_encoded_query(
        ...
        response = self.get(
            f"/queries/models/{model_name}/views/{view_name}/run/{result_format}", str
        )
        assert isinstance(response, str)
        return response

    # GET /saml_config -> models.SamlConfig
    def saml_config(self) -> models.SamlConfig:
        """Get SAML Configuration"""
        response = self.get(f"/saml_config", models.SamlConfig)
        assert isinstance(response, models.SamlConfig)
        return response
    ...
    def saml_test_config(
        ...
        response = self.get(f"/saml_test_configs/{test_slug}", models.SamlConfig)
        assert isinstance(response, models.SamlConfig)
        return response
    ...
    def scheduled_plan_run_once(
        ...
        response = self.post(
            f"/scheduled_plans/run_once", models.ScheduledPlan, body=body
        )
        assert isinstance(response, models.ScheduledPlan)
        return response
    ...
    def session(self) -> models.ApiSession:
        """Get Session"""
        response = self.get(f"/session", models.ApiSession)
        assert isinstance(response, models.ApiSession)
        return response

    # GET /session_config -> models.SessionConfig
    def session_config(self) -> models.SessionConfig:
        """Get Session Config"""
        response = self.get(f"/session_config", models.SessionConfig)
    ...
    def set_default_theme(
        ...
        """Set Default Theme"""
        response = self.put(
            f"/themes/default", models.Theme, query_params={"name": name}
        )
        assert isinstance(response, models.Theme)
        return response
    ...
    def set_role_groups(
        ...
        """Update Role Groups"""
        response = self.put(
            f"/roles/{role_id}/groups", Sequence[models.Group], body=body
        )
        assert isinstance(response, list)
        return response
    ...
    def set_role_users(
        ...
        """Update Role Users"""
        response = self.put(f"/roles/{role_id}/users", Sequence[models.User], body=body)
        assert isinstance(response, list)
        return response
    ...
    def space(
        ...
        """Get Space"""
        response = self.get(
            f"/spaces/{space_id}", models.Space, query_params={"fields": fields}
        )
        assert isinstance(response, models.Space)
        return response
    ...
    def space_parent(
        ...
        """Get Space Parent"""
        response = self.get(
            f"/spaces/{space_id}/parent", models.Space, query_params={"fields": fields}
        )
        assert isinstance(response, models.Space)
        return response
    ...
    def sql_query(
        ...
        response = self.get(f"/sql_queries/{slug}", models.SqlQuery)
        assert isinstance(response, models.SqlQuery)
        return response
    ...
    def test_integration(
        ...
        """Test integration"""
        response = self.post(
            f"/integrations/{integration_id}/test", models.IntegrationTestResult
        )
    ...
    def test_ldap_config_auth(
        self, body: models.WriteLDAPConfig
    ) -> models.LDAPConfigTestResult:
        """Test LDAP Auth"""
        response = self.put(
            f"/ldap_config/test_auth", models.LDAPConfigTestResult, body=body
        )
    ...
    def test_ldap_config_connection(
        ...
        response = self.put(
            f"/ldap_config/test_connection", models.LDAPConfigTestResult, body=body
        )
        assert isinstance(response, models.LDAPConfigTestResult)
        return response
    ...
    def test_ldap_config_user_auth(
        ...
        """Test LDAP User Auth"""
        response = self.put(
            f"/ldap_config/test_user_auth", models.LDAPConfigTestResult, body=body
        )
        assert isinstance(response, models.LDAPConfigTestResult)
        return response
    ...
    def test_ldap_config_user_info(
        ...
        """Test LDAP User Info"""
        response = self.put(
            f"/ldap_config/test_user_info", models.LDAPConfigTestResult, body=body
        )
        assert isinstance(response, models.LDAPConfigTestResult)
        return response
    ...
    def theme(
        ...
        """Get Theme"""
        response = self.get(
            f"/themes/{theme_id}", models.Theme, query_params={"fields": fields}
        )
        assert isinstance(response, models.Theme)
        return response
    ...
    def update_backup_configuration(
        self, body: models.WriteBackupConfiguration
    ) -> models.BackupConfiguration:
        """Update Backup Configuration"""
        response = self.patch(
            f"/backup_configuration", models.BackupConfiguration, body=body
        )
        assert isinstance(response, models.BackupConfiguration)
        return response
    ...
    def update_color_collection(
        ...
        response = self.patch(
            f"/color_collections/{collection_id}", models.ColorCollection, body=body
        )
        assert isinstance(response, models.ColorCollection)
        return response
    ...
    def update_connection(
        ...
        """Update Connection"""
        response = self.patch(
            f"/connections/{connection_name}", models.DBConnection, body=body
        )
        assert isinstance(response, models.DBConnection)
        return response
    ...
    def update_content_metadata(
        ...
        response = self.patch(
            f"/content_metadata/{content_metadata_id}", models.ContentMeta, body=body
        )
        assert isinstance(response, models.ContentMeta)
        return response
    ...
    def update_dashboard(
        ...
        """Update Dashboard"""
        response = self.patch(
            f"/dashboards/{dashboard_id}", models.Dashboard, body=body
        )
        assert isinstance(response, models.Dashboard)
        return response
    ...
    def update_datagroup(
        ...
        """Update Datagroup"""
        response = self.patch(
            f"/datagroups/{datagroup_id}", models.Datagroup, body=body
        )
        assert isinstance(response, models.Datagroup)
        return response
    ...
    def update_folder(
        ...
        """Update Folder"""
        response = self.patch(f"/folders/{folder_id}", models.Folder, body=body)
        assert isinstance(response, models.Folder)
        return response
    ...
    def update_internal_help_resources(
        ...
        response = self.patch(
            f"/internal_help_resources", models.InternalHelpResources, body=body
        )
        assert isinstance(response, models.InternalHelpResources)
        return response
    ...
    def update_internal_help_resources_content(
        self, body: models.WriteInternalHelpResourcesContent
    ...
    def update_ldap_config(self, body: models.WriteLDAPConfig) -> models.LDAPConfig:
        """Update LDAP Configuration"""
        response = self.patch(f"/ldap_config", models.LDAPConfig, body=body)
        assert isinstance(response, models.LDAPConfig)
        return response
    ...
    def update_legacy_feature(
        ...
        response = self.patch(
            f"/legacy_features/{legacy_feature_id}", models.LegacyFeature, body=body
        )
        assert isinstance(response, models.LegacyFeature)
        return response
    ...
    def update_lookml_model(
        ...
        """Update LookML Model"""
        response = self.patch(
            f"/lookml_models/{lookml_model_name}", models.LookmlModel, body=body
        )
        assert isinstance(response, models.LookmlModel)
        return response
    ...
    def update_model_set(
        ...
        """Update Model Set"""
        response = self.patch(f"/model_sets/{model_set_id}", models.ModelSet, body=body)
        assert isinstance(response, models.ModelSet)
        return response

    # PATCH /oidc_config -> models.OIDCConfig
    def update_oidc_config(self, body: models.WriteOIDCConfig) -> models.OIDCConfig:
        """Update OIDC Configuration"""
        response = self.patch(f"/oidc_config", models.OIDCConfig, body=body)
        assert isinstance(response, models.OIDCConfig)
        return response

    # PATCH /password_config -> models.PasswordConfig
    def update_password_config(
        self, body: models.WritePasswordConfig
    ) -> models.PasswordConfig:
        """Update Password Config"""
        response = self.patch(f"/password_config", models.PasswordConfig, body=body)
        assert isinstance(response, models.PasswordConfig)
        return response
    ...
    def update_permission_set(
        ...
        response = self.patch(
            f"/permission_sets/{permission_set_id}", models.PermissionSet, body=body
        )
        assert isinstance(response, models.PermissionSet)
        return response
    ...
    def update_role(
        ...
        """Update Role"""
        response = self.patch(f"/roles/{role_id}", models.Role, body=body)
        assert isinstance(response, models.Role)
        return response

    # PATCH /saml_config -> models.SamlConfig
    def update_saml_config(self, body: models.WriteSamlConfig) -> models.SamlConfig:
        """Update SAML Configuration"""
        response = self.patch(f"/saml_config", models.SamlConfig, body=body)
        assert isinstance(response, models.SamlConfig)
        return response
    ...
    def update_scheduled_plan(
        ...
        response = self.patch(
            f"/scheduled_plans/{scheduled_plan_id}", models.ScheduledPlan, body=body
        )
        assert isinstance(response, models.ScheduledPlan)
        return response

    # PATCH /session -> models.ApiSession
    def update_session(self, body: models.WriteApiSession) -> models.ApiSession:
        """Update Session"""
        response = self.patch(f"/session", models.ApiSession, body=body)
        assert isinstance(response, models.ApiSession)
        return response

    # PATCH /session_config -> models.SessionConfig
    def update_session_config(
        self, body: models.WriteSessionConfig
    ) -> models.SessionConfig:
        """Update Session Config"""
        response = self.patch(f"/session_config", models.SessionConfig, body=body)
        assert isinstance(response, models.SessionConfig)
        return response
    ...
    def update_space(
        ...
        """Update Space"""
        response = self.patch(f"/spaces/{space_id}", models.Space, body=body)
        assert isinstance(response, models.Space)
        return response
    ...
    def update_theme(
        ...
        """Update Theme"""
        response = self.patch(f"/themes/{theme_id}", models.Theme, body=body)
        assert isinstance(response, models.Theme)
        return response
    ...
    def update_user(
        ...
        """Update User"""
        response = self.patch(
            f"/users/{user_id}", models.User, query_params={"fields": fields}, body=body
        )
        assert isinstance(response, models.User)
        return response
    ...
    def update_whitelabel_configuration(
        self, body: models.WriteWhitelabelConfiguration
    ) -> models.WhitelabelConfiguration:
        """Update Whitelabel configuration"""
        response = self.put(
            f"/whitelabel_configuration", models.WhitelabelConfiguration, body=body
        )
    ...
    def user(
        ...
        """Get User by Id"""
        response = self.get(
            f"/users/{user_id}", models.User, query_params={"fields": fields}
        )
        assert isinstance(response, models.User)
        return response
    ...
    def validate_theme(
        self, body: Optional[models.WriteTheme] = None
    ) -> models.ValidationError:
        """Validate Theme"""
        response = self.post(f"/themes/validate", models.ValidationError, body=body)
    ...
    def versions(
        ...
        """Get ApiVersion"""
        response = self.get(
            f"/versions", models.ApiVersion, query_params={"fields": fields}
        )
    ...
    def workspace(
        ...
        """Get Workspace"""
        response = self.get(f"/workspaces/{workspace_id}", models.Workspace)
