...
class FunctionalLocationRepresentation(object):
    ...
    def __init__(self, id=None, functional_location_name=None, functional_location_type=None, functional_location_type_id=None, attributes=None, links=None, embedded=None):  # noqa: E501
