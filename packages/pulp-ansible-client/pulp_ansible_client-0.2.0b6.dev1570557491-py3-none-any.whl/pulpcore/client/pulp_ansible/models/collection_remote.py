...
class CollectionRemote(object):
    ...
    def __init__(self, href=None, created=None, type=None, name=None, url=None, ssl_ca_certificate=None, ssl_client_certificate=None, ssl_client_key=None, ssl_validation=None, proxy_url=None, username=None, password=None, last_updated=None, download_concurrency=None, policy='immediate', requirements_file=None):  # noqa: E501
    ...
    def requirements_file(self, requirements_file):
        ...
        :type: str
        """
        if requirements_file is not None and len(requirements_file) < 1:
