...
class Experiment(CnvrgJob):
    ...
    @staticmethod
    def run(command=None, title=None, project=None, compute=None, computes=None,
            datasets=None, dataset=None, local=False, library=None, working_directory=None,
            sync_before=True, sync_after=True, **kwargs):
