...
def NO2NWB_export(exportFromDryad, path_to_data):
    ...
    if exportFromDryad:
        ...
        #  Download the Rutishauser Lab dataset from the Dryad Repository (https://datadryad.org/resource/doi:10.5061/dryad.46st5)
