...
return value;}};guiFields.namedbinimage=class NamedBinImageField extends guiFields.namedbinfile{static get mixins(){return super.mixins.concat(gui_fields_mixins.namedbinimage);}};guiFields.text_paragraph=class TextParagraphField extends guiFields.base{toRepresent(data={}){let value=data[this.options.name];if(value===undefined){return this.options.default;}
