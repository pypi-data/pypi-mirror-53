...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2-targets", "1.12.0", __name__, "aws-elasticloadbalancingv2-targets@1.12.0.jsii.tgz")
