...
id = "2d844d12922eb0bc957eefb930985f8b33bd681f"
date = "2019-10-8 14:11:18 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "2d844d12922eb0bc957eefb930985f8b33bd681f":
        return
    msg = "Program id (2d844d12922eb0bc957eefb930985f8b33bd681f) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
