...
_DATARESPONSE_DATA = _descriptor.Descriptor(
  ...
  nested_types=[_DATARESPONSE_DATA_POSITION, _DATARESPONSE_DATA_SPEED, _DATARESPONSE_DATA_STEERINGANGLE, _DATARESPONSE_DATA_LIDAR, _DATARESPONSE_DATA_CAMERA, _DATARESPONSE_DATA_DAMAGE, _DATARESPONSE_DATA_ROADCENTERDISTANCE, _DATARESPONSE_DATA_CARTOLANEANGLE, _DATARESPONSE_DATA_BOUNDINGBOX, _DATARESPONSE_DATA_ERROR, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
