...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-identity',
    project_urls={
        'Documentation': 'https://tendril-identity.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-identity/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-identity',
    },
