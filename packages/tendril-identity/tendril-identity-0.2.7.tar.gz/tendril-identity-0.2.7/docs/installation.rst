...
``tendril-identity`` can be installed normally from the Python Package Index.
...
`github releases <https://github.com/tendril-framework/tendril-identity/releases>`_.
...
``tendril-identity``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-identity.git
    $ cd tendril-identity
    $ pip install -e .
