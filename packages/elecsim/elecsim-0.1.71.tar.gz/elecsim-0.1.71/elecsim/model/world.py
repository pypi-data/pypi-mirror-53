    ...
    def override_total_demand(self, total_demand, number_of_agents=None):
        ...
        if total_demand is not None:
            ...
            if number_of_agents is not None:
                ...
                elecsim.scenario.scenario_data.power_plants.Company = np.repeat(company_names, int(fraction_to_replace))[:total_plants]

                print(len(elecsim.scenario.scenario_data.power_plants.Company))
                print(len(np.repeat(company_names, int(fraction_to_replace))[:total_plants]))
