from abc import ABC
from typing import TypeVar, Generic, Type, Any, Dict, List, overload, Union, Tuple
...
class IEncoder(ABC, Generic[T]):
    ...
    @classmethod
    def _encode_many(cls, model: Type[T], obj: List[T], **kwargs) -> EncodedObjListType:
        raise NotImplementedError
    @classmethod
    def encode_many(cls, model: Type[T], obj: List[T], **kwargs) -> EncodedObjListType:
        cls._check_type(model)
