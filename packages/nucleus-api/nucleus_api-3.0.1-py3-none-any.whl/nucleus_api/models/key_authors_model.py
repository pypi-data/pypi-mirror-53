...
class KeyAuthorsModel(object):
    ...
    def __init__(self, dataset=None, query=None, custom_stop_words=None, num_topics=None, num_keywords=None, metadata_selection=None, time_period=None, period_start=None, period_end=None, num_authors=None, num_keydocs=None, excluded_docs=None, custom_dict_file=None):  # noqa: E501
