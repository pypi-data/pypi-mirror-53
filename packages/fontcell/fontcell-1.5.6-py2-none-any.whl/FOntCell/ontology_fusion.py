...
def gen_graph_similarity_array(node1, ontology1, ontology2, subgraphs2, window_size, auto, topological=True,
...
def equivalent_dictionary_semi(graph1, graph2, sequential, globalthreshold, localthreshold, subgraphs1, subgraphs2,
    ...
    def question(actual_node, candidat):
        ...
        while not questioned:
            response = str(input('It is ' + actual_node + ' = ' + candidat + '? (y/n)'))
            if response.lower() == 'yes' or response.lower() == 'y':
                print('Assigned ' + actual_node + ' as ' + candidat)
                answer = True
                questioned = True
