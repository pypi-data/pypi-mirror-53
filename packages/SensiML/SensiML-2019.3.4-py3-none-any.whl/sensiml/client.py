...
class SensiML(object):
    ...
    def list_knowledgepacks(self, unnamed=False):
        ...
        if unnamed:
            return knowledgepack_list[['Name', 'Created', 'Project', 'Pipeline', 'kp_uuid', 'kp_description']]

        return knowledgepack_list[knowledgepack_list['Name'] != ''][['Name', 'Created', 'Project', 'Pipeline', 'kp_uuid', 'kp_description']]
