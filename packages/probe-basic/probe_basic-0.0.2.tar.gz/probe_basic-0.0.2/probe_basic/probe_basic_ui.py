...
"}")
        ...
        self.widget_5.setGeometry(QtCore.QRect(0, 30, 171, 480))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_141.setContentsMargins(10, 10, 10, 30)
...
"}")
        ...
        self.probesim = ProbeSim(self.widget_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.verticalLayout_141.addWidget(self.probesim)
...
"]"))
        ...
        self.extra_probe_depth.setText(_translate("Form", "0.5000"))
