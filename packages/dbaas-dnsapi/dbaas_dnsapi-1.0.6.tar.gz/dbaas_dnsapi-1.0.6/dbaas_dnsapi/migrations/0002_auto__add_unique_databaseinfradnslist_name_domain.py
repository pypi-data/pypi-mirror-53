...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DatabaseInfraDNSList', fields ['name', 'domain']
        db.create_unique(u'dbaas_dnsapi_databaseinfradnslist', ['name', 'domain'])


    def backwards(self, orm):
        # Removing unique constraint on 'DatabaseInfraDNSList', fields ['name', 'domain']
        db.delete_unique(u'dbaas_dnsapi_databaseinfradnslist', ['name', 'domain'])
