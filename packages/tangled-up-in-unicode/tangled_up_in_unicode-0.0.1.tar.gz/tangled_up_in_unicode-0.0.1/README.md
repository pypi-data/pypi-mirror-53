...
Enabling a larger range of applications within the Python realm.
Note: useful for data analysis

Please read the [docs](#) for details.

Contains an in-memory database of Unicode.
- Hangul Syllable 
- Name ranges
...
It is compiled with Cython to gain [competitive performance](# "Meaning the null hypothesis of the two libraries having the same average runtime could not be rejected.") with the native library.
Functional, in-memory and compiled implementation are present.

Note: currently only for the default platform.
How do people do this automatically cross-platform?
...
## Acknowledgements
Where possible, code and documentation of the original module is used.

Dylan. Support the project. https://patreon.com/dylanprofiling