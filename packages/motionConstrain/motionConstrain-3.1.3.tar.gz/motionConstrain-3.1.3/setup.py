...
setup(
  ...
  version = '3.1.3',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JorryZ/motionConstrain/archive/v3.1.3.tar.gz',    # I explain this later on
