...
def send_mail(event, subject, message, issuer="", priority="low"):
    try:
...
def argparse_entrypoint():
    ...
    parser.add_argument('-m', '--msg', help='Email message goes here.', default="", required=False)
    parser.add_argument('-i', '--issuer', help='Name of issuer', default="", required=False)
    args = parser.parse_args()
    send_mail(args.event, args.subject, args.msg, args.issuer)
