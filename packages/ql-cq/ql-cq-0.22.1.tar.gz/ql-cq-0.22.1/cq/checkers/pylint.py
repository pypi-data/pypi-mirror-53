...
class PylintChecker(cq.checker.Checker):
	...
	@staticmethod
	def _get_pylint_rc_file(default_rcfile_path: str) -> Tuple[str, Optional[IO[bytes]]]:
		'''
	...
	@staticmethod
	def _setup_pylint() -> Tuple[List[str], Optional[IO[bytes]]]:
		'''
		Setup pylint.
