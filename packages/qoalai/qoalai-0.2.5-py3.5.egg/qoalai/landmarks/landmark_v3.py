...
class Landmark(object):
    ...
    def build_densenet_base(self, input_tensor,
        ...
        self.point_map_nonlogit = new_conv2d_layer(input=out, 
                               ...
                               use_bias=False,
                               use_batchnorm=False) 
        self.point_map = tf.nn.sigmoid(self.point_map_nonlogit)
    ...
    def calculate_loss(self):
        ...
        Returns:
            [type] -- [description]
        """
        self.point_map_loss = sigmoid_crossentropy_mean(self.point_map_nonlogit, self.point_map_placeholder)
    ...
    def read_target(self, file_path):
        ...
        for i in range(self.num_landmark_point):
            ...
            #------------------------------------ #
            point_position_label[0, i, 0] = data_x - cell_x * self.grid_size_relative
            point_position_label[0, i, 1] = data_y - cell_y * self.grid_size_relative
    ...
    def optimize(self, 
        ...
        for i in range(iteration):
            ...
            loss = session.run(cost_tensor, feed_dict)
            map_acc = session.run(self.point_map_acc, feed_dict)
            ...
            print (">> epoch: ", i, "train loss: ", round(t_loss, 3), "val loss: ", round(loss, 3), "val map acc: ", round(map_acc, 3), sign)  
