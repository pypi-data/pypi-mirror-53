...
class UserSchema(object):
    ...
    def __init__(self, email_address=None, entity_id=None, object='user', user_name=None):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, email_address=None, entity_id=None, object='user', user_name=None):  # noqa: E501
