...
class ModelServerSchema(object):
    ...
    def __init__(self, config_file_path=None, created_at=None, deployed_by=None, endpoint_id=None, id=None, model_version_id=None, object='server', parameters=None, resources=None, secrets=None, source=None, status=None, undeployed_at=None, undeployed_by=None, updated_at=None):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, config_file_path=None, created_at=None, deployed_by=None, endpoint_id=None, id=None, model_version_id=None, object='server', parameters=None, resources=None, secrets=None, source=None, status=None, undeployed_at=None, undeployed_by=None, updated_at=None):  # noqa: E501
