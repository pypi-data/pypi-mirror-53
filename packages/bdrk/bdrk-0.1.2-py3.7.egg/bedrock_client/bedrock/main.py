...
@click.option(
    "--script-parameters", default=None, help="Script parameters overrides as JSON string"
)
...
def labrun(
    ...
    :param Optional[str] script_parameters: Script parameter overrides, JSON str
    :return None
    """
    ...
    script_params = json.loads(script_parameters) if script_parameters else None
