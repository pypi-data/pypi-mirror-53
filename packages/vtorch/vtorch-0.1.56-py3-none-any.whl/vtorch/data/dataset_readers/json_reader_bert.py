...
from vtorch.data.preprocessors.pynlple_preprocessors import get_pynlple_preprocessors
...
class JsonDatasetBertReader(DatasetReader):
    def __init__(self, pynlple_preprocessors_attr: List[List], tokenizer: str = None,
                 transformer_tokenizer_type: str = None, transformer_tokenizer_name: str = None, to_lower: bool = True,
                 max_padding_length: int = None, lazy: bool = False):
        super().__init__(lazy=lazy)
        pynlple_preprocessors = get_pynlple_preprocessors(pynlple_preprocessors_attr)

        self.preprocessor = StackingPreprocessor(pynlple_preprocessors)
        if tokenizer is not None:
            ...
            self.tokenizer = getattr(pytorch_transformers,
