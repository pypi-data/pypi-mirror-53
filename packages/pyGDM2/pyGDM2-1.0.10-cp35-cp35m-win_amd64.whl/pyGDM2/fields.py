...
def planewave(struct, wavelength, theta=None, polarization_state=None, 
              kSign=-1, k0=None, consider_substrate_reflection=False, 
              returnField='E'):
    ...
    k0 : int, default: None
        **future feature, not yet supported!!!**
        incident wavevector. will override `kSign` if non `None`.
        either kSign or k0 must be given.
    ...
    """    
    if k0 is not None:
        raise ValueError("non-normal incident angles not yet supported.")
    if (struct.n1 !=struct.n2 or struct.n2 != struct.n3) and k0 is not None:
        raise ValueError("`planewave` supports non-normal incident angles only in homogeneous environment (no substrate / cladding).")
...
def focused_planewave(struct, wavelength, theta=None, polarization_state=None, xSpot=0, ySpot=0, 
...
def gaussian(struct, wavelength, theta=None, polarization_state=None, xSpot=0, ySpot=0, zSpot=0, NA=-1, 
...
def gaussian_old(struct, wavelength, theta, xSpot=0, ySpot=0, zSpot=0, NA=-1, 
             spotsize=-1, kSign=-1, paraxial=False, phase=0, returnField='E'):
    """Normal incident (along Z) Gaussian Beam Field
