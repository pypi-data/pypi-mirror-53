...
class hyperdopedSilicon(object):
    ...
    D. Chandler-Horowitz and P. M. Amirtharaj. 
    ...
    def __init__(self, N_dop, factor_gamma=0.1, act_eff=1, carrier='electron'):
        if carrier == 'electron':
            self.m0 = 0.3*self.me
        elif carrier == 'hole':
            self.m0 = 0.4*self.me
...
class hyperdopedConstantDielectric(object):    
    ...
    def __init__(self, n, N_dop, factor_gamma=0.1, act_eff=1, carrier='electron'):
        """Define constant material"""
        self.n = complex(n)
        self.__name__ = 'constant index material, n={}'.format(self.n)
...
MAT_LIST = [dummy, gold, silver, alu, silicon, 
            hyperdopedSilicon, hyperdopedConstantDielectric]