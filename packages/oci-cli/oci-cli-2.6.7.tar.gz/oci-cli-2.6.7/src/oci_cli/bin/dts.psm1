...
function GetOciSubcommands_dts() {
    $ociSubcommands = @{
        ...
        'dts appliance' = 'cancel delete get-passphrase list never-receive request show update-shipping-address'
        'dts job' = 'close create delete detach-devices-details list show update verify-upload-user-credentials'
...
function GetOciCommandsToLongParams_dts() {
    $ociCommandsToLongParams = @{
        ...
        'dts appliance request' = 'customer-shipping-address from-json help job-id'
        'dts appliance show' = 'appliance-label from-json help job-id'
        'dts appliance update-shipping-address' = 'appliance-label customer-shipping-address force from-json help job-id'
