...
from iddexapi.websocket import IDDEXWebsocket
...
class Notify(Events, BlockchainInstance):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`iddex.market.Market` that identify markets to be monitored
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from iddex.notify import Notify
            from iddex.market import Market
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`iddex.price.Order` or
            * :class:`iddex.price.FilledOrder` or
            * :class:`iddex.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:iddex.account.AccountUpdate`
        """
