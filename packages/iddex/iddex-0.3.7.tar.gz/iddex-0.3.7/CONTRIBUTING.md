...
You are here to help IDDEX and the python-iddex library?
...
tracker][https://github.com/iddex/python-iddex/issues] to see if
someone else in the community has already created a ticket. If not, go
ahead and [make one][https://github.com/iddex/python-iddex/issues/new]!
...
* **Ensure the bug was not already reported** by [searching all issues][https://github.com/iddex/python-iddex/issues].

* If you're unable to find an open issue addressing the problem,
  [open a new one][https://github.com/iddex/python-iddex/issues/new]. Be sure
...
[Codeclimate](https://codeclimate.com/github/iddex/python-iddex)
will give you feedback in this regard. You can check & fix codeclimate's
feedback by running it locally using [Codeclimate's CLI](https://codeclimate.com/github/iddex/python-iddex), via
`codeclimate analyze`.
...
sure it's up to date with python-iddex's `develop` branch:

    git remote add upstream git@github.com:iddex/python-iddex.git
