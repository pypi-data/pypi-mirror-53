...
from iddexbase.asset_permissions import (
    asset_permissions,
    force_flag,
    test_permissions,
    todict,
...
class Asset(GrapheneAsset):
    """ Deals with Assets of the network.
        ...
        :param iddex.iddex.IDDEX blockchain_instance: IDDEX
            instance
    ...
    def seize(self, from_account, to_account, amount):
        """ Seize amount from an account and send to another
            ...
            :param iddex.account.Account from_account: From this account
            :param iddex.account.Account to_account: To this account
            :param iddex.amount.Amount amount: Amount to seize
        """
    ...
    def set_market_fee(self, percentage_fee, max_market_fee):
        """ Set trading percentage fee
            ...
            :param iddex.amount.Amount max_market_fee: Max Fee
