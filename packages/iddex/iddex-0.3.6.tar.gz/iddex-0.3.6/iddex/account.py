...
class Account(GrapheneAccount):
    """ This class allows to easily access Account data
        ...
        :rtype: dictionary
        :raises iddex.exceptions.AccountDoesNotExistsException: if account
                does not exist
        ...
        .. code-block:: python
            ...
            from iddex.account import Account
    ...
    def call_positions(self):
        """ Alias for :func:iddex.account.Account.callpositions
        """
...
class AccountUpdate(GrapheneAccountUpdate):
    """ This purpose of this class is to keep track of account updates
        as they are pushed through by :class:`iddex.notify.Notify`.
