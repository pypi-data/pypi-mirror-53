...
from iddexbase.account import PrivateKey, PublicKey
...
class Memo(GrapheneMemo):
    """ Deals with Memos that are attached to a transfer
        ...
        :param iddex.account.Account from_account: Account that has sent
            the memo
        :param iddex.account.Account to_account: Account that has received
            the memo
        ...
        .. code-block:: python
            ...
            from iddex.memo import Memo
            m = Memo("iddexeu", "wallet.xeroc")
