...
class RType(Assembler.InstDescription, Simulation.InstDescription):
    ...
    def format(self, inst: Simulation.Instruction) -> str:
        return "{} x{}, x{}, x{}".format(self.mnemonic, inst.rd, inst.rs1, inst.rs2)
...
class IType(Assembler.InstDescription, Simulation.InstDescription):
    ...
    def format(self, inst: Simulation.Instruction) -> str:
        return "{} x{}, {}(x{})".format(self.mnemonic, inst.rd, inst.imm, inst.rs1)
...
class SType(Assembler.InstDescription, Simulation.InstDescription):
    ...
    def format(self, inst: Simulation.Instruction) -> str:
        return "{} x{}, {}(x{})".format(self.mnemonic, inst.rs2, inst.imm, inst.rs1)
...
class BType(Assembler.InstDescription, Simulation.InstDescription):
    ...
    def format(self, inst: Simulation.Instruction) -> str:
        return "{} x{}, x{}, {}".format(self.mnemonic, inst.rs1, inst.rs2, inst.imm)
...
class UType(Assembler.InstDescription, Simulation.InstDescription):
    ...
    def format(self, inst: Simulation.Instruction) -> str:
        return "{} x{}, {}".format(self.mnemonic, inst.rd, inst.imm >> 12)
...
class JType(Assembler.InstDescription, Simulation.InstDescription):
    ...
    def format(self, inst: Simulation.Instruction) -> str:
        return "{} x{}, {}".format(self.mnemonic, inst.rd, inst.imm)
...
class ImmType(IType):
    ...
    def format(self, inst: Simulation.Instruction) -> str:
        return "{} x{}, x{}, {}".format(self.mnemonic, inst.rd, inst.rs1, inst.imm)
