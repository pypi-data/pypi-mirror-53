...
class TreatResults:
    ...
    def merge(self, other_treat_results):
        for [key, value] in other_treat_results._values.items():
            self._values[key] = value

        self._general_errors = self._general_errors.union(other_treat_results.general_errors)
