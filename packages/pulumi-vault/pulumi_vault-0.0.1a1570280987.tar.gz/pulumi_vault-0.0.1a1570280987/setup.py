...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v0.0.1-alpha.1570280987+g21f2c04'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v0.0.1-alpha.1570280987+g21f2c04`
                """)
            else:
                raise
