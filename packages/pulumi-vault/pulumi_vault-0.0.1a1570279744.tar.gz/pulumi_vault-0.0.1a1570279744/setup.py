...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v0.0.1-alpha.1570279744+gc711e38'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v0.0.1-alpha.1570279744+gc711e38`
                """)
            else:
                raise
