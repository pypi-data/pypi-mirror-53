...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        "jsii~=0.17.1",
        "publication>=0.0.3",
        "aws-cdk.aws-applicationautoscaling~=1.11,>=1.11.0",
        "aws-cdk.aws-autoscaling~=1.11,>=1.11.0",
        "aws-cdk.aws-autoscaling-hooktargets~=1.11,>=1.11.0",
        ...
        "aws-cdk.aws-ecr-assets~=1.11,>=1.11.0",
        ...
        "aws-cdk.aws-route53~=1.11,>=1.11.0",
        "aws-cdk.aws-route53-targets~=1.11,>=1.11.0",
        "aws-cdk.aws-secretsmanager~=1.11,>=1.11.0",
        "aws-cdk.aws-servicediscovery~=1.11,>=1.11.0",
        "aws-cdk.aws-sns~=1.11,>=1.11.0",
        "aws-cdk.aws-sqs~=1.11,>=1.11.0",
        "aws-cdk.aws-ssm~=1.11,>=1.11.0",
