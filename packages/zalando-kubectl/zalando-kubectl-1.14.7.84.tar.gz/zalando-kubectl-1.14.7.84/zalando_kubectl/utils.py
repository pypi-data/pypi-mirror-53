...
from . import APP_NAME, KUBECTL_VERSION, KUBECTL_SHA512, STERN_VERSION, STERN_SHA256
...
class ExternalBinary:
    def __init__(self, env, name, url_template, version, checksum_algo, checksum, extract):
        self.env = env
        self.name = name
