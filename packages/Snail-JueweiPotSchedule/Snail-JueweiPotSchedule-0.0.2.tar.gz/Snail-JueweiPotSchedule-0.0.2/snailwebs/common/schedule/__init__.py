...
default_model = [
    ...
    [A1, A1, A1, A3, A3, A3],
    # 鸭脖需求量大
    [A1, A1, A1, A1, A2, A3, B, B, B],
    [A1, A1, A1, A1, A2, A2, B, B, B],
    [A1, A1, A1, A1, A3, A3, B, B, B],
    [A1, A1, A1, A1, A2, A3, B, B],
    [A1, A1, A1, A1, A2, A2, B, B],
    [A1, A1, A1, A1, A3, A3, B, B],
    [A1, A1, A1, A1, A2, A3, B],
    [A1, A1, A1, A1, A2, A2, B],
    [A1, A1, A1, A1, A3, A3, B],
    [A1, A1, A1, A1, A2, A3],
    ...
    [A1, A1, A1, A1, A3, A3],
    # 鸭脖需求量小(第3圈可卤制A2类产品)
    [A1, A1, A2, A2, A2, A3, B, B, B],
    [A1, A1, A2, A2, A2, A2, B, B, B],
    [A1, A1, A2, A2, A3, A3, B, B, B],
    [A1, A1, A2, A3, A3, A3, B, B, B],
    [A1, A1, A2, A2, A2, A3, B, B],
    [A1, A1, A2, A2, A2, A2, B, B],
    [A1, A1, A2, A2, A3, A3, B, B],
    [A1, A1, A2, A3, A3, A3, B, B],
    [A1, A1, A2, A2, A2, A3, B],
    [A1, A1, A2, A2, A2, A2, B],
    [A1, A1, A2, A2, A3, A3, B],
    [A1, A1, A2, A3, A3, A3, B],
