...
def test_multiple_snapshots(session, network, basic_snapshot, basic_snapshot2,
                            monkeypatch):
    ...
    assert not session._check_policy_exists_locally('p1', 'pid1',
                                                    basic_snapshot2)
    assert session._check_policy_exists_remotely('p1', 'pid1', basic_snapshot)
    assert not session._check_policy_exists_remotely('p1', 'pid1',
                                                     basic_snapshot2)
