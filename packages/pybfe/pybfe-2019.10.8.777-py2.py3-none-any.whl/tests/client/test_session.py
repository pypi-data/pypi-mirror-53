...
def test_get_policy_by_name_local():
    ...
    assert s._get_policy_by_name(policy_name='p1', policy_id='pid1',
                                 snapshot='ss1') == p1
...
def test_get_policy_by_name_missing():
    ...
    with pytest.raises(ValueError) as e:
        s._get_policy_by_name(policy_name='bogus', policy_id='bogus',
                              snapshot='ss1')
...
def test_get_policy_by_name_remote():
    ...
    assert s._get_policy_by_name(policy_name='p1',
                                 policy_id='pid1',
                                 snapshot='ss1').get_summary() == p1.get_summary()
...
def test_get_policy_by_name_local_first():
    ...
    get_policy = s._get_policy_by_name(policy_name='p1', policy_id='pid1',
                                       snapshot='ss1')
