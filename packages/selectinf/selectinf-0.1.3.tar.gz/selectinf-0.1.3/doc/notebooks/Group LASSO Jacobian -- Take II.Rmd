...
$$
\begin{aligned}
D_0^{-1}PW\eta = \gamma ( D_0^{1/2}A_0D_0^{1/2} + I)^{-1}  D_0^{1/2}A_0D_0^{1/2}W\eta.
\end{aligned}
$$
...
&= \gamma W^T ( D_0^{1/2}A_0D_0^{1/2} + I)^{-1}  D_0^{1/2}A_0D_0^{1/2}W\eta.
\end{aligned}
$$
Or, $\eta$ is a (regular) eigenvector of 
$$
