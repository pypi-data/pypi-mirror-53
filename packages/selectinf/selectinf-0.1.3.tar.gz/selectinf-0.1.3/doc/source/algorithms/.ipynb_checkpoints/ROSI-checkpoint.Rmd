...
is extended beyond squared-error loss in 
...
plt.plot(grid, sm.distributions.ECDF(results['pvalue'][results['pvalue'] > thresh])(grid), 'r-', linewidth=3, label='P-value')
plt.plot([0, 1], [0, 1], 'k--')
