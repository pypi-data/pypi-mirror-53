...
class Account(BaseObject):
  ...
  def change_request_by_id(self, id):
    ...
    elem = ChangeRequest(self.appliance_url, self.api_key, self.sec_key, self.insecure)
  ...
  def change_requests(self):
    ...
    the_list = ChangeRequestList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
      elem = ChangeRequest(self.appliance_url, self.api_key, self.sec_key, self.insecure)
      if "external_id" in x:
  ...
  def connection_manager_groups(self):
    ...
    the_list = ConnectionManagerGroupList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
  ...
  def environments(self):
    ...
    the_list = EnvironmentList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
      elem = Environment(self.appliance_url, self.api_key, self.sec_key, self.insecure)
      if "description" in x:
  ...
  def event_types(self):
    ...
    the_list = EventTypeList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
      elem = EventType(self.appliance_url, self.api_key, self.sec_key, self.insecure)
      if "id" in x:
        elem.id = x["id"]
      if "name" in x:
        elem.name = x["name"]
  ...
  def event_actions(self):
    ...
    the_list = EventActionList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
      elem = EventAction(self.appliance_url, self.api_key, self.sec_key, self.insecure)
      if "id" in x:
        elem.id = x["id"]
  ...
  def incidents(self):
    ...
    the_list = IncidentList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
  ...
  def jobs(self):
    ...
    the_list = JobList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
  ...
  def node_groups(self):
    ...
    the_list = NodeGroupList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
      elem = NodeGroup(self.appliance_url, self.api_key, self.sec_key, self.insecure)
      if "description" in x:
        elem.description = x["description"]
      if "id" in x:
        elem.id = x["id"]
  ...
  def operating_system_families(self):
    ...
    the_list = OperatingSystemFamilyList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
  ...
  def operating_systems(self):
    ...
    the_list = OperatingSystemList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
  ...
  def policies(self):
    ...
    the_list = PolicyList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
      elem = Policy(self.appliance_url, self.api_key, self.sec_key, self.insecure)
      if "id" in x:
        elem.id = x["id"]
      if "name" in x:
        elem.name = x["name"]
  ...
  def scheduled_jobs(self):
    ...
    the_list = ScheduledJobList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
      elem = ScheduledJob(self.appliance_url, self.api_key, self.sec_key, self.insecure)
      if "data" in x:
        elem.data = x["data"]
      if "id" in x:
        elem.id = x["id"]
  ...
  def system_metrics(self):
    ...
    the_list = SystemMetricList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
  ...
  def text_file_by_id(self, id):
    ...
    elem = TextFile(self.appliance_url, self.api_key, self.sec_key, self.insecure)
  ...
  def users(self):
    ...
    the_list = UserList(self.appliance_url, self.api_key, self.sec_key, self.insecure)
    for x in obj:
