...
.. warning::
   ...
   `qtplotlib` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `qtplotlib`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `qtplotlib-dev` with all
the QtPlotLib dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate qtplotlib-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate qtplotlib-dev``
...
type::
    ...
    conda list -n qtplotlib-dev

If later you want to leave the `qtplotlib-dev` virtual environment:
...
then on, all the QtPlotLib binaries and the library itself will be
...
.. _available on GitHub: https://github.com/jeremiedecock/qtplotlib-python
...
.. _TODO.md: https://github.com/jeremiedecock/qtplotlib-python/blob/master/TODO.md
