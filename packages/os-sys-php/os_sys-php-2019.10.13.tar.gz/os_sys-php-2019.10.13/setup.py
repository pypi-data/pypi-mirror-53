...
with concurrent.futures.ProcessPoolExecutor() as executor:
    ...
    setuptools.setup(
        name="os_sys-php",
        version=strftime("%Y.%m.%d"),#.dev moet dan hier
        ...
        packages=list(list(package_data) + ['php_osx','php']),#list(package_data) + ['os_sys', 'edit', 'ins', 'server', 'mysite','pyspectator','pyspectator_tornado']
