...
{
	'comment': {
		'id': 50990, 'body': 'Hey, mat1!! 🙌', 'timeCreated': '2019-09-25T23:04:03.000Z', 'canEdit': True, 'canComment': True, 'canReport': False, 'hasReported': False, 'url': '/talk/announcements/ignore-this/18922/50990', 'voteCount': 1, 'canVote': True, 'hasVoted': True, 'user': {'id': 1042714, 'username': 'ReplTalk', 'url': '/@ReplTalk', 'image': 'https://storage.googleapis.com/replit/images/1534649204246_18b340d11a5e43fd3acd0e828716ee72.pn', 'karma': 476, 'firstName': 'Repl', 'lastName': 'Talk', 'fullName': 'Repl Talk', 'displayName': 'Repl', 'isLoggedIn': True, 'bio': 'Automated bot account by @mat1 :)', 'organization': None, 'subscription': None, 'languages': [], 'roles': [{'id': '1042714:self_learner', 'name': 'self learner', 'key':'SELF_LEARNER', 'tagline': None}]}, 'comments': [], 'parentComment': {'id': 50982}
	}
}
