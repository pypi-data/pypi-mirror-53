...
class inserDataSH():
    ...
    def getMessage(self, table, startTime, endTime):
        result = self.db.getDataFromTableSH(table, startTime, endTime)
        return result
...
if __name__ == '__main__':
    inserDataSH().insertToTable('lianjia_shanghai', '2017.10.01', '2017.11.01')
    '''s = '4'
    ss = '5'
    inserData().insertToTable('dianping_cities', '2018.0' + s + '.01', '2018.0' + ss + '.01')
    inserData().insertToTable('dianpinga_cities', '2018.0' + s + '.01', '2018.0' + ss + '.01')
    inserData().insertToTable('dianpingx_cities', '2018.0' + s + '.01', '2018.0' + ss + '.01')
    inserData().insertToTable('dianpingau_cities', '2018-0' + s + '-01 00:00:00', '2018-0' + ss + '-01 00:00:00')

    # inserData().insertToTable('dianpingz_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    # inserData().insertToTable('dianpingw_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    # inserData().insertToTable('dianpinglan_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    # inserData().insertToTable('dianpingp_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    # inserData().insertToTable('dianpingzhu_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    # inserData().insertToTable('dianpingm_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    #
    # inserData().insertToTable('dianpingajk_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    # inserData().insertToTable('dianpingesf_cities_xiaoqu', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    # inserData().insertToTable('dianpingxzl_cities', '2018.0' + s + '.01', '2019.0' + ss + '.01')
    #
