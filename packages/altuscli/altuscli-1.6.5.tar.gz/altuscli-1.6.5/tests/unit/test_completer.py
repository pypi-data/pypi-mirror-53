...
from altuscli.arguments import BaseCLIArgument, CustomArgument
from altuscli.clidriver import (
    CLICommand, CLIDriver, ServiceCommand, ServiceOperation)
from altuscli.compat import OrderedDict
from altuscli.completer import Completer
...
class TestCompleter(BaseCompleterTest):
    def test_complete_services(self):
        ...
        self.assert_completion(completer, 'altus ', ['foo', 'bar'])
    ...
    def test_complete_partial_service_name(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus cloud', [
            'cloudfront', 'cloudformation', 'cloudhsm'])
        self.assert_completion(completer, 'altus cloudf', [
            'cloudfront', 'cloudformation'])
        self.assert_completion(completer, 'altus cloudfr', ['cloudfront'])
        self.assert_completion(completer, 'altus cloudfront', [])
    ...
    def test_complete_on_invalid_service(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus bin', [])
    ...
    def test_complete_partial_top_level_arg(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus --f', [
            '--foo', '--fubar', '--foobar'])
        self.assert_completion(completer, 'altus --fo', [
            '--foo', '--foobar'])
        self.assert_completion(completer, 'altus --foob', ['--foobar'])
        self.assert_completion(completer, 'altus --foobar', [])
    ...
    def test_complete_top_level_arg_with_arg_already_used(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus --foo --f', [])
    ...
    def test_complete_service_commands(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus foo ', ['bar', 'baz'])
    ...
    def test_complete_partial_service_commands(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus foo b', ['barb', 'baz', 'biz'])
        self.assert_completion(completer, 'altus foo ba', ['barb', 'baz'])
        self.assert_completion(completer, 'altus foo bar', ['barb'])
        self.assert_completion(completer, 'altus foo barb', [])
    ...
    def test_complete_service_arguments(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus foo --', ['--baz', '--bin'])
    ...
    def test_complete_partial_service_arguments(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus biz --f', [
            '--foo', '--fubar', '--foobar'])
        self.assert_completion(completer, 'altus biz --fo', [
            '--foo', '--foobar'])
        self.assert_completion(completer, 'altus biz --foob', ['--foobar'])
    ...
    def test_complete_service_arg_with_arg_already_used(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus baz --foo --f', [])
    ...
    def test_complete_operation_arguments(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus foo bar --', ['--baz', '--bin'])
    ...
    def test_complete_partial_operation_arguments(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus foo bar --b', [
            '--base', '--baz', '--bin'])
        self.assert_completion(completer, 'altus foo bar --ba', [
            '--base', '--baz'])
        self.assert_completion(completer, 'altus foo bar --bas', ['--base'])
        self.assert_completion(completer, 'altus foo bar --base', [])
    ...
    def test_complete_operation_arg_when_arg_already_used(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus foo bar --baz --b', [])
    ...
    def test_complete_positional_argument(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus foo bar --bin ', [])
        self.assert_completion(completer, 'altus foo bar --bin blah --',
                               ['--baz'])
    ...
    def test_complete_undocumented_command(self):
        ...
        completer = Completer(
            self.clidriver_creator.create_clidriver(commands))
        self.assert_completion(completer, 'altus ', ['foo'])
