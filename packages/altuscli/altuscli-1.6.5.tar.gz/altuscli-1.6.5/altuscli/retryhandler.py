...
from altuscli.thirdparty.requests import ConnectionError, Timeout
from altuscli.thirdparty.requests.packages.urllib3.exceptions \
    import ClosedPoolError


LOG = logging.getLogger('altuscli.retryhandler')
