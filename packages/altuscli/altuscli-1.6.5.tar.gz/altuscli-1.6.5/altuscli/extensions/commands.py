...
from altuscli.argprocess import unpack_argument, unpack_cli_arg
from altuscli.arguments import create_argument_model_from_schema, CustomArgument
...
from altuscli.validate import validate_parameters
...
class _FromFile(object):
    ...
    def __init__(self, *paths, **kwargs):
        ...
        no value is provided, will default to ``altuscli``.  This means
        that by default we look for examples in the ``altuscli`` module.
        """
        self.filename = None
        if paths:
...
class BasicCommand(CLICommand):
    ...
    # create an 'altus mycommand ...' command, the NAME would be
    # 'mycommand'
    NAME = 'commandname'
    ...
    # altuscli/examples/<command name>/_description.rst
    # The naming conventions for these attributes are:
    #
    # DESCRIPTION = altuscli/examples/<command name>/_description.rst
    # SYNOPSIS = altuscli/examples/<command name>/_synopsis.rst
    # EXAMPLES = altuscli/examples/<command name>/_examples.rst
    #
    # You can also provide a relative path and we'll load the file
    # from the specified location:
    #
    # DESCRIPTION = altuscli/examples/<filename>
    #
    # For example:
    #
    # DESCRIPTION = FROM_FILE('command, 'subcommand, '_description.rst')
    # DESCRIPTION = 'altuscli/examples/command/subcommand/_description.rst'
    #
