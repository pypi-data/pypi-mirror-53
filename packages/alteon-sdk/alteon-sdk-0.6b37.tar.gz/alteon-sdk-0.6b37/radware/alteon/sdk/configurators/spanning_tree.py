...
STPGroupParameters.__annotations__ = {
    'id': int,
...
SpanningTreeParameters.__annotations__ = {
    'state': EnumStgState,
...
SpanningTreeConfigurator.__annotations__ = {
    'parameters_class': SpanningTreeParameters
}
