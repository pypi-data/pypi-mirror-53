...
GSLBRuleMetricEntry.__annotations__ = {
    'metric': EnumGslbMetricMetric,
    'network_ids': Optional[List[int]]
}
GSLBRuleMetrics.__annotations__ = {
...
GSLBRuleParameters.__annotations__ = {
    'index': int,
...
GSLBRuleConfigurator.__annotations__ = {
    'parameters_class': GSLBRuleParameters
}