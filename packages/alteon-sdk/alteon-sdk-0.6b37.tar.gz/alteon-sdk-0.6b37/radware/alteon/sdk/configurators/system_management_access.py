...
class ManagementAccessConfigurator(AlteonConfigurator):
    ...
    def _update(self, parameters: ManagementAccessParameters, dry_run: bool) -> str:
        ...
        bean_map[AgNewCfgMgmtNetTable]['direct'] = False
        bean_map[AgNewCfgMgmtNet6Table]['direct'] = False
        ...
        bean_map[Root]['attrs'].update(dict(agMgmtNewCfgNtp='ntp_traffic_port'))
        bean_map[AgNewCfgMgmtNetTable]['direct'] = True
        bean_map[AgNewCfgMgmtNet6Table]['direct'] = True
...
ManagementAccessConfigurator.__annotations__ = {
    'parameters_class': ManagementAccessParameters
}
