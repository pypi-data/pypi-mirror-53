...
AggregationGroup.__annotations__ = {
    'id': int,
    'state': EnumLacpPortTableState,
    'ports': List[int],
}
LACPAggregationParameters.__annotations__ = {
...
LACPAggregationConfigurator.__annotations__ = {
    'parameters_class': LACPAggregationParameters
}
