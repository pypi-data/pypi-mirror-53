...
ParametersMgmtNetStruct.__annotations__ = {
    'vlan': int,
...
VADCInstanceParameters.__annotations__ = {
    'index': int,
...
class VADCInstanceConfigurator(AlteonConfigurator):
    ...
    def _update(self, parameters: VADCInstanceParameters, dry_run: bool) -> str:
        ...
        bean_map[VADCNewCfgNetTable]['direct'] = False
        ...
        bean_map[VADCNewCfgNetTable]['direct'] = True
...
VADCInstanceConfigurator.__annotations__ = {
    'parameters_class': VADCInstanceParameters
}
