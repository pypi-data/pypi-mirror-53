...
class NetworkClassRegionConfigurator(AlteonConfigurator):
    ...
    def _update(self, parameters: NetworkClassRegionParameters, dry_run: bool) -> str:
        bean_map[SlbNewNwclssCfgNetworkClassesTable]['direct'] = False
        bean_map[SlbNewNwclssCfgNetworkElementsTable]['direct'] = False
        ...
        bean_map[SlbNewNwclssCfgNetworkClassesTable]['direct'] = True
        bean_map[SlbNewNwclssCfgNetworkElementsTable]['direct'] = True
...
NetworkClassRegionConfigurator.__annotations__ = {
    'parameters_class': NetworkClassRegionParameters
}
