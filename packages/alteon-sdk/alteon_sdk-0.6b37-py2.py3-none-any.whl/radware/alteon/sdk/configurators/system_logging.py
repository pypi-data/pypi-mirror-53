...
from radware.alteon.sdk.alteon_configurator import MSG_UPDATE, MSG_DELETE, MSG_NO_DELETE, AlteonConfigurator
...
SyslogHostEntry.__annotations__ = {
...
SystemLoggingParameters.__annotations__ = {
...
class SystemLoggingConfigurator(AlteonConfigurator):
    ...
    def delete(self, parameters: SystemLoggingParameters, dry_run=False, **kw) -> str:
        ...
        #TODO - currently alteon does not allow removal of multiple entries by set ip to '0.0.0.0'. it will identify it as entry conflict
        #self._write_syslog_servers(syslog_servers)
    ...
    def dry_run_delete_procedure(self, diff):
        #TODO - modify procedure when removal of multiple entries issue fix
        dry_run_procedure = DryRunDeleteProcedure()
        dry_run_procedure.non_removable_bean_map_attrs_list.append(bean_map[Root]['attrs'])
        dry_run_procedure.ignore_prop_names.append('syslog_servers')
        return dry_run_procedure


SystemLoggingConfigurator.__annotations__ = {
    'parameters_class': SystemLoggingParameters
}
