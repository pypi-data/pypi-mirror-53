...
NetworkClassIPEntry.__annotations__ = {
    'name': str,
...
NetworkClassIPParameters.__annotations__ = {
    'index': str,
...
NetworkClassIPConfigurator.__annotations__ = {
    'parameters_class': NetworkClassIPParameters
}
