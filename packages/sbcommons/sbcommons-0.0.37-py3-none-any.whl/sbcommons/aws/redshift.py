    ...
    def kill_locks(self, table_name: str, exlude_users: List[str] = None):
        ...
        if process_ids:
            ...
            try:
                ...
                # Log exception and swallow it, pid already terminated.
                logger.info(f'Exception caught when killing query! One of the PIDs in: '
                            f'{process_ids} was probably already terminated. Exception raised: '
                            f'{str(e)}')
