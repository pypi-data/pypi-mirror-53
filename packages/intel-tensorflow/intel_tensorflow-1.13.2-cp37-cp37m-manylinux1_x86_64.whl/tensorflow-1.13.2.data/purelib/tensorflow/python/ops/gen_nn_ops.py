...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_and_relu')
def quantized_conv2d_and_relu(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_and_relu, input=input, filter=filter,
                                         min_input=min_input,
                                         max_input=max_input,
...
def quantized_conv2d_and_relu_eager_fallback(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_and_relu_and_requantize')
def quantized_conv2d_and_relu_and_requantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_and_relu_and_requantize, input=input,
                                                        filter=filter,
                                                        min_input=min_input,
                                                        max_input=max_input,
                                                        min_filter=min_filter,
...
def quantized_conv2d_and_relu_and_requantize_eager_fallback(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_and_requantize')
def quantized_conv2d_and_requantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_and_requantize, input=input, filter=filter,
                                               min_input=min_input,
                                               max_input=max_input,
                                               min_filter=min_filter,
                                               max_filter=max_filter,
...
def quantized_conv2d_and_requantize_eager_fallback(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_with_bias')
def quantized_conv2d_with_bias(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_with_bias, input=input, filter=filter,
  ...
  try:
    ...
    result = _dispatch.dispatch(
          quantized_conv2d_with_bias, input=input, filter=filter, bias=bias,
                                      min_input=min_input,
                                      max_input=max_input,
                                      min_filter=min_filter,
                                      max_filter=max_filter, strides=strides,
...
def quantized_conv2d_with_bias_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_with_bias_and_relu')
def quantized_conv2d_with_bias_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_with_bias_and_relu, input=input, filter=filter,
                                                   bias=bias,
                                                   min_input=min_input,
                                                   max_input=max_input,
                                                   min_filter=min_filter,
...
def quantized_conv2d_with_bias_and_relu_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_with_bias_and_relu_and_requantize')
def quantized_conv2d_with_bias_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_with_bias_and_relu_and_requantize, input=input,
                                                                  filter=filter,
                                                                  bias=bias,
                                                                  min_input=min_input,
                                                                  max_input=max_input,
...
def quantized_conv2d_with_bias_and_relu_and_requantize_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_with_bias_and_requantize')
def quantized_conv2d_with_bias_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_with_bias_and_requantize, input=input,
                                                         filter=filter,
                                                         bias=bias,
                                                         min_input=min_input,
                                                         max_input=max_input,
...
def quantized_conv2d_with_bias_and_requantize_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize')
def quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize, input=input,
                                                                             filter=filter,
                                                                             bias=bias,
                                                                             min_input=min_input,
                                                                             max_input=max_input,
...
def quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_with_bias_sum_and_relu')
def quantized_conv2d_with_bias_sum_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, summand, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_with_bias_sum_and_relu, input=input,
                                                       filter=filter,
                                                       bias=bias,
                                                       min_input=min_input,
                                                       max_input=max_input,
  ...
  try:
    ...
    result = _dispatch.dispatch(
          quantized_conv2d_with_bias_sum_and_relu, input=input, filter=filter,
                                                   bias=bias,
                                                   min_input=min_input,
                                                   max_input=max_input,
                                                   min_filter=min_filter,
...
def quantized_conv2d_with_bias_sum_and_relu_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, summand, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_dispatch.add_dispatch_list
@tf_export('quantized_conv2d_with_bias_sum_and_relu_and_requantize')
def quantized_conv2d_with_bias_sum_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._eager_context.is_eager:
    try:
      ...
      try:
        ...
        result = _dispatch.dispatch(
              quantized_conv2d_with_bias_sum_and_relu_and_requantize, input=input,
                                                                      filter=filter,
                                                                      bias=bias,
                                                                      min_input=min_input,
                                                                      max_input=max_input,
...
def quantized_conv2d_with_bias_sum_and_relu_and_requantize_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
