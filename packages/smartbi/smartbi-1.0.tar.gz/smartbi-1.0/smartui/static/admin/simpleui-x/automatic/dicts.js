...
var dicts = {
   ...
   // 'fas fa-tablet-alt': ['设备'],
    ...
    //分析
    'far fa-chart-bar': ['图形','分析', '图表', '统计', '统计图'],
    //蜘蛛
    'fas fa-spider': ['数据集','采集', '收集', '爬虫', '调试'],
    //异常
    'fas fa-exclamation-triangle': ['异常', '错误', '警告', '警报', '报警'],
    //产品
    'fas fa-shopping-cart': ['模版','产品', '货物', '商品', '购物车'],
    //分类
    'fas fa-list': ['项目清单','类别', '类目', '分类', '列表', '集合', '排行'],
    //职位
    'fas fa-chalkboard-teacher': ['职位', '职能', '职称'],
    //车
   // 'fas fa-car': ['汽车', '摩托车', '轿车', '货车', '公交车', '单车', '采购'],
    //计划
    'far fa-calendar-alt': ['DAG','计划', '定时', '日程', '日历'],
    //仓库
   ...
   // 'fas fa-music': ['音乐', '歌曲', '歌词', '歌手', '歌唱家', '演唱会', 'MV'],
    //电影
    'fas fa-film': ['主题','电影', '电视', '节目', '录像', '影片', '影视', '视频'],
    //菜单
