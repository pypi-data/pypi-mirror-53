...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-validation-common',
    project_urls={
        'Documentation': 'https://tendril-validation-common.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-validation-common/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-validation-common',
    },
