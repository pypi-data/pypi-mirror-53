...
``tendril-validation-common`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-validation-common
...
`github releases <https://github.com/tendril-framework/tendril-validation-common/releases>`_.
...
``tendril-validation-common``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-validation-common.git
    $ cd tendril-validation-common
    $ pip install -e .
