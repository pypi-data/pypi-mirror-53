...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v0.17.5-alpha.1570925235+gccfd8ee'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v0.17.5-alpha.1570925235+gccfd8ee`
                """)
            else:
                raise
