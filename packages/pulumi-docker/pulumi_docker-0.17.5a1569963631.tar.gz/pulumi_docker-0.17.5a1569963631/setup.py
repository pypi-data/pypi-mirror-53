...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v0.17.5-alpha.1569963631+gd9b4949'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v0.17.5-alpha.1569963631+gd9b4949`
                """)
            else:
                raise
