...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v0.17.5-alpha.1570834880+ga862d8f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v0.17.5-alpha.1570834880+ga862d8f`
                """)
            else:
                raise
