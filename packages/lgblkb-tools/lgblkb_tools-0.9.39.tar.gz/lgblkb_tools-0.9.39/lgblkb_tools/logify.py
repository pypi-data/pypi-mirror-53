...
def generate_handle():
	...
	def _handle_generator(wrapped,instance,args,kwargs):
		...
		out=instance.create_handler(wrapped(*args,**kwargs),level=the_level,log_format=the_format)
		instance.info('Log handle %s created at %s',wrapped.__name__,datetime.datetime.now())
		return out
