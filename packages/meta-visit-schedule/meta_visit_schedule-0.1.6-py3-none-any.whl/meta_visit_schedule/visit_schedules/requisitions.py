...
requisitions_prn = FormsCollection(
    ...
    Requisition(
        show_order=30, panel=hba1c_poc_panel, required=True, additional=False
    ),
    Requisition(
        show_order=40, panel=hba1c_panel, required=True, additional=False
    ),
    Requisition(show_order=50, panel=fbc_panel,
                required=True, additional=False),
    Requisition(show_order=60, panel=chemistry_panel,
                required=True, additional=False),
...
requisitions_d1 = FormsCollection(
    ...
    Requisition(
        show_order=20, panel=hba1c_poc_panel, required=True, additional=False
    ),
    Requisition(
        show_order=30, panel=fbc_panel, required=True, additional=False),
    Requisition(
        show_order=40, panel=chemistry_panel, required=True, additional=False),
