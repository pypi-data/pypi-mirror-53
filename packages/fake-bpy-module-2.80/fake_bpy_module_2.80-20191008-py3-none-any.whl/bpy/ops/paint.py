...
def image_paint(stroke: typing.List['bpy.types.bpy_prop_collection'] = None,
                mode: typing.Union[int, str] = 'NORMAL'):
    '''Paint a stroke into the image 

    :param stroke: Stroke 
    :type stroke: typing.List['bpy.types.bpy_prop_collection']
...
def mask_lasso_gesture(
        path: typing.List['bpy.types.bpy_prop_collection'] = None,
        mode: typing.Union[int, str] = 'VALUE',
        value: float = 1.0):
    '''Add mask within the lasso as you move the brush 

    :param path: Path 
    :type path: typing.List['bpy.types.bpy_prop_collection']
    :param mode: ModeVALUE Value, Set mask to the level specified by the ‘value’ property.VALUE_INVERSE Value Inverted, Set mask to the level specified by the inverted ‘value’ property.INVERT Invert, Invert the mask. 
    :type mode: typing.Union[int, str]
    :param value: Value, Mask level to use when mode is ‘Value’; zero means no masking and one is fully masked 
    :type value: float
...
def vertex_paint(stroke: typing.List['bpy.types.bpy_prop_collection'] = None,
                 mode: typing.Union[int, str] = 'NORMAL'):
...
def weight_paint(stroke: typing.List['bpy.types.bpy_prop_collection'] = None,
                 mode: typing.Union[int, str] = 'NORMAL'):
