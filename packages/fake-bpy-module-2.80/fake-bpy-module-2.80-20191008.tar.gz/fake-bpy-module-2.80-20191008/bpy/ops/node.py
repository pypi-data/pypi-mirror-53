...
def add_and_link_node(
        ...
        settings: typing.List['bpy.types.bpy_prop_collection'] = None,
    ...
    :type settings: typing.List['bpy.types.bpy_prop_collection']
...
def add_reroute(path: typing.List['bpy.types.bpy_prop_collection'] = None,
                cursor: int = 6):
    '''Add a reroute node 
...
def links_cut(path: typing.List['bpy.types.bpy_prop_collection'] = None,
              cursor: int = 9):
