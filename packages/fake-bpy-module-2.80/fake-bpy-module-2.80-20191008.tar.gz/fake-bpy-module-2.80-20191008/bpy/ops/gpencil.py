...
def annotate(mode: typing.Union[int, str] = 'DRAW',
             stroke: typing.List['bpy.types.bpy_prop_collection'] = None,
...
def sculpt_paint(stroke: typing.List['bpy.types.bpy_prop_collection'] = None,
                 wait_for_input: bool = True):
...
def stroke_cutter(path: typing.List['bpy.types.bpy_prop_collection'] = None):
