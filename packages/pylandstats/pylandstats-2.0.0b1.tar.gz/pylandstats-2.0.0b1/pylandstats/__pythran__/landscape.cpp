...
namespace __pythran_landscape
{
  ...
  {
    {
      static typename __transonic__::type::result_type tmp_global = pythonic::types::make_tuple(pythonic::types::str("0.4.0"));
      return tmp_global;
    }
  }
  template <typename argument_type0 , typename argument_type1 >
...
PYTHRAN_MODULE_INIT(landscape)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.3post1",
                                      "2019-09-29 17:42:50.261296",
                                      "db9843812b714b85afaec52b40d844b56092a4bcbcbf8be306cf809a595785c5");
    if(! theDoc)
        PYTHRAN_RETURN;
