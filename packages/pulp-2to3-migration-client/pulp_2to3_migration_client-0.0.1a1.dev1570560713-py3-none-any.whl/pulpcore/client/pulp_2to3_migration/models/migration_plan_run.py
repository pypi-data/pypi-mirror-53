...
class MigrationPlanRun(object):
    ...
    def __init__(self, dry_run=False):  # noqa: E501
    ...
    def dry_run(self):
        ...
        If ``True``, performs validation of a Migration Plan only, no migration is run. If ``False``, both validation and migration are run.  # noqa: E501
