...
class StandardFieldKeys:
    ...
    def keys(cls) -> List[str]:
        ...
        return [
            ...
            StandardFieldKeys.FAILURE_REASON,
...
class StandardFields(dict):
    ...
    def __init__(self, algorithm_type=None, client_os=None, compute_type=None,
                 http_method=None, http_status_code=None, http_user_agent=None,
                 iteration_id=None, run_id=None, parent_run_id=None,
                 task_result=None, resource_group=None, workspace_region=None,
                 *args: Any, **kwargs: Any):
    ...
    def failure_reason(self):
        """Get failure reason."""
        return self.get(StandardFieldKeys.FAILURE_REASON, None)

    @failure_reason.setter
    def failure_reason(self, value):
        """Set failure reason."""
        validate = (value == ErrorCodes.USER_ERROR or value == ErrorCodes.SYSTEM_ERROR)
        assert validate is True, "Failure reason has to be either User or System"
        self[StandardFieldKeys.FAILURE_REASON] = value
