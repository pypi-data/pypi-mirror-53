...
class Tello:
	...
	def connect(self):
		sock.sendto("command".encode(encoding="utf-8"))
		time.sleep(1)
	...
	def takeoff(self):
		sock.sendto("takeoff".encode(encoding="utf-8"))
		time.sleep(5)
	
	#Sends the "land" command to Tello EDU Drone
	def land(self):
		sock.sendto("land".encode(encoding="utf-8"))
		time.sleep(5)

	#Sends the "stop" command to Tello EDU Drone
	def stop(self):
		sock.sendto("stop".encode(encoding="utf-8"))
		time.sleep(1)
	...
	def get_speed(self):
		sock.sendto("speed?".encode(encoding="utf-8"))
		time.sleep(1)

	#Sends the "battery?" command to Tello EDU Drone
	def get_battery(self):
		sock.sendto("battery?".encode(encoding="utf-8"))
		time.sleep(1)

	#Sends the "time?" command to Tello EDU Drone
	def get_time(self):
		sock.sendto("time?".encode(encoding="utf-8"))
		time.sleep(1)

	#Sends the "wifi?" command to Tello EDU Drone
	def get_wifi(self):
		sock.sendto("wifi?".encode(encoding="utf-8"))
		time.sleep(1)
