    ...
    def _save_trace_df(self, traceDF, initialColumns, spreadId, sheetName):
        ...
        if 'CONTENDO_AT_HOME' in os.environ:
            ...
            try:
                ...
                files.download('{}.csv'.format(sheetName))
            except:
                IN_COLAB = False

    def pbp_get_stat(self, statName, object, playDimention='all', gameDimention='game', aggfunc=None, playType=None, filter='True', trace=False, traceFileName=None):
