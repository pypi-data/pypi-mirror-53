...
def test():
    ...
    df = generator.pbp_get_stat('rushes', 'rushingPlayer', 'conversion', '3rdDown', filter="df.season=='2019-regular'")
    logger.info('Columns={}, Shape={}\n\n{}\n\n'.format(df.columns, df.shape, df))
    df = generator.pbp_get_stat('rushes', 'rushingPlayer', 'all', 'game', filter="df.season=='2019-regular'", trace=False, playerId=12606)
    logger.info('Columns={}, Shape={}\n{}'.format(df.columns, df.shape, df))
